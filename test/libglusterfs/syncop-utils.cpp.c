...
# 26 "./syncop-utils.c"
 ...
 28
# 26 "./syncop-utils.c"
                , GF_LOG_ERROR, (*__errno_location ()), 0, (100000 + 1000 + 49), "fd_create of %s", uuid_utoa (loc->gfid)); } while (0)
        ...
        ret = syncop_opendir (subvol, loc, dirfd, ((void *)0), ((void *)0));
        if (ret) {
# 56 "./syncop-utils.c"
                fd_unref (dirfd);
                do { _gf_msg (subvol->name,
...
# 57 "./syncop-utils.c"
 ...
 59
# 57 "./syncop-utils.c"
                , GF_LOG_ERROR, (*__errno_location ()), 0, (100000 + 1000 + 10), "opendir of %s", uuid_utoa (loc->gfid)); } while (0)
                       ...
                       void *data))
{
        ...
        do { (&entries.list)->next = (&entries.list)->prev = &entries.list; } while (0);
        ...
        while ((ret = syncop_readdirp (subvol, fd, 131072, offset, &entries,
                ...
                for (entry = ((typeof(*entry) *)((char *)((&entries.list)->next)-(unsigned long)(&((typeof(*entry) *)0)->list))); &entry->list != (&entries.list); entry = ((typeof(*entry) *)((char *)(entry->list.next)-(unsigned long)(&((typeof(*entry) *)0)->list)))) {
                        ...
                        gf_link_inode_from_dirent (((void *)0), fd->inode, entry);
...
syncop_is_subvol_local (xlator_t *this, loc_t *loc, gf_boolean_t *is_local)
{
        ...
        *is_local = _gf_false;
        ...
        ret = syncop_getxattr (this, loc, &xattr, "trusted.glusterfs.pathinfo", ((void *)0),
                               ((void *)0));
        if (ret < 0) {
                ret = -1;
                goto out;
        ...
        ret = dict_get_str (xattr, "trusted.glusterfs.pathinfo", &pathinfo);
        if (ret)
                goto out;
...
# 305 "./syncop-utils.c"
 ...
 306
# 305 "./syncop-utils.c"
        , GF_LOG_DEBUG, 0, 0, 0, "subvol %s is %slocal", this->name, is_local ? "" : "not "); } while (0)
                                                   ;
                     ...
                     char **path_p)
{
        ...
        ret = syncop_getxattr (subvol, &loc, &xattr, "glusterfs.gfid2path", ((void *)0),
                               ((void *)0));
        if (ret < 0)
                goto out;

        ret = dict_get_str (xattr, "glusterfs.gfid2path", &path);
        if (ret || !path) {
                ret = -22;
                goto out;
        }
