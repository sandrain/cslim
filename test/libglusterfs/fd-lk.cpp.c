...
_fd_lk_delete_lock (fd_lk_ctx_node_t *lock)
{
        ...
        do { if (!lock) { (*__errno_location ()) = 22; do { _gf_msg ("fd-lk", "./fd-lk.c", __FUNCTION__, 20, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "lock"); } while (0); goto out; } } while (0);
...
_fd_lk_destroy_lock (fd_lk_ctx_node_t *lock)
{
        ...
        do { if (!lock) { (*__errno_location ()) = 22; do { _gf_msg ("fd-lk", "./fd-lk.c", __FUNCTION__, 34, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "lock"); } while (0); goto out; } } while (0);
...
{
        int ret = -1;
        fd_lk_ctx_node_t *lk = ((void *)0);
        fd_lk_ctx_node_t *tmp = ((void *)0);

        do { if (!lk_ctx) { (*__errno_location ()) = 22; do { _gf_msg ("fd-lk", "./fd-lk.c", __FUNCTION__, 50, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "lk_ctx"); } while (0); goto out; } } while (0);

        for (lk = ((typeof(*lk) *)((char *)((&lk_ctx->lk_list)->next)-(unsigned long)(&((typeof(*lk) *)0)->next))), tmp = ((typeof(*lk) *)((char *)(lk->next.next)-(unsigned long)(&((typeof(*lk) *)0)->next))); &lk->next != (&lk_ctx->lk_list); lk = tmp, tmp = ((typeof(*tmp) *)((char *)(tmp->next.next)-(unsigned long)(&((typeof(*tmp) *)0)->next)))) {
...
fd_lk_ctx_unref (fd_lk_ctx_t *lk_ctx)
{
        ...
        do { if (!lk_ctx) { (*__errno_location ()) = 22; do { _gf_msg ("fd-lk", "./fd-lk.c", __FUNCTION__, 66, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "lk_ctx"); } while (0); goto err; } } while (0);

        pthread_mutex_lock (&lk_ctx->lock);
        {
                ref = --lk_ctx->ref;
                if (ref < 0)
                        do { if (!(!ref)) { do { _gf_msg ("", "./fd-lk.c", __FUNCTION__, 72, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "!ref"); } while (0); } } while (0);
                if (ref == 0)
                        _fd_lk_destroy_lock_list (lk_ctx);
        }
        pthread_mutex_unlock (&lk_ctx->lock);

        if (ref == 0) {
                pthread_mutex_destroy (&lk_ctx->lock);
                __gf_free (lk_ctx);
        }
...
fd_lk_ctx_try_ref (fd_lk_ctx_t *lk_ctx)
{
        ...
        ret = pthread_mutex_trylock (&lk_ctx->lock);
        if (ret)
                goto out;
...
fd_lk_ctx_create ()
{
        fd_lk_ctx_t *fd_lk_ctx = ((void *)0);

        fd_lk_ctx = __gf_calloc (1, sizeof (fd_lk_ctx_t), gf_common_mt_fd_lk_ctx_t, "gf_common_mt_fd_lk_ctx_t")
                                                        ;
        if (!fd_lk_ctx)
                goto out;

        do { (&fd_lk_ctx->lk_list)->next = (&fd_lk_ctx->lk_list)->prev = &fd_lk_ctx->lk_list; } while (0);

        pthread_mutex_init (&fd_lk_ctx->lock, 0);
...
{
        fd_lk_ctx_node_t *new_lock = ((void *)0);


        new_lock = __gf_calloc (1, sizeof (fd_lk_ctx_node_t), gf_common_mt_fd_lk_ctx_node_t, "gf_common_mt_fd_lk_ctx_node_t")
                                                            ;
        if (!new_lock)
                goto out;
        ...
        if (flock) {
                ...
                if (flock->l_len == 0)
                        new_lock->fl_end = 9223372036854775807LL;
                else
        ...
        do { (&new_lock->next)->next = (&new_lock->next)->prev = &new_lock->next; } while (0);
out:
        return new_lock;
}
...
_fd_lk_delete_unlck_locks (fd_lk_ctx_t *lk_ctx)
{
        ...
        do { if (!lk_ctx) { (*__errno_location ()) = 22; do { _gf_msg ("fd-lk", "./fd-lk.c", __FUNCTION__, 217, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "lk_ctx"); } while (0); goto out; } } while (0);
...
_fd_lk_add_locks (fd_lk_ctx_node_t *l1,
                  fd_lk_ctx_node_t *l2)
{
        fd_lk_ctx_node_t *sum = ((void *)0);

        sum = fd_lk_ctx_node_new (0, ((void *)0));
        if (!sum)
                goto out;

        sum->fl_start = ((l1->fl_start)<(l2->fl_start)?(l1->fl_start):(l2->fl_start));
        sum->fl_end = ((l1->fl_end)>(l2->fl_end)?(l1->fl_end):(l2->fl_end));
                  ...
                  fd_lk_ctx_node_t *small)
{
        ...
        if ((big->fl_start == small->fl_start) &&
            (big->fl_end == small->fl_end)) {
                ...
                v->locks[0] = fd_lk_ctx_node_new (small->cmd, ((void *)0));
                if (!v->locks[0])
                        goto out;
                ...
                v->locks[0] = fd_lk_ctx_node_new (big->cmd, ((void *)0));
                if (!v->locks[0])
                        goto out;

                v->locks[1] = fd_lk_ctx_node_new (small->cmd, ((void *)0));
                if (!v->locks[1])
                        goto out;

                v->locks[2] = fd_lk_ctx_node_new (big->cmd, ((void *)0));
                if (!v->locks[2])
                        goto out;
                ...
                v->locks[1] = fd_lk_ctx_node_new (big->cmd, ((void *)0));
                if (!v->locks[1])
                        goto out;
                ...
                do { if (!(!"Invalid case")) { do { _gf_msg ("", "./fd-lk.c", __FUNCTION__, 348, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "!\"Invalid case\""); } while (0); } } while (0);
        }
        ret = 0;
out:
        return ret;
                         ...
                         fd_lk_ctx_node_t *lock)
{
        int32_t ret = -1;
        int32_t i = 0;
        fd_lk_ctx_node_t *entry = ((void *)0);
        fd_lk_ctx_node_t *t = ((void *)0);
        fd_lk_ctx_node_t *sum = ((void *)0);
        struct _values v = {.locks = {0, 0, 0 }};

        for (entry = ((typeof(*entry) *)((char *)((&lk_ctx->lk_list)->next)-(unsigned long)(&((typeof(*entry) *)0)->next))), t = ((typeof(*entry) *)((char *)(entry->next.next)-(unsigned long)(&((typeof(*entry) *)0)->next))); &entry->next != (&lk_ctx->lk_list); entry = t, t = ((typeof(*t) *)((char *)(t->next.next)-(unsigned long)(&((typeof(*t) *)0)->next)))) {
                ...
                if (entry->fl_type == lock->fl_type) {
                        ...
                        for (i = 0; i < 3; i++) {
                                ...
                                do { (&v.locks[i]->next)->next = (&v.locks[i]->next)->prev = &v.locks[i]->next; } while (0);
...
print_lock_list (fd_lk_ctx_t *lk_ctx)
{
        ...
        do { _gf_msg ("fd-lk", "./fd-lk.c", __FUNCTION__, 421, GF_LOG_DEBUG, 0, 0, 0, "lock list:"); } while (0);

        for (lk = ((typeof(*lk) *)((char *)((&lk_ctx->lk_list)->next)-(unsigned long)(&((typeof(*lk) *)0)->next))); &lk->next != (&lk_ctx->lk_list); lk = ((typeof(*lk) *)((char *)(lk->next.next)-(unsigned long)(&((typeof(*lk) *)0)->next))))
                do { _gf_msg ("fd-lk",
...
# 424 "./fd-lk.c"
 ...
 432
# 424 "./fd-lk.c"
                , GF_LOG_DEBUG, 0, 0, 0, "owner = %s, cmd = %s fl_type = %s," " fs_start = %""l" "d"", fs_end = %""l" "d"", " "user_flock: l_type = %s, l_start = %""l" "d"", " "l_len = %""l" "d"", ", lkowner_utoa (&lk->user_flock.l_owner), lk->cmd == 7 ? "F_SETLKW" : (lk->cmd == 6 ? "F_SETLK" : "F_GETLK"), lk->fl_type == 2 ? "F_UNLCK" : (lk->fl_type == 0 ? "F_RDLCK" : "F_WRLCK"), lk->fl_start, lk->fl_end, lk->user_flock.l_type == 2 ? "F_UNLCK" : (lk->user_flock.l_type == 0 ? "F_RDLCK" : "F_WRLCK"), lk->user_flock.l_start, lk->user_flock.l_len); } while (0)
...
{
        int32_t ret = -1;
        fd_lk_ctx_t *lk_ctx = ((void *)0);
        fd_lk_ctx_node_t *lk = ((void *)0);

        do { if (!fd) { (*__errno_location ()) = 22; do { _gf_msg ("fd-lk", "./fd-lk.c", __FUNCTION__, 443, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "fd"); } while (0); goto out; } } while (0);
        do { if (!flock) { (*__errno_location ()) = 22; do { _gf_msg ("fd-lk", "./fd-lk.c", __FUNCTION__, 444, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "flock"); } while (0); goto out; } } while (0);
...
# 449 "./fd-lk.c"
 ...
 455
# 449 "./fd-lk.c"
        , GF_LOG_DEBUG, 0, 0, 0, "new lock requrest: owner = %s, fl_type = %s" ", fs_start = %""l" "d"", fs_end = %""l" "d"", user_flock:" " l_type = %s, l_start = %""l" "d"", l_len = %""l" "d", lkowner_utoa (&flock->l_owner), lk->fl_type == 2 ? "F_UNLCK" : (lk->fl_type == 0 ? "F_RDLCK" : "F_WRLCK"), lk->fl_start, lk->fl_end, lk->user_flock.l_type == 2 ? "F_UNLCK" : (lk->user_flock.l_type == 0 ? "F_RDLCK" : "F_WRLCK"), lk->user_flock.l_start, lk->user_flock.l_len); } while (0)
