...
gf_fd_fdtable_expand (fdtable_t *fdtable, uint32_t nr)
{
        fdentry_t *oldfds = ((void *)0);
        uint32_t oldmax_fds = -1;
        int ret = -1;

        if (fdtable == ((void *)0) || nr > (4294967295U)) {
                do { _gf_msg ("fd",
 "./fd.c"
# 59 "./fd.c"
                , __FUNCTION__,
...
# 59 "./fd.c"
        ...
        fdtable->fdentries = __gf_calloc (nr, sizeof (fdentry_t), gf_common_mt_fdentry_t, "gf_common_mt_fdentry_t")
                                                               ;
...
gf_fd_fdtable_alloc (void)
{
        fdtable_t *fdtable = ((void *)0);

        fdtable = __gf_calloc (1, sizeof (*fdtable), gf_common_mt_fdtable_t, "gf_common_mt_fdtable_t");
        if (!fdtable)
                return ((void *)0);

        pthread_mutex_init (&fdtable->lock, ((void *)0));
...
# 127 "./fd.c"
 ...
 128
# 127 "./fd.c"
                , GF_LOG_WARNING, 22, 1, (100000 + 1000 + 172), "!count"); } while (0)
                                                               ;
                goto out;
        }

        fdentries = fdtable->fdentries;
        fdtable->fdentries = __gf_calloc (fdtable->max_fds, sizeof (fdentry_t), gf_common_mt_fdentry_t, "gf_common_mt_fdentry_t")
                                                               ;
...
# 167 "./fd.c"
        ...
        fdentries = __gf_calloc (fdtable->max_fds, sizeof (fdentry_t), gf_common_mt_fdentry_t, "gf_common_mt_fdentry_t")
                                                      ;
        if (fdentries == ((void *)0)) {
                goto out;
        }
        ...
        *count = fdtable->max_fds;
        ...
        for (i = 0; i < fdtable->max_fds; i++) {
                if (fdtable->fdentries[i].fd != ((void *)0)) {
...
# 220 "./fd.c"
 ...
 221
# 220 "./fd.c"
                , GF_LOG_WARNING, 22, 1, (100000 + 1000 + 172), "!fdtable"); } while (0)
                                                                 ;
                return;
        }
...
{
        int32_t fd = -1;
        fdentry_t *fde = ((void *)0);
        int error;
        int alloc_attempts = 0;

        if (fdtable == ((void *)0) || fdptr == ((void *)0)) {
                do { _gf_msg ("fd",
 "./fd.c"
# 256 "./fd.c"
                , __FUNCTION__,
...
# 275 "./fd.c"
 ...
 278
# 275 "./fd.c"
                                , GF_LOG_ERROR, 0, 0, (100000 + 1000 + 33), "multiple attempts to expand fd table" " have failed."); } while (0)
...
# 284 "./fd.c"
 ...
 286
# 284 "./fd.c"
                                , GF_LOG_ERROR, error, 0, (100000 + 1000 + 33), "Cannot expand fdtable"); } while (0)
...
# 375 "./fd.c"
 ...
 378
# 375 "./fd.c"
                        , GF_LOG_WARNING, 0, 1, (100000 + 1000 + 145), "fd (%p) is not present in fdtable", fd); } while (0)
...
# 451 "./fd.c"
 ...
 452
# 451 "./fd.c"
                , GF_LOG_ERROR, 22, 1, (100000 + 1000 + 172), "null fd"); } while (0)
                                                                ;
                return ((void *)0);
        }
...
__fd_unref (fd_t *fd)
{
        do { if (!(fd->refcount)) { do { _gf_msg ("", "./fd.c", __FUNCTION__, 467, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "fd->refcount"); } while (0); } } while (0);
...
# 489 "./fd.c"
 ...
 491
# 489 "./fd.c"
                , GF_LOG_ERROR, 0, 1, (100000 + 1000 + 180), "fd->inode is NULL"); } while (0)
...
# 548 "./fd.c"
 ...
 549
# 548 "./fd.c"
                , GF_LOG_ERROR, 22, 1, (100000 + 1000 + 172), "fd is NULL"); } while (0)
                                                                   ;
                return;
        }
...
# 590 "./fd.c"
 ...
 591
# 590 "./fd.c"
                , GF_LOG_ERROR, 22, 1, (100000 + 1000 + 172), "!fd || !fd->inode"); } while (0)
                                                                          ;
                return ((void *)0);
        }
...
# 611 "./fd.c"
        ...
        fd->_ctx = __gf_calloc (1, (sizeof (struct _fd_ctx) * fd->xl_count), gf_common_mt_fd_ctx, "gf_common_mt_fd_ctx")
                                                  ;
        if (!fd->_ctx)
                goto free_fd;
        ...
        fd->pid = pid;
        do { (&fd->inode_list)->next = (&fd->inode_list)->prev = &fd->inode_list; } while (0);
...
__fd_lookup (inode_t *inode, uint64_t pid)
{
        ...
        for (iter_fd = ((typeof(*iter_fd) *)((char *)((&inode->fd_list)->next)-(unsigned long)(&((typeof(*iter_fd) *)0)->inode_list))); &iter_fd->inode_list != (&inode->fd_list); iter_fd = ((typeof(*iter_fd) *)((char *)(iter_fd->inode_list.next)-(unsigned long)(&((typeof(*iter_fd) *)0)->inode_list)))) {
...
# 712 "./fd.c"
 ...
 713
# 712 "./fd.c"
                , GF_LOG_WARNING, 22, 1, (100000 + 1000 + 172), "!inode"); } while (0)
                                                               ;
                return ((void *)0);
        }
 ...
 if (!fd || !xlator)
  return -1;
        ...
        if (set_idx == -1) {
                ...
                tmp = __gf_realloc (fd->_ctx, (sizeof (struct _fd_ctx) * new_xl_count))
...
# 915 "./fd.c"
 ...
 916
# 915 "./fd.c"
                , GF_LOG_WARNING, 22, 1, (100000 + 1000 + 172), "%p %p", fd, xlator); } while (0)
                                                                          ;
  return -1;
        }
...
fd_dump (fd_t *fd, char *prefix)
{
        ...
        if (fd->inode) {
                { _gf_proc_dump_build_key(key, "inode", ((void *)0)); };
...
fdtable_dump (fdtable_t *fdtable, char *prefix)
{
        ...
        memset(key, 0, sizeof(key));
        { _gf_proc_dump_build_key(key, prefix, "refcount"); };
        gf_proc_dump_write(key, "%d", fdtable->refcount);
        { _gf_proc_dump_build_key(key, prefix, "maxfds"); };
        ...
        for ( i = 0 ; i < fdtable->max_fds; i++) {
                if (-2 ==
                    fdtable->fdentries[i].next_free) {
                        { _gf_proc_dump_build_key(key, prefix, "fdentry[%d]", i); };
                        gf_proc_dump_add_section(key);
...
fd_ctx_dump (fd_t *fd, char *prefix)
{
        struct _fd_ctx *fd_ctx = ((void *)0);
        xlator_t *xl = ((void *)0);
        int i = 0;


        if ((fd == ((void *)0)) || (fd->_ctx == ((void *)0))) {
                goto out;
        }
        ...
        {
                if (fd->_ctx != ((void *)0)) {
                        fd_ctx = __gf_calloc (fd->xl_count, sizeof (*fd_ctx), gf_common_mt_fd_ctx, "gf_common_mt_fd_ctx")
                                                                ;
                        if (fd_ctx == ((void *)0)) {
                                goto unlock;
                        }
