...
# 84 "./inode.c"
 ...
 85
# 84 "./inode.c"
                , GF_LOG_WARNING, 0, 1, (100000 + 1000 + 159), "dentry not found"); } while (0)
                                                                              ;
                return;
        }
...
# 128 "./inode.c"
        ...
        __gf_free (dentry->name);
        dentry->name = ((void *)0);

        if (dentry->parent) {
                __inode_unref (dentry->parent);
                dentry->parent = ((void *)0);
        }
...
__foreach_ancestor_dentry (dentry_t *dentry,
                           ...
                           void *data)
{
        inode_t *parent = ((void *)0);
        dentry_t *each = ((void *)0);
        int ret = 0;
...
# 167 "./inode.c"
 ...
 169
# 167 "./inode.c"
                , GF_LOG_WARNING, 0, 0, (100000 + 1000 + 182), "per dentry fn returned %d", ret); } while (0)
...
# 175 "./inode.c"
 ...
 177
# 175 "./inode.c"
                , GF_LOG_WARNING, 0, 0, (100000 + 1000 + 183), "parent not found"); } while (0)

                                           ;
                goto out;
        }

        for (each = ((typeof(*each) *)((char *)((&parent->dentry_list)->next)-(unsigned long)(&((typeof(*each) *)0)->inode_list))); &each->inode_list != (&parent->dentry_list); each = ((typeof(*each) *)((char *)(each->inode_list.next)-(unsigned long)(&((typeof(*each) *)0)->inode_list)))) {
...
__is_dentry_cyclic (dentry_t *dentry)
{
        ...
        if (ret) {
                ...
                do { _gf_msg (dentry->inode->table->name,
...
# 220 "./inode.c"
 ...
 223
# 220 "./inode.c"
                , GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 184), "detected cyclic loop " "formation during inode linkage. inode (%s) linking " "under itself as %s", uuid_utoa (inode->gfid), name); } while (0)
...
# 234 "./inode.c"
 ...
 235
# 234 "./inode.c"
                , GF_LOG_WARNING, 0, 1, (100000 + 1000 + 160), "inode not found"); } while (0)
                                                                            ;
                return;
        }
...
# 283 "./inode.c"
 ...
 285
# 283 "./inode.c"
                , GF_LOG_WARNING, 22, 1, (100000 + 1000 + 172), "inode || name not found"); } while (0)
        ...
        for (tmp = ((typeof(*tmp) *)((char *)((&inode->dentry_list)->next)-(unsigned long)(&((typeof(*tmp) *)0)->inode_list))); &tmp->inode_list != (&inode->dentry_list); tmp = ((typeof(*tmp) *)((char *)(tmp->inode_list.next)-(unsigned long)(&((typeof(*tmp) *)0)->inode_list)))) {
...
# 321 "./inode.c"
 ...
 322
# 321 "./inode.c"
                , GF_LOG_WARNING, 0, 0, (100000 + 1000 + 93), "_ctx not found"); } while (0)
                                         ;
                goto noctx;
        }
...
# 368 "./inode.c"
 ...
 369
# 368 "./inode.c"
                , GF_LOG_WARNING, 22, 1, (100000 + 1000 + 172), "invalid inode"); } while (0)
                                                                      ;
                return;
        }
...
# 374 "./inode.c"
 ...
 376
# 374 "./inode.c"
                , GF_LOG_WARNING, 22, 1, (100000 + 1000 + 172), "invalid inode context"); } while (0)
...
# 412 "./inode.c"
        ...
        for (dentry = ((typeof(*dentry) *)((char *)((&inode->dentry_list)->next)-(unsigned long)(&((typeof(*dentry) *)0)->inode_list))), t = ((typeof(*dentry) *)((char *)(dentry->inode_list.next)-(unsigned long)(&((typeof(*dentry) *)0)->inode_list))); &dentry->inode_list != (&inode->dentry_list); dentry = t, t = ((typeof(*t) *)((char *)(t->inode_list.next)-(unsigned long)(&((typeof(*t) *)0)->inode_list)))) {
...
__inode_unref (inode_t *inode)
{
        ...
        do { if (!(inode->ref)) { do { _gf_msg ("", "./inode.c", __FUNCTION__, 463, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "inode->ref"); } while (0); } } while (0);
...
# 556 "./inode.c"
 ...
 558
# 556 "./inode.c"
                , GF_LOG_WARNING, 22, 1, (100000 + 1000 + 172), "inode || parent || name not found"); } while (0)
        ...
        do { (&newd->inode_list)->next = (&newd->inode_list)->prev = &newd->inode_list; } while (0);
        do { (&newd->hash)->next = (&newd->hash)->prev = &newd->hash; } while (0);
...
# 594 "./inode.c"
 ...
 596
# 594 "./inode.c"
                , GF_LOG_WARNING, 0, 1, (100000 + 1000 + 161), "table not " "found"); } while (0)
        ...
        pthread_mutex_init (&newi->lock, 0);

        do { (&newi->fd_list)->next = (&newi->fd_list)->prev = &newi->fd_list; } while (0);
        do { (&newi->list)->next = (&newi->list)->prev = &newi->list; } while (0);
        do { (&newi->hash)->next = (&newi->hash)->prev = &newi->hash; } while (0);
        do { (&newi->dentry_list)->next = (&newi->dentry_list)->prev = &newi->dentry_list; } while (0);

        newi->_ctx = __gf_calloc (1, (sizeof (struct _inode_ctx) * table->ctxcount), gf_common_mt_inode_ctx, "gf_common_mt_inode_ctx")

                                                       ;
        if (newi->_ctx == ((void *)0)) {
                pthread_mutex_destroy (&newi->lock);
                mem_put (newi);
                newi = ((void *)0);
                goto out;
        }
...
# 639 "./inode.c"
 ...
 641
# 639 "./inode.c"
                , GF_LOG_WARNING, 0, 1, (100000 + 1000 + 161), "inode not " "found"); } while (0)
...
__inode_ref_reduce_by_n (inode_t *inode, uint64_t nref)
{
        ...
        do { if (!(inode->ref >= nref)) { do { _gf_msg ("", "./inode.c", __FUNCTION__, 673, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "inode->ref >= nref"); } while (0); } } while (0);
...
__inode_forget (inode_t *inode, uint64_t nlookup)
{
        ...
        do { if (!(inode->nlookup >= nlookup)) { do { _gf_msg ("", "./inode.c", __FUNCTION__, 711, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "inode->nlookup >= nlookup"); } while (0); } } while (0);
...
__dentry_grep (inode_table_t *table, inode_t *parent, const char *name)
{
        ...
        for (tmp = ((typeof(*tmp) *)((char *)((&table->name_hash[hash])->next)-(unsigned long)(&((typeof(*tmp) *)0)->hash))); &tmp->hash != (&table->name_hash[hash]); tmp = ((typeof(*tmp) *)((char *)(tmp->hash.next)-(unsigned long)(&((typeof(*tmp) *)0)->hash)))) {
...
# 752 "./inode.c"
 ...
 754
# 752 "./inode.c"
                , GF_LOG_WARNING, 22, 1, (100000 + 1000 + 172), "table || parent || name" " not found"); } while (0)
...
inode_resolve (inode_table_t *table, char *path)
{
        char *tmp = ((void *)0), *bname = ((void *)0), *str = ((void *)0), *saveptr = ((void *)0);
        inode_t *inode = ((void *)0), *parent = ((void *)0);

        if ((path == ((void *)0)) || (table == ((void *)0))) {
                goto out;
        }
...
# 875 "./inode.c"
        ...
        for (tmp = ((typeof(*tmp) *)((char *)((&table->inode_hash[hash])->next)-(unsigned long)(&((typeof(*tmp) *)0)->hash))); &tmp->hash != (&table->inode_hash[hash]); tmp = ((typeof(*tmp) *)((char *)(tmp->hash.next)-(unsigned long)(&((typeof(*tmp) *)0)->hash)))) {
...
{
        dentry_t *dentry = ((void *)0);
        dentry_t *old_dentry = ((void *)0);
        inode_t *old_inode = ((void *)0);
        inode_table_t *table = ((void *)0);
        inode_t *link_inode = ((void *)0);
        ...
        if (parent) {
                ...
                if (inode->table != parent->table) {
                        do { if (!(!"link attempted b/w inodes of diff table")) { do { _gf_msg ("", "./inode.c", __FUNCTION__, 944, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "!\"link attempted b/w inodes of diff table\""); } while (0); } } while (0);
                }

                if (parent->ia_type != IA_IFDIR) {
                        do { if (!(!"link attempted on non-directory parent")) { do { _gf_msg ("", "./inode.c", __FUNCTION__, 948, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "!\"link attempted on non-directory parent\""); } while (0); } } while (0);
                        return ((void *)0);
                }

                if (!name || strlen (name) == 0) {
                        do { if (!(!"link attempted with no basename on " "parent")) { do { _gf_msg ("",
 "./inode.c"
# 953 "./inode.c"
                        , __FUNCTION__,
 954
# 953 "./inode.c"
                        , GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "!\"link attempted with no basename on \" \"parent\""); } while (0); } } while (0)
                                             ;
                        return ((void *)0);
                }
        }
...
# 987 "./inode.c"
  old_inode = inode;
        ...
        if (name) {
                ...
                if (strchr (name, '/')) {
                        do { if (!(!"inode link attempted with '/' in name")) { do { _gf_msg ("", "./inode.c", __FUNCTION__, 995, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "!\"inode link attempted with '/' in name\""); } while (0); } } while (0);
                        return ((void *)0);
                }
        }
...
# 1007 "./inode.c"
 ...
 1012
# 1007 "./inode.c"
                                , GF_LOG_ERROR, 0, 1, (100000 + 1000 + 162), "dentry create failed on " "inode %s with parent %s", uuid_utoa (link_inode->gfid), uuid_utoa (parent->gfid)); } while (0)
...
# 1198 "./inode.c"
 ...
 1201
# 1198 "./inode.c"
                , GF_LOG_WARNING, 0, 0, (100000 + 1000 + 159), "%s/%s: dentry not found in %s", uuid_utoa_r (parent->gfid, pgfid), name, uuid_utoa_r (inode->gfid, gfid)); } while (0)
...
{
        dentry_t *dentry = ((void *)0);
        dentry_t *trav = ((void *)0);

        if (!inode)
                return ((void *)0);

        for (trav = ((typeof(*trav) *)((char *)((&inode->dentry_list)->next)-(unsigned long)(&((typeof(*trav) *)0)->inode_list))); &trav->inode_list != (&inode->dentry_list); trav = ((typeof(*trav) *)((char *)(trav->inode_list.next)-(unsigned long)(&((typeof(*trav) *)0)->inode_list)))) {
...
__inode_path (inode_t *inode, const char *name, char **bufp)
{
        ...
        if (!inode || gf_uuid_is_null (inode->gfid)) {
                do { if (!(0)) { do { _gf_msg ("", "./inode.c", __FUNCTION__, 1356, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "0"); } while (0); } } while (0);
                do { _gf_msg ((*__glusterfs_this_location())->name,
 "./inode.c"
# 1357 "./inode.c"
                , __FUNCTION__,
...
# 1371 "./inode.c"
 ...
 1374
# 1371 "./inode.c"
                        , GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 184), "possible infinite " "loop detected, forcing break. name=(%s)", name); } while (0)
        ...
        if (!__is_root_gfid (itrav->gfid)) {
                ...
                i += (sizeof ("<gfid:" "00000000-0000-0000-0000-000000000000" ">") - 1);
        }
        ...
        ret = i;
        size = i + 1;
        buf = __gf_calloc (size, sizeof (char), gf_common_mt_char, "gf_common_mt_char");
        if (buf) {
                ...
                if (!__is_root_gfid (itrav->gfid)) {
                        snprintf (&buf[i-(sizeof ("<gfid:" "00000000-0000-0000-0000-000000000000" ">") - 1)], (sizeof ("<gfid:" "00000000-0000-0000-0000-000000000000" ">") - 1),
...
out:
        if (__is_root_gfid (inode->gfid) && !name) {
                ret = 1;
                __gf_free (buf);
                buf = __gf_calloc (ret + 1, sizeof (char), gf_common_mt_char, "gf_common_mt_char");
                if (buf) {
                        strcpy (buf, "/");
                        *bufp = buf;
                } else {
...
inode_table_prune (inode_table_t *table)
{
        ...
        inode_t *del = ((void *)0);
        inode_t *tmp = ((void *)0);
        inode_t *entry = ((void *)0);

        if (!table)
                return -1;

        do { (&purge)->next = (&purge)->prev = &purge; } while (0);
        ...
        pthread_mutex_lock (&table->lock);
        {
                while (table->lru_limit
                       && table->lru_size > (table->lru_limit)) {
                        ...
                        entry = ((inode_t *)((char *)(table->lru.next)-(unsigned long)(&((inode_t *)0)->list)));
        ...
        {
                for (del = ((typeof(*del) *)((char *)((&purge)->next)-(unsigned long)(&((typeof(*del) *)0)->list))), tmp = ((typeof(*del) *)((char *)(del->list.next)-(unsigned long)(&((typeof(*del) *)0)->list))); &del->list != (&purge); del = tmp, tmp = ((typeof(*tmp) *)((char *)(tmp->list.next)-(unsigned long)(&((typeof(*tmp) *)0)->list)))) {
...
__inode_table_init_root (inode_table_t *table)
{
        ...
        __inode_link (root, ((void *)0), ((void *)0), &iatt);
        table->root = root;
}
...
inode_table_new (size_t lru_limit, xlator_t *xl)
{
        inode_table_t *new = ((void *)0);
        int ret = -1;
        int i = 0;

        new = (void *)__gf_calloc (1, sizeof (*new), gf_common_mt_inode_table_t, "gf_common_mt_inode_table_t");
        if (!new)
                return ((void *)0);
        ...
        new->inode_pool = mem_pool_new_fn (sizeof(inode_t), lru_limit, "inode_t");

        if (!new->inode_pool)
                goto out;

        new->dentry_pool = mem_pool_new_fn (sizeof(dentry_t), lru_limit, "dentry_t");

        if (!new->dentry_pool)
                goto out;

        new->inode_hash = (void *)__gf_calloc (65536, sizeof (struct list_head), gf_common_mt_list_head, "gf_common_mt_list_head")

                                                                    ;
        if (!new->inode_hash)
                goto out;

        new->name_hash = (void *)__gf_calloc (new->hashsize, sizeof (struct list_head), gf_common_mt_list_head, "gf_common_mt_list_head")
        ...
        new->fd_mem_pool = mem_pool_new_fn (sizeof(fd_t), 1024, "fd_t");

        if (!new->fd_mem_pool)
                goto out;

        for (i = 0; i < 65536; i++) {
                do { (&new->inode_hash[i])->next = (&new->inode_hash[i])->prev = &new->inode_hash[i]; } while (0);
        }


        for (i = 0; i < new->hashsize; i++) {
                do { (&new->name_hash[i])->next = (&new->name_hash[i])->prev = &new->name_hash[i]; } while (0);
        }

        do { (&new->active)->next = (&new->active)->prev = &new->active; } while (0);
        do { (&new->lru)->next = (&new->lru)->prev = &new->lru; } while (0);
        do { (&new->purge)->next = (&new->purge)->prev = &new->purge; } while (0);
        ...
        pthread_mutex_init (&new->lock, ((void *)0));

        ret = 0;
out:
        if (ret) {
                if (new) {
                        __gf_free (new->inode_hash);
                        __gf_free (new->name_hash);
                        if (new->dentry_pool)
...
inode_table_ctx_free (inode_table_t *table)
{
        ...
        pthread_mutex_lock (&table->lock);
        {
                for (del = ((typeof(*del) *)((char *)((&table->purge)->next)-(unsigned long)(&((typeof(*del) *)0)->list))), tmp = ((typeof(*del) *)((char *)(del->list.next)-(unsigned long)(&((typeof(*del) *)0)->list))); &del->list != (&table->purge); del = tmp, tmp = ((typeof(*tmp) *)((char *)(tmp->list.next)-(unsigned long)(&((typeof(*tmp) *)0)->list)))) {
                        if (del->_ctx) {
                ...
                for (del = ((typeof(*del) *)((char *)((&table->lru)->next)-(unsigned long)(&((typeof(*del) *)0)->list))), tmp = ((typeof(*del) *)((char *)(del->list.next)-(unsigned long)(&((typeof(*del) *)0)->list))); &del->list != (&table->lru); del = tmp, tmp = ((typeof(*tmp) *)((char *)(tmp->list.next)-(unsigned long)(&((typeof(*tmp) *)0)->list)))) {
                        if (del->_ctx) {
                                __inode_ctx_free (del);
                                lru_count++;
                        }
                ...
                for (del = ((typeof(*del) *)((char *)((&table->active)->next)-(unsigned long)(&((typeof(*del) *)0)->list))), tmp = ((typeof(*del) *)((char *)(del->list.next)-(unsigned long)(&((typeof(*del) *)0)->list))); &del->list != (&table->active); del = tmp, tmp = ((typeof(*tmp) *)((char *)(tmp->list.next)-(unsigned long)(&((typeof(*tmp) *)0)->list)))) {
                        if (del->_ctx) {
                                __inode_ctx_free (del);
                                active_count++;
                        }
...
# 1692 "./inode.c"
 ...
 1698
# 1692 "./inode.c"
        , GF_LOG_INFO, 0, 1, (100000 + 1000 + 163), "total %d (itable size: " "%d) inode contexts have been freed (active: %d, (" "active size: %d), lru: %d, (lru size: %d),  purge: " "%d, (purge size: %d))", ret, itable_size, active_count, table->active_size, lru_count, table->lru_size, purge_count, table->purge_size); } while (0)
...
inode_table_destroy_all (glusterfs_ctx_t *ctx) {
        ...
        glusterfs_graph_t *trav_graph = ((void *)0), *tmp = ((void *)0);
        xlator_t *tree = ((void *)0);
        inode_table_t *inode_table = ((void *)0);
        ...
        for (trav_graph = ((typeof(*trav_graph) *)((char *)((&ctx->graphs)->next)-(unsigned long)(&((typeof(*trav_graph) *)0)->list))), tmp = ((typeof(*trav_graph) *)((char *)(trav_graph->list.next)-(unsigned long)(&((typeof(*trav_graph) *)0)->list))); &trav_graph->list != (&ctx->graphs); trav_graph = tmp, tmp = ((typeof(*tmp) *)((char *)(tmp->list.next)-(unsigned long)(&((typeof(*tmp) *)0)->list)))) {
...
inode_table_destroy (inode_table_t *inode_table) {
        ...
        inode_t *tmp = ((void *)0), *trav = ((void *)0);

        if (inode_table == ((void *)0))
                return;
# 1756 "./inode.c"
...
# 1768 "./inode.c"
                while (!list_empty (&inode_table->lru)) {
                        for (trav = ((typeof(*trav) *)((char *)((&inode_table->lru)->next)-(unsigned long)(&((typeof(*trav) *)0)->list))), tmp = ((typeof(*trav) *)((char *)(trav->list.next)-(unsigned long)(&((typeof(*trav) *)0)->list))); &trav->list != (&inode_table->lru); trav = tmp, tmp = ((typeof(*tmp) *)((char *)(tmp->list.next)-(unsigned long)(&((typeof(*tmp) *)0)->list))))
                                                        {
                ...
                for (trav = ((typeof(*trav) *)((char *)((&inode_table->active)->next)-(unsigned long)(&((typeof(*trav) *)0)->list))), tmp = ((typeof(*trav) *)((char *)(trav->list.next)-(unsigned long)(&((typeof(*trav) *)0)->list))); &trav->list != (&inode_table->active); trav = tmp, tmp = ((typeof(*tmp) *)((char *)(tmp->list.next)-(unsigned long)(&((typeof(*tmp) *)0)->list))))
                                                {
...
# 1783 "./inode.c"
 ...
 1787
# 1783 "./inode.c"
                                , GF_LOG_WARNING, 0, 1, (100000 + 1000 + 171), "Active inode(%p) with refcount" "(%d) found during cleanup", trav, trav->ref); } while (0)
        ...
        __gf_free (inode_table->inode_hash);
        __gf_free (inode_table->name_hash);
        ...
        __gf_free (inode_table->name);
        __gf_free (inode_table);
...
inode_from_path (inode_table_t *itable, const char *path)
{
        ...
        char *component = ((void *)0), *next_component = ((void *)0);
        char *strtokptr = ((void *)0);
        ...
        while (component) {
                ...
                if (curr == ((void *)0)) {
                        strtok_r (((void *)0), "/", &strtokptr);
                        break;
                }

                next_component = strtok_r (((void *)0), "/", &strtokptr);
...
inode_set_need_lookup (inode_t *inode, xlator_t *this)
{
        ...
        inode_ctx_set0(inode,this,&need_lookup);
...
inode_needs_lookup (inode_t *inode, xlator_t *this)
{
        ...
        op_ret = inode_ctx_get0(inode,this,&need_lookup);
        if (op_ret == -1) {
                ret = _gf_true;
        } else if (need_lookup == 1) {
                ret = _gf_true;
                need_lookup = 2;
                inode_ctx_set0(inode,this,&need_lookup);
        }
...
{
        return __inode_ctx_set2 (inode, xlator, value1_p, ((void *)0));
}

int
__inode_ctx_set1 (inode_t *inode, xlator_t *xlator, uint64_t *value2_p)
{
        return __inode_ctx_set2 (inode, xlator, ((void *)0), value2_p);
}
...
__inode_ctx_get0 (inode_t *inode, xlator_t *xlator, uint64_t *value1)
{
        ...
        ret = __inode_ctx_get2 (inode, xlator, &tmp_value, ((void *)0));
        if (!ret && value1)
                *value1 = tmp_value;
...
__inode_ctx_get1 (inode_t *inode, xlator_t *xlator, uint64_t *value2)
{
        ...
        ret = __inode_ctx_get2 (inode, xlator, ((void *)0), &tmp_value);
        if (!ret && value2)
                *value2 = tmp_value;
                ...
                uint64_t *value2)
{
        ...
        pthread_mutex_lock (&inode->lock);
        {
                ...
                inode->_ctx[index].xl_key = ((void *)0);
...
inode_ctx_reset1 (inode_t *inode, xlator_t *xlator, uint64_t *value2_p)
{
        ...
        ret = __inode_ctx_reset2 (inode, xlator, ((void *)0), &tmp_value2);
...
inode_ctx_reset0 (inode_t *inode, xlator_t *xlator, uint64_t *value1_p)
{
        ...
        ret = __inode_ctx_reset2 (inode, xlator, &tmp_value1, ((void *)0));
...
inode_dump (inode_t *inode, char *prefix)
{
        ...
        int i = 0;
        fd_t *fd = ((void *)0);
        struct _inode_ctx *inode_ctx = ((void *)0);
        struct list_head fd_list;

        if (!inode)
                return;

        do { (&fd_list)->next = (&fd_list)->prev = &fd_list; } while (0);

        ret = pthread_mutex_trylock (&inode->lock);
        if (ret != 0) {
                return;
        }

        {
                ...
                if (inode->_ctx) {
                        inode_ctx = __gf_calloc (inode->table->ctxcount, sizeof (*inode_ctx), gf_common_mt_inode_ctx, "gf_common_mt_inode_ctx")
  ...
  if (dump_options.xl_options.dump_fdctx != _gf_true)
   goto unlock;
                ...
                for (fd = ((typeof(*fd) *)((char *)((&inode->fd_list)->next)-(unsigned long)(&((typeof(*fd) *)0)->inode_list))); &fd->inode_list != (&inode->fd_list); fd = ((typeof(*fd) *)((char *)(fd->inode_list.next)-(unsigned long)(&((typeof(*fd) *)0)->inode_list)))) {
...
inode_table_dump (inode_table_t *itable, char *prefix)
{
        ...
        { _gf_proc_dump_build_key(key, prefix, "hashsize"); };
        gf_proc_dump_write(key, "%d", itable->hashsize);
        { _gf_proc_dump_build_key(key, prefix, "name"); };
        gf_proc_dump_write(key, "%s", itable->name);

        { _gf_proc_dump_build_key(key, prefix, "lru_limit"); };
        gf_proc_dump_write(key, "%d", itable->lru_limit);
        { _gf_proc_dump_build_key(key, prefix, "active_size"); };
        gf_proc_dump_write(key, "%d", itable->active_size);
        { _gf_proc_dump_build_key(key, prefix, "lru_size"); };
        gf_proc_dump_write(key, "%d", itable->lru_size);
        { _gf_proc_dump_build_key(key, prefix, "purge_size"); };
        gf_proc_dump_write(key, "%d", itable->purge_size);

        { int i = 1; inode_t *inode = ((void *)0); for (inode = ((typeof(*inode) *)((char *)((&itable->active)->next)-(unsigned long)(&((typeof(*inode) *)0)->list))); &inode->list != (&itable->active); inode = ((typeof(*inode) *)((char *)(inode->list.next)-(unsigned long)(&((typeof(*inode) *)0)->list)))) { { _gf_proc_dump_build_key(key, prefix, "%s.%d","active", i++); }; gf_proc_dump_add_section(key); inode_dump(inode, key); } };
        { int i = 1; inode_t *inode = ((void *)0); for (inode = ((typeof(*inode) *)((char *)((&itable->lru)->next)-(unsigned long)(&((typeof(*inode) *)0)->list))); &inode->list != (&itable->lru); inode = ((typeof(*inode) *)((char *)(inode->list.next)-(unsigned long)(&((typeof(*inode) *)0)->list)))) { { _gf_proc_dump_build_key(key, prefix, "%s.%d","lru", i++); }; gf_proc_dump_add_section(key); inode_dump(inode, key); } };
        { int i = 1; inode_t *inode = ((void *)0); for (inode = ((typeof(*inode) *)((char *)((&itable->purge)->next)-(unsigned long)(&((typeof(*inode) *)0)->list))); &inode->list != (&itable->purge); inode = ((typeof(*inode) *)((char *)(inode->list.next)-(unsigned long)(&((typeof(*inode) *)0)->list)))) { { _gf_proc_dump_build_key(key, prefix, "%s.%d","purge", i++); }; gf_proc_dump_add_section(key); inode_dump(inode, key); } };
...
inode_table_dump_to_dict (inode_table_t *itable, char *prefix, dict_t *dict)
{
        ...
        for (inode = ((typeof(*inode) *)((char *)((&itable->active)->next)-(unsigned long)(&((typeof(*inode) *)0)->list))); &inode->list != (&itable->active); inode = ((typeof(*inode) *)((char *)(inode->list.next)-(unsigned long)(&((typeof(*inode) *)0)->list)))) {
                memset (key, 0, sizeof (key));
        ...
        for (inode = ((typeof(*inode) *)((char *)((&itable->lru)->next)-(unsigned long)(&((typeof(*inode) *)0)->list))); &inode->list != (&itable->lru); inode = ((typeof(*inode) *)((char *)(inode->list.next)-(unsigned long)(&((typeof(*inode) *)0)->list)))) {
                memset (key, 0, sizeof (key));
        ...
        for (inode = ((typeof(*inode) *)((char *)((&itable->purge)->next)-(unsigned long)(&((typeof(*inode) *)0)->list))); &inode->list != (&itable->purge); inode = ((typeof(*inode) *)((char *)(inode->list.next)-(unsigned long)(&((typeof(*inode) *)0)->list)))) {
                memset (key, 0, sizeof (key));
