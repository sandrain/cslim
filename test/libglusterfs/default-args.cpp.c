...
args_readdirp_cbk_store (default_args_cbk_t *args,
                       ...
                       gf_dirent_t *entries, dict_t *xdata)
{
        gf_dirent_t *stub_entry = ((void *)0), *entry = ((void *)0);
...
args_cbk_wipe (default_args_cbk_t *args_cbk)
{
        ...
        __gf_free ((char *)args_cbk->buf);

        __gf_free (args_cbk->vector);
        ...
        __gf_free (args_cbk->strong_checksum);
