...
{
        xlator_list_t *xlchild = ((void *)0);
        xlator_list_t *xlparent = ((void *)0);
        xlator_list_t **tmp = ((void *)0);

        xlparent = (void *) __gf_calloc (1, sizeof (*xlparent), gf_common_mt_xlator_list_t, "gf_common_mt_xlator_list_t")
                                                                  ;
        if (!xlparent)
                return -1;

        xlchild = (void *) __gf_calloc (1, sizeof (*xlchild), gf_common_mt_xlator_list_t, "gf_common_mt_xlator_list_t")
                                                                 ;
        if (!xlchild) {
                __gf_free (xlparent);
...
# 125 "./graph.c"
 ...
 127
# 125 "./graph.c"
                , GF_LOG_ERROR, 0, 0, (100000 + 1000 + 19), "volume \"%s\" can be added from command line only " "on client side", type); } while (0)
        ...
        ixl = __gf_calloc (1, sizeof (*ixl), gf_common_mt_xlator_t, "gf_common_mt_xlator_t");
        if (!ixl)
                return -1;
...
# 149 "./graph.c"
 ...
 151
# 149 "./graph.c"
                , GF_LOG_ERROR, 0, 0, (100000 + 1000 + 89), "%s (%s) initialization failed", name, type); } while (0)
...
glusterfs_graph_mac_compat (glusterfs_graph_t *graph, glusterfs_ctx_t *ctx)
{
        ...
        if (cmd_args->mac_compat == _gf_false)
                return 0;
...
gf_add_cmdline_options (glusterfs_graph_t *graph, cmd_args_t *cmd_args)
{
        ...
        xlator_cmdline_option_t *cmd_option = ((void *)0);

        trav = graph->first;

        while (trav) {
                for (cmd_option = ((typeof(*cmd_option) *)((char *)((&cmd_args->xlator_options)->next)-(unsigned long)(&((typeof(*cmd_option) *)0)->cmd_args))); &cmd_option->cmd_args != (&cmd_args->xlator_options); cmd_option = ((typeof(*cmd_option) *)((char *)(cmd_option->cmd_args.next)-(unsigned long)(&((typeof(*cmd_option) *)0)->cmd_args))))
                                                                          {
...
# 264 "./graph.c"
 ...
 269
# 264 "./graph.c"
                                        , GF_LOG_INFO, 0, 0, (100000 + 1000 + 173), "adding option '%s' for " "volume '%s' with value '%s'", cmd_option->key, trav->name, cmd_option->value); } while (0)
...
# 271 "./graph.c"
 ...
 275
# 271 "./graph.c"
                                        , GF_LOG_WARNING, -ret, 0, (100000 + 1000 + 173), "adding option '%s' for " "volume '%s' failed", cmd_option->key, trav->name); } while (0)
...
# 299 "./graph.c"
 ...
 301
# 299 "./graph.c"
                        , GF_LOG_ERROR, 0, 0, (100000 + 1000 + 90), "validation failed: " "%s", errstr); } while (0)
...
# 322 "./graph.c"
 ...
 324
# 322 "./graph.c"
                        , GF_LOG_ERROR, 0, 0, (100000 + 1000 + 66), "initializing translator failed"); } while (0)
...
# 358 "./graph.c"
 ...
 360
# 358 "./graph.c"
                , GF_LOG_WARNING, 0, 0, (100000 + 1000 + 174), "option '%s' is not recognized", key); } while (0)
...
{
        xlator_foreach (graph->first, _xlator_check_unknown_options, ((void *)0));
        return 0;
}
...
# 467 "./graph.c"
 ...
 468
# 467 "./graph.c"
                , GF_LOG_ERROR, 0, 0, (100000 + 1000 + 91), "glusterfs graph settop failed"); } while (0)
                                                        ;
                return -1;
        }
...
# 475 "./graph.c"
 ...
 476
# 475 "./graph.c"
                , GF_LOG_ERROR, 0, 0, (100000 + 1000 + 91), "glusterfs graph worm failed"); } while (0)
                                                      ;
                return -1;
        }
...
# 481 "./graph.c"
 ...
 482
# 481 "./graph.c"
                , GF_LOG_ERROR, 0, 0, (100000 + 1000 + 91), "glusterfs graph ACL failed"); } while (0)
                                                     ;
                return -1;
        }
...
# 489 "./graph.c"
 ...
 490
# 489 "./graph.c"
                , GF_LOG_ERROR, 0, 0, (100000 + 1000 + 91), "glusterfs graph mac compat failed"); } while (0)
                                                            ;
                return -1;
        }
...
# 497 "./graph.c"
 ...
 498
# 497 "./graph.c"
                , GF_LOG_ERROR, 0, 0, (100000 + 1000 + 91), "glusterfs graph 'gfid-access' failed"); } while (0)
                                                               ;
                return -1;
        }
...
# 505 "./graph.c"
 ...
 506
# 505 "./graph.c"
  , GF_LOG_ERROR, 0, 0, (100000 + 1000 + 91), "glusterfs graph meta failed"); } while (0)
                                 ;
  return -1;
 }
...
# 661 "./graph.c"
 ...
 662
# 661 "./graph.c"
                , GF_LOG_ERROR, 0, 0, (100000 + 1000 + 90), "validate options failed"); } while (0)
                                                  ;
                return ret;
        }
...
# 669 "./graph.c"
 ...
 670
# 669 "./graph.c"
                , GF_LOG_ERROR, 0, 0, (100000 + 1000 + 176), "init failed"); } while (0)
                                      ;
                return ret;
        }
...
# 676 "./graph.c"
 ...
 678
# 676 "./graph.c"
                , GF_LOG_ERROR, 0, 0, (100000 + 1000 + 92), "unknown options " "failed"); } while (0)
...
# 691 "./graph.c"
 ...
 693
# 691 "./graph.c"
                        , GF_LOG_ERROR, 0, 0, (100000 + 1000 + 177), "graph new notification failed"); } while (0)
...
# 702 "./graph.c"
 ...
 703
# 702 "./graph.c"
                , GF_LOG_ERROR, 0, 0, (100000 + 1000 + 177), "parent up notification failed"); } while (0)
                                                        ;
                return ret;
        }
...
xlator_equal_rec (xlator_t *xl1, xlator_t *xl2)
{
        ...
        if (xl1 == ((void *)0) || xl2 == ((void *)0)) {
                do { _gf_msg ("xlator", "./graph.c", __FUNCTION__, 719, GF_LOG_DEBUG, 0, 0, 0, "invalid argument"); } while (0);
                return -1;
        }
        ...
        while (trav1 && trav2) {
                ...
                if (ret) {
                        do { _gf_msg ("glusterfsd-mgmt",
 "./graph.c"
# 729 "./graph.c"
                        , __FUNCTION__,
 730
# 729 "./graph.c"
                        , GF_LOG_DEBUG, 0, 0, 0, "xlators children " "not equal"); } while (0)
                                                  ;
                        goto out;
                }
...
is_graph_topology_equal (glusterfs_graph_t *graph1, glusterfs_graph_t *graph2)
{
        xlator_t *trav1 = ((void *)0);
        xlator_t *trav2 = ((void *)0);
        ...
        if (ret) {
                do { _gf_msg ("glusterfsd-mgmt", "./graph.c", __FUNCTION__, 774, GF_LOG_DEBUG, 0, 0, 0, "graphs are not equal"); } while (0);
                ret = _gf_false;
                goto out;
        }

        ret = _gf_true;
        do { _gf_msg ("glusterfsd-mgmt", "./graph.c", __FUNCTION__, 780, GF_LOG_DEBUG, 0, 0, 0, "graphs are equal"); } while (0);
...
glusterfs_volfile_reconfigure (int oldvollen, FILE *newvolfile_fp,
                               glusterfs_ctx_t *ctx, const char *oldvolfile)
{
        glusterfs_graph_t *oldvolfile_graph = ((void *)0);
        glusterfs_graph_t *newvolfile_graph = ((void *)0);
        FILE *oldvolfile_fp = ((void *)0);
...
# 815 "./graph.c"
 ...
 816
# 815 "./graph.c"
                , GF_LOG_ERROR, 0, 0, (100000 + 1000 + 93), "ctx is NULL"); } while (0)
                 ;
  goto out;
 }
...
# 823 "./graph.c"
 ...
 825
# 823 "./graph.c"
                , GF_LOG_ERROR, 0, 0, (100000 + 1000 + 178), "glusterfs_ctx->active is NULL"); } while (0)
...
# 829 "./graph.c"
 ...
 831
# 829 "./graph.c"
                        , GF_LOG_ERROR, (*__errno_location ()), 0, (100000 + 1000 + 94), "Unable to " "create temporary volfile"); } while (0)
...
# 841 "./graph.c"
 ...
 843
# 841 "./graph.c"
                        , GF_LOG_ERROR, (*__errno_location ()), 0, (100000 + 1000 + 199), "Temporary file" " delete failed."); } while (0)
...
# 875 "./graph.c"
 ...
 876
# 875 "./graph.c"
                , GF_LOG_DEBUG, 0, 0, 0, "Graph topology not " "equal(should call INIT)"); } while (0)
                                                        ;
                goto out;
        }
...
# 880 "./graph.c"
 ...
 881
# 880 "./graph.c"
        , GF_LOG_DEBUG, 0, 0, 0, "Only options have changed in the" " new graph"); } while (0)
                                   ;
...
# 887 "./graph.c"
 ...
 888
# 887 "./graph.c"
                , GF_LOG_DEBUG, 0, 0, 0, "Could not reconfigure " "new options in old graph"); } while (0)
                                                         ;
                goto out;
        }
...
glusterfs_graph_reconfigure (glusterfs_graph_t *oldgraph,
                             glusterfs_graph_t *newgraph)
{
        xlator_t *old_xl = ((void *)0);
        xlator_t *new_xl = ((void *)0);

        do { if (!(oldgraph)) { do { _gf_msg ("", "./graph.c", __FUNCTION__, 920, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "oldgraph"); } while (0); } } while (0);
        do { if (!(newgraph)) { do { _gf_msg ("", "./graph.c", __FUNCTION__, 921, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "newgraph"); } while (0); } } while (0);
...
glusterfs_graph_destroy (glusterfs_graph_t *graph)
{
        ...
        do { if (!graph) { (*__errno_location ()) = 22; do { _gf_msg ("graph", "./graph.c", __FUNCTION__, 979, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "graph"); } while (0); goto out; } } while (0);
