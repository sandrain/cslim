...
# 31 "./options.c"
 ...
 32
# 31 "./options.c"
                , GF_LOG_ERROR, 0, 0, (100000 + 1000 + 2), "%s", errstr); } while (0)
                               ;
                goto out;
        }
...
# 85 "./options.c"
 ...
 86
# 85 "./options.c"
                , GF_LOG_TRACE, 0, 0, 0, "no range check required for " "'option %s %s'", key, value); } while (0)
                                                           ;
                ret = 0;
                goto out;
        }
...
# 116 "./options.c"
 ...
 117
# 116 "./options.c"
                , GF_LOG_ERROR, 0, 0, (100000 + 1000 + 28), "%s", errstr); } while (0)
                               ;
                goto out;
        }
...
# 149 "./options.c"
        ...
        if ((size < opt->min) || (size > opt->max)) {
                if ((strncmp (key, "cache-size", 10) == 0) &&
                    (size > opt->max)) {
                       snprintf (errstr, 256, "Cache size %" "zu" " is out of "
                                 "range [%.0f - %.0f]",
...
# 160 "./options.c"
 ...
 161
# 160 "./options.c"
                       , GF_LOG_WARNING, 0, 0, (100000 + 1000 + 28), "%s", errstr); } while (0)
                                                                 ;
                } else {
                        snprintf (errstr, 256,
                                  "'%" "zu" "' in 'option %s %s' "
                            ...
                            volume_option_t *opt, char **op_errstr)
{
        ...
        for (i = 0; (i < 64) && opt->value[i]; i++) {
                ...
                if (fnmatch (opt->value[i], value, (1 << 5)) == 0) {
                        ret = 0;
                        break;
                }
...
# 445 "./options.c"
 ...
 snprintf (errstr, 256,
    "invalid number format \"%s\" in \"option %s\"",
    value, key);
 do { _gf_msg (xl->name, "./options.c", __FUNCTION__, 458, GF_LOG_ERROR, 0, 0, (100000 + 1000 + 2), "%s", errstr); } while (0);
                                  ...
                                  char **op_errstr)
{
        ...
        while (addr_tok) {
                ...
                addr_tok = strtok_r (((void *)0), ",", &save_ptr);
        }
        ret = 0;
...
gf_validate_size (const char *sizestr, volume_option_t *opt)
{
        ...
        do { if (!(opt)) { do { _gf_msg ("", "./options.c", __FUNCTION__, 687, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "opt"); } while (0); } } while (0);
 ...
 out:
        do { _gf_msg ((*__glusterfs_this_location())->name, "./options.c", __FUNCTION__, 697, GF_LOG_DEBUG, 0, 0, 0, "Returning %d", ret); } while (0);
        return ret;
}
                        ...
                        int (value_validator)( const char *, volume_option_t *))
{
        ...
        char *dup_string = ((void *)0);
        char *str_sav = ((void *)0);
        char *substr_sav = ((void *)0);
        char *str_ptr = ((void *)0);
        char *key = ((void *)0);
        char *value = ((void *)0);
        int ret = 0;

        do { if (!(string)) { do { _gf_msg ("", "./options.c", __FUNCTION__, 724, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "string"); } while (0); } } while (0);

        dup_string = gf_strdup (string);
        if (((void *)0) == dup_string)
                goto out;
...
# 741 "./options.c"
 ...
 743
# 741 "./options.c"
                        , GF_LOG_WARNING, 0, 0, (100000 + 1000 + 2), "invalid list '%s', key " "'%s' not valid.", string, key); } while (0)

                                                               ;
                        goto out;
                }

                value = strtok_r (((void *)0), ":", &substr_sav);
                if (!value ||
...
# 751 "./options.c"
 ...
 753
# 751 "./options.c"
                        , GF_LOG_WARNING, 0, 0, (100000 + 1000 + 2), "invalid list '%s', " "value '%s' not valid.", string, key); } while (0)

                                                                     ;
                        goto out;
                }

                str_ptr = strtok_r (((void *)0), ",", &str_sav);
                substr_sav = ((void *)0);
        }

 out:
        __gf_free (dup_string);
        do { _gf_msg ((*__glusterfs_this_location())->name, "./options.c", __FUNCTION__, 763, GF_LOG_DEBUG, 0, 0, 0, "Returning %d", ret); } while (0);
        return ret;
}
                                      ...
                                      char **op_errstr)
{
        ...
        do { if (!(value)) { do { _gf_msg ("", "./options.c", __FUNCTION__, 775, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "value"); } while (0); } } while (0);

        ret = validate_list_elements (value, opt, ((void *)0), &gf_validate_number);
        if (ret) {
                                  ...
                                  char **op_errstr)
{
        ...
        do { if (!(value)) { do { _gf_msg ("", "./options.c", __FUNCTION__, 797, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "value"); } while (0); } } while (0);

        ret = gf_validate_size (value, opt);
        if (ret)
                ret = validate_list_elements (value, opt, ((void *)0), &gf_validate_size);
...
# 855 "./options.c"
 ...
 856
# 855 "./options.c"
                , GF_LOG_ERROR, 0, 0, (100000 + 1000 + 2), "unknown option type '%d'", opt->type); } while (0)
                                                              ;
                goto out;
        }
...
xlator_volume_option_get_list (volume_opt_list_t *vol_list, const char *key)
{
        volume_option_t *opt = ((void *)0);
        volume_opt_list_t *opt_list = ((void *)0);
        volume_option_t *found = ((void *)0);
        int index = 0;
        int i = 0;
        char *cmp_key = ((void *)0);

        if (!vol_list->given_opt) {
                opt_list = ((volume_opt_list_t *)((char *)(vol_list->list.next)-(unsigned long)(&((volume_opt_list_t *)0)->list)))
                                            ;
...
xlator_volume_option_get (xlator_t *xl, const char *key)
{
        volume_opt_list_t *vol_list = ((void *)0);
        volume_option_t *found = ((void *)0);

        for (vol_list = ((typeof(*vol_list) *)((char *)((&xl->volume_options)->next)-(unsigned long)(&((typeof(*vol_list) *)0)->list))); &vol_list->list != (&xl->volume_options); vol_list = ((typeof(*vol_list) *)((char *)(vol_list->list.next)-(unsigned long)(&((typeof(*vol_list) *)0)->list)))) {
...
{
        xlator_t *xl = ((void *)0);
        volume_opt_list_t *vol_opt = ((void *)0);
        volume_option_t *opt = ((void *)0);
        int ret = 0;
        char *errstr = ((void *)0);
...
# 942 "./options.c"
 ...
 943
# 942 "./options.c"
                , GF_LOG_WARNING, 0, 0, (100000 + 1000 + 29), "validate of %s returned %d", key, ret); } while (0)
                                                               ;
        ...
        if (fnmatch (opt->key[0], key, (1 << 1)) != 0) {
                do { _gf_msg (xl->name,
...
# 950 "./options.c"
 ...
 952
# 950 "./options.c"
                , GF_LOG_WARNING, 0, 0, (100000 + 1000 + 2), "option '%s' is deprecated, preferred is '%s', " "continuing with correction", key, opt->key[0]); } while (0)
...
xlator_options_validate (xlator_t *xl, dict_t *options, char **op_errstr)
{
        ...
        if (!xl) {
                do { _gf_msg ((*__glusterfs_this_location())->name, "./options.c", __FUNCTION__, 994, GF_LOG_DEBUG, 0, 0, 0, "'this' not a valid ptr"); } while (0);
                ret = -1;
                goto out;
        }
        ...
        for (vol_opt = ((typeof(*vol_opt) *)((char *)((&xl->volume_options)->next)-(unsigned long)(&((typeof(*vol_opt) *)0)->list))); &vol_opt->list != (&xl->volume_options); vol_opt = ((typeof(*vol_opt) *)((char *)(vol_opt->list.next)-(unsigned long)(&((typeof(*vol_opt) *)0)->list)))) {
...
{
        int ret = -1;
        xlator_list_t *trav = ((void *)0);
        xlator_t *old_THIS = ((void *)0);

        do { if (!xlator) { (*__errno_location ()) = 22; do { _gf_msg ("xlator", "./options.c", __FUNCTION__, 1018, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "xlator"); } while (0); goto out; } } while (0);
...
# 1024 "./options.c"
 ...
 1026
# 1024 "./options.c"
                        , GF_LOG_WARNING, 0, 0, (100000 + 1000 + 30), "validate_rec " "failed"); } while (0)
        ...
        if (xlator_dynload (xlator))
                do { _gf_msg (xlator->name, "./options.c", __FUNCTION__, 1034, GF_LOG_DEBUG, 0, 0, 0, "Did not load the symbols"); } while (0);

        old_THIS = (*__glusterfs_this_location());
        (*__glusterfs_this_location()) = xlator;
        ...
        if (ret) {
                do { _gf_msg (xlator->name,
 "./options.c"
# 1050 "./options.c"
                , __FUNCTION__,
 1051
# 1050 "./options.c"
                , GF_LOG_INFO, 0, 0, (100000 + 1000 + 2), "%s", *op_errstr); } while (0)
                                         ;
                goto out;
        }

        do { _gf_msg (xlator->name, "./options.c", __FUNCTION__, 1055, GF_LOG_DEBUG, 0, 0, 0, "Validated options"); } while (0);
...
{
        xlator_t *xlator = ((void *)0);
        int ret = -1;

        do { if (!(graph)) { do { _gf_msg ("", "./options.c", __FUNCTION__, 1069, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "graph"); } while (0); } } while (0);
...
{
        xlator_list_t *trav1 = ((void *)0);
        xlator_list_t *trav2 = ((void *)0);
        int32_t ret = -1;
        xlator_t *old_THIS = ((void *)0);

        do { if (!old_xl) { (*__errno_location ()) = 22; do { _gf_msg ("xlator", "./options.c", __FUNCTION__, 1087, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "old_xl"); } while (0); goto out; } } while (0);
        do { if (!new_xl) { (*__errno_location ()) = 22; do { _gf_msg ("xlator", "./options.c", __FUNCTION__, 1088, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "new_xl"); } while (0); goto out; } } while (0);
        ...
        while (trav1 && trav2) {
                ...
                do { _gf_msg (trav1->xlator->name, "./options.c", __FUNCTION__, 1098, GF_LOG_DEBUG, 0, 0, 0, "reconfigured"); } while (0);
        ...
        if (old_xl->reconfigure) {
                old_THIS = (*__glusterfs_this_location());
                (*__glusterfs_this_location()) = old_xl;
                ...
                do { _gf_msg (old_xl->name, "./options.c", __FUNCTION__, 1115, GF_LOG_DEBUG, 0, 0, 0, "No reconfigure() found"); } while (0);
        }
...
{
        xlator_t *new_top = ((void *)0);
        xlator_t *old_top = ((void *)0);

        do { if (!(old_xl)) { do { _gf_msg ("", "./options.c", __FUNCTION__, 1130, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "old_xl"); } while (0); } } while (0);
        do { if (!(new_xl)) { do { _gf_msg ("", "./options.c", __FUNCTION__, 1131, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "new_xl"); } while (0); } } while (0);
...
xl_by_name (char *in, xlator_t **out)
{
        ...
        xl = xlator_search_by_name ((*__glusterfs_this_location()), in);
...
int xlator_option_init_str (xlator_t *this, dict_t *options, char *key, char * *val_p) { int ret = 0; volume_option_t *opt = ((void *)0); char *def_value = ((void *)0); char *set_value = ((void *)0); char *value = ((void *)0); xlator_t *old_THIS = ((void *)0); opt = xlator_volume_option_get (this, key); if (!opt) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1208, GF_LOG_WARNING, 22, 0, (100000 + 1000 + 2), "unknown option: %s", key); } while (0); ret = -1; return ret; } def_value = opt->default_value; ret = dict_get_str (options, key, &set_value); if (def_value) value = def_value; if (set_value) value = set_value; if (!value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1208, GF_LOG_TRACE, 0, 0, 0, "option %s not set", key); } while (0); *val_p = (char *)0; return 0; } if (value == def_value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1208, GF_LOG_TRACE, 0, 0, 0, "option %s using default" " value %s", key, value); } while (0); } else { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1208, GF_LOG_DEBUG, 0, 0, 0, "option %s using set" " value %s", key, value); } while (0); } old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = this; ret = pass (value, val_p); (*__glusterfs_this_location()) = old_THIS; if (ret) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1208, GF_LOG_INFO, 0, 0, (100000 + 1000 + 84), "option %s conversion failed value %s", key, value); } while (0); return ret; } ret = xlator_option_validate (this, key, value, opt, ((void *)0)); return ret; };
int xlator_option_init_uint64 (xlator_t *this, dict_t *options, char *key, uint64_t *val_p) { int ret = 0; volume_option_t *opt = ((void *)0); char *def_value = ((void *)0); char *set_value = ((void *)0); char *value = ((void *)0); xlator_t *old_THIS = ((void *)0); opt = xlator_volume_option_get (this, key); if (!opt) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1209, GF_LOG_WARNING, 22, 0, (100000 + 1000 + 2), "unknown option: %s", key); } while (0); ret = -1; return ret; } def_value = opt->default_value; ret = dict_get_str (options, key, &set_value); if (def_value) value = def_value; if (set_value) value = set_value; if (!value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1209, GF_LOG_TRACE, 0, 0, 0, "option %s not set", key); } while (0); *val_p = (uint64_t)0; return 0; } if (value == def_value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1209, GF_LOG_TRACE, 0, 0, 0, "option %s using default" " value %s", key, value); } while (0); } else { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1209, GF_LOG_DEBUG, 0, 0, 0, "option %s using set" " value %s", key, value); } while (0); } old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = this; ret = gf_string2uint64 (value, val_p); (*__glusterfs_this_location()) = old_THIS; if (ret) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1209, GF_LOG_INFO, 0, 0, (100000 + 1000 + 84), "option %s conversion failed value %s", key, value); } while (0); return ret; } ret = xlator_option_validate (this, key, value, opt, ((void *)0)); return ret; };
int xlator_option_init_int64 (xlator_t *this, dict_t *options, char *key, int64_t *val_p) { int ret = 0; volume_option_t *opt = ((void *)0); char *def_value = ((void *)0); char *set_value = ((void *)0); char *value = ((void *)0); xlator_t *old_THIS = ((void *)0); opt = xlator_volume_option_get (this, key); if (!opt) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1210, GF_LOG_WARNING, 22, 0, (100000 + 1000 + 2), "unknown option: %s", key); } while (0); ret = -1; return ret; } def_value = opt->default_value; ret = dict_get_str (options, key, &set_value); if (def_value) value = def_value; if (set_value) value = set_value; if (!value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1210, GF_LOG_TRACE, 0, 0, 0, "option %s not set", key); } while (0); *val_p = (int64_t)0; return 0; } if (value == def_value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1210, GF_LOG_TRACE, 0, 0, 0, "option %s using default" " value %s", key, value); } while (0); } else { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1210, GF_LOG_DEBUG, 0, 0, 0, "option %s using set" " value %s", key, value); } while (0); } old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = this; ret = gf_string2int64 (value, val_p); (*__glusterfs_this_location()) = old_THIS; if (ret) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1210, GF_LOG_INFO, 0, 0, (100000 + 1000 + 84), "option %s conversion failed value %s", key, value); } while (0); return ret; } ret = xlator_option_validate (this, key, value, opt, ((void *)0)); return ret; };
int xlator_option_init_uint32 (xlator_t *this, dict_t *options, char *key, uint32_t *val_p) { int ret = 0; volume_option_t *opt = ((void *)0); char *def_value = ((void *)0); char *set_value = ((void *)0); char *value = ((void *)0); xlator_t *old_THIS = ((void *)0); opt = xlator_volume_option_get (this, key); if (!opt) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1211, GF_LOG_WARNING, 22, 0, (100000 + 1000 + 2), "unknown option: %s", key); } while (0); ret = -1; return ret; } def_value = opt->default_value; ret = dict_get_str (options, key, &set_value); if (def_value) value = def_value; if (set_value) value = set_value; if (!value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1211, GF_LOG_TRACE, 0, 0, 0, "option %s not set", key); } while (0); *val_p = (uint32_t)0; return 0; } if (value == def_value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1211, GF_LOG_TRACE, 0, 0, 0, "option %s using default" " value %s", key, value); } while (0); } else { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1211, GF_LOG_DEBUG, 0, 0, 0, "option %s using set" " value %s", key, value); } while (0); } old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = this; ret = gf_string2uint32 (value, val_p); (*__glusterfs_this_location()) = old_THIS; if (ret) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1211, GF_LOG_INFO, 0, 0, (100000 + 1000 + 84), "option %s conversion failed value %s", key, value); } while (0); return ret; } ret = xlator_option_validate (this, key, value, opt, ((void *)0)); return ret; };
int xlator_option_init_int32 (xlator_t *this, dict_t *options, char *key, int32_t *val_p) { int ret = 0; volume_option_t *opt = ((void *)0); char *def_value = ((void *)0); char *set_value = ((void *)0); char *value = ((void *)0); xlator_t *old_THIS = ((void *)0); opt = xlator_volume_option_get (this, key); if (!opt) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1212, GF_LOG_WARNING, 22, 0, (100000 + 1000 + 2), "unknown option: %s", key); } while (0); ret = -1; return ret; } def_value = opt->default_value; ret = dict_get_str (options, key, &set_value); if (def_value) value = def_value; if (set_value) value = set_value; if (!value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1212, GF_LOG_TRACE, 0, 0, 0, "option %s not set", key); } while (0); *val_p = (int32_t)0; return 0; } if (value == def_value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1212, GF_LOG_TRACE, 0, 0, 0, "option %s using default" " value %s", key, value); } while (0); } else { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1212, GF_LOG_DEBUG, 0, 0, 0, "option %s using set" " value %s", key, value); } while (0); } old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = this; ret = gf_string2int32 (value, val_p); (*__glusterfs_this_location()) = old_THIS; if (ret) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1212, GF_LOG_INFO, 0, 0, (100000 + 1000 + 84), "option %s conversion failed value %s", key, value); } while (0); return ret; } ret = xlator_option_validate (this, key, value, opt, ((void *)0)); return ret; };
int xlator_option_init_size (xlator_t *this, dict_t *options, char *key, size_t *val_p) { int ret = 0; volume_option_t *opt = ((void *)0); char *def_value = ((void *)0); char *set_value = ((void *)0); char *value = ((void *)0); xlator_t *old_THIS = ((void *)0); opt = xlator_volume_option_get (this, key); if (!opt) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1213, GF_LOG_WARNING, 22, 0, (100000 + 1000 + 2), "unknown option: %s", key); } while (0); ret = -1; return ret; } def_value = opt->default_value; ret = dict_get_str (options, key, &set_value); if (def_value) value = def_value; if (set_value) value = set_value; if (!value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1213, GF_LOG_TRACE, 0, 0, 0, "option %s not set", key); } while (0); *val_p = (size_t)0; return 0; } if (value == def_value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1213, GF_LOG_TRACE, 0, 0, 0, "option %s using default" " value %s", key, value); } while (0); } else { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1213, GF_LOG_DEBUG, 0, 0, 0, "option %s using set" " value %s", key, value); } while (0); } old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = this; ret = gf_string2bytesize_size (value, val_p); (*__glusterfs_this_location()) = old_THIS; if (ret) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1213, GF_LOG_INFO, 0, 0, (100000 + 1000 + 84), "option %s conversion failed value %s", key, value); } while (0); return ret; } ret = xlator_option_validate (this, key, value, opt, ((void *)0)); return ret; };
int xlator_option_init_size_uint64 (xlator_t *this, dict_t *options, char *key, uint64_t *val_p) { int ret = 0; volume_option_t *opt = ((void *)0); char *def_value = ((void *)0); char *set_value = ((void *)0); char *value = ((void *)0); xlator_t *old_THIS = ((void *)0); opt = xlator_volume_option_get (this, key); if (!opt) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1214, GF_LOG_WARNING, 22, 0, (100000 + 1000 + 2), "unknown option: %s", key); } while (0); ret = -1; return ret; } def_value = opt->default_value; ret = dict_get_str (options, key, &set_value); if (def_value) value = def_value; if (set_value) value = set_value; if (!value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1214, GF_LOG_TRACE, 0, 0, 0, "option %s not set", key); } while (0); *val_p = (uint64_t)0; return 0; } if (value == def_value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1214, GF_LOG_TRACE, 0, 0, 0, "option %s using default" " value %s", key, value); } while (0); } else { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1214, GF_LOG_DEBUG, 0, 0, 0, "option %s using set" " value %s", key, value); } while (0); } old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = this; ret = gf_string2bytesize_uint64 (value, val_p); (*__glusterfs_this_location()) = old_THIS; if (ret) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1214, GF_LOG_INFO, 0, 0, (100000 + 1000 + 84), "option %s conversion failed value %s", key, value); } while (0); return ret; } ret = xlator_option_validate (this, key, value, opt, ((void *)0)); return ret; };
int xlator_option_init_percent (xlator_t *this, dict_t *options, char *key, double *val_p) { int ret = 0; volume_option_t *opt = ((void *)0); char *def_value = ((void *)0); char *set_value = ((void *)0); char *value = ((void *)0); xlator_t *old_THIS = ((void *)0); opt = xlator_volume_option_get (this, key); if (!opt) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1215, GF_LOG_WARNING, 22, 0, (100000 + 1000 + 2), "unknown option: %s", key); } while (0); ret = -1; return ret; } def_value = opt->default_value; ret = dict_get_str (options, key, &set_value); if (def_value) value = def_value; if (set_value) value = set_value; if (!value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1215, GF_LOG_TRACE, 0, 0, 0, "option %s not set", key); } while (0); *val_p = (double)0; return 0; } if (value == def_value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1215, GF_LOG_TRACE, 0, 0, 0, "option %s using default" " value %s", key, value); } while (0); } else { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1215, GF_LOG_DEBUG, 0, 0, 0, "option %s using set" " value %s", key, value); } while (0); } old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = this; ret = gf_string2percent (value, val_p); (*__glusterfs_this_location()) = old_THIS; if (ret) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1215, GF_LOG_INFO, 0, 0, (100000 + 1000 + 84), "option %s conversion failed value %s", key, value); } while (0); return ret; } ret = xlator_option_validate (this, key, value, opt, ((void *)0)); return ret; };
int xlator_option_init_percent_or_size (xlator_t *this, dict_t *options, char *key, double *val_p) { int ret = 0; volume_option_t *opt = ((void *)0); char *def_value = ((void *)0); char *set_value = ((void *)0); char *value = ((void *)0); xlator_t *old_THIS = ((void *)0); opt = xlator_volume_option_get (this, key); if (!opt) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1216, GF_LOG_WARNING, 22, 0, (100000 + 1000 + 2), "unknown option: %s", key); } while (0); ret = -1; return ret; } def_value = opt->default_value; ret = dict_get_str (options, key, &set_value); if (def_value) value = def_value; if (set_value) value = set_value; if (!value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1216, GF_LOG_TRACE, 0, 0, 0, "option %s not set", key); } while (0); *val_p = (double)0; return 0; } if (value == def_value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1216, GF_LOG_TRACE, 0, 0, 0, "option %s using default" " value %s", key, value); } while (0); } else { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1216, GF_LOG_DEBUG, 0, 0, 0, "option %s using set" " value %s", key, value); } while (0); } old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = this; ret = pc_or_size (value, val_p); (*__glusterfs_this_location()) = old_THIS; if (ret) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1216, GF_LOG_INFO, 0, 0, (100000 + 1000 + 84), "option %s conversion failed value %s", key, value); } while (0); return ret; } ret = xlator_option_validate (this, key, value, opt, ((void *)0)); return ret; };
int xlator_option_init_bool (xlator_t *this, dict_t *options, char *key, gf_boolean_t *val_p) { int ret = 0; volume_option_t *opt = ((void *)0); char *def_value = ((void *)0); char *set_value = ((void *)0); char *value = ((void *)0); xlator_t *old_THIS = ((void *)0); opt = xlator_volume_option_get (this, key); if (!opt) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1217, GF_LOG_WARNING, 22, 0, (100000 + 1000 + 2), "unknown option: %s", key); } while (0); ret = -1; return ret; } def_value = opt->default_value; ret = dict_get_str (options, key, &set_value); if (def_value) value = def_value; if (set_value) value = set_value; if (!value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1217, GF_LOG_TRACE, 0, 0, 0, "option %s not set", key); } while (0); *val_p = (gf_boolean_t)0; return 0; } if (value == def_value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1217, GF_LOG_TRACE, 0, 0, 0, "option %s using default" " value %s", key, value); } while (0); } else { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1217, GF_LOG_DEBUG, 0, 0, 0, "option %s using set" " value %s", key, value); } while (0); } old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = this; ret = gf_string2boolean (value, val_p); (*__glusterfs_this_location()) = old_THIS; if (ret) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1217, GF_LOG_INFO, 0, 0, (100000 + 1000 + 84), "option %s conversion failed value %s", key, value); } while (0); return ret; } ret = xlator_option_validate (this, key, value, opt, ((void *)0)); return ret; };
int xlator_option_init_xlator (xlator_t *this, dict_t *options, char *key, xlator_t * *val_p) { int ret = 0; volume_option_t *opt = ((void *)0); char *def_value = ((void *)0); char *set_value = ((void *)0); char *value = ((void *)0); xlator_t *old_THIS = ((void *)0); opt = xlator_volume_option_get (this, key); if (!opt) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1218, GF_LOG_WARNING, 22, 0, (100000 + 1000 + 2), "unknown option: %s", key); } while (0); ret = -1; return ret; } def_value = opt->default_value; ret = dict_get_str (options, key, &set_value); if (def_value) value = def_value; if (set_value) value = set_value; if (!value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1218, GF_LOG_TRACE, 0, 0, 0, "option %s not set", key); } while (0); *val_p = (xlator_t *)0; return 0; } if (value == def_value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1218, GF_LOG_TRACE, 0, 0, 0, "option %s using default" " value %s", key, value); } while (0); } else { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1218, GF_LOG_DEBUG, 0, 0, 0, "option %s using set" " value %s", key, value); } while (0); } old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = this; ret = xl_by_name (value, val_p); (*__glusterfs_this_location()) = old_THIS; if (ret) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1218, GF_LOG_INFO, 0, 0, (100000 + 1000 + 84), "option %s conversion failed value %s", key, value); } while (0); return ret; } ret = xlator_option_validate (this, key, value, opt, ((void *)0)); return ret; };
int xlator_option_init_path (xlator_t *this, dict_t *options, char *key, char * *val_p) { int ret = 0; volume_option_t *opt = ((void *)0); char *def_value = ((void *)0); char *set_value = ((void *)0); char *value = ((void *)0); xlator_t *old_THIS = ((void *)0); opt = xlator_volume_option_get (this, key); if (!opt) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1219, GF_LOG_WARNING, 22, 0, (100000 + 1000 + 2), "unknown option: %s", key); } while (0); ret = -1; return ret; } def_value = opt->default_value; ret = dict_get_str (options, key, &set_value); if (def_value) value = def_value; if (set_value) value = set_value; if (!value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1219, GF_LOG_TRACE, 0, 0, 0, "option %s not set", key); } while (0); *val_p = (char *)0; return 0; } if (value == def_value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1219, GF_LOG_TRACE, 0, 0, 0, "option %s using default" " value %s", key, value); } while (0); } else { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1219, GF_LOG_DEBUG, 0, 0, 0, "option %s using set" " value %s", key, value); } while (0); } old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = this; ret = pass (value, val_p); (*__glusterfs_this_location()) = old_THIS; if (ret) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1219, GF_LOG_INFO, 0, 0, (100000 + 1000 + 84), "option %s conversion failed value %s", key, value); } while (0); return ret; } ret = xlator_option_validate (this, key, value, opt, ((void *)0)); return ret; };
int xlator_option_init_double (xlator_t *this, dict_t *options, char *key, double *val_p) { int ret = 0; volume_option_t *opt = ((void *)0); char *def_value = ((void *)0); char *set_value = ((void *)0); char *value = ((void *)0); xlator_t *old_THIS = ((void *)0); opt = xlator_volume_option_get (this, key); if (!opt) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1220, GF_LOG_WARNING, 22, 0, (100000 + 1000 + 2), "unknown option: %s", key); } while (0); ret = -1; return ret; } def_value = opt->default_value; ret = dict_get_str (options, key, &set_value); if (def_value) value = def_value; if (set_value) value = set_value; if (!value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1220, GF_LOG_TRACE, 0, 0, 0, "option %s not set", key); } while (0); *val_p = (double)0; return 0; } if (value == def_value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1220, GF_LOG_TRACE, 0, 0, 0, "option %s using default" " value %s", key, value); } while (0); } else { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1220, GF_LOG_DEBUG, 0, 0, 0, "option %s using set" " value %s", key, value); } while (0); } old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = this; ret = gf_string2double (value, val_p); (*__glusterfs_this_location()) = old_THIS; if (ret) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1220, GF_LOG_INFO, 0, 0, (100000 + 1000 + 84), "option %s conversion failed value %s", key, value); } while (0); return ret; } ret = xlator_option_validate (this, key, value, opt, ((void *)0)); return ret; };
int xlator_option_init_time (xlator_t *this, dict_t *options, char *key, uint32_t *val_p) { int ret = 0; volume_option_t *opt = ((void *)0); char *def_value = ((void *)0); char *set_value = ((void *)0); char *value = ((void *)0); xlator_t *old_THIS = ((void *)0); opt = xlator_volume_option_get (this, key); if (!opt) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1221, GF_LOG_WARNING, 22, 0, (100000 + 1000 + 2), "unknown option: %s", key); } while (0); ret = -1; return ret; } def_value = opt->default_value; ret = dict_get_str (options, key, &set_value); if (def_value) value = def_value; if (set_value) value = set_value; if (!value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1221, GF_LOG_TRACE, 0, 0, 0, "option %s not set", key); } while (0); *val_p = (uint32_t)0; return 0; } if (value == def_value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1221, GF_LOG_TRACE, 0, 0, 0, "option %s using default" " value %s", key, value); } while (0); } else { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1221, GF_LOG_DEBUG, 0, 0, 0, "option %s using set" " value %s", key, value); } while (0); } old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = this; ret = gf_string2time (value, val_p); (*__glusterfs_this_location()) = old_THIS; if (ret) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1221, GF_LOG_INFO, 0, 0, (100000 + 1000 + 84), "option %s conversion failed value %s", key, value); } while (0); return ret; } ret = xlator_option_validate (this, key, value, opt, ((void *)0)); return ret; };


int xlator_option_reconf_str (xlator_t *this, dict_t *options, char *key, char * *val_p) { int ret = 0; volume_option_t *opt = ((void *)0); char *def_value = ((void *)0); char *set_value = ((void *)0); char *value = ((void *)0); xlator_t *old_THIS = ((void *)0); opt = xlator_volume_option_get (this, key); if (!opt) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1224, GF_LOG_WARNING, 22, 0, (100000 + 1000 + 2), "unknown option: %s", key); } while (0); ret = -1; return ret; } def_value = opt->default_value; ret = dict_get_str (options, key, &set_value); if (def_value) value = def_value; if (set_value) value = set_value; if (!value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1224, GF_LOG_TRACE, 0, 0, 0, "option %s not set", key); } while (0); *val_p = (char *)0; return 0; } if (value == def_value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1224, GF_LOG_TRACE, 0, 0, 0, "option %s using default value %s", key, value); } while (0); } else { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1224, GF_LOG_DEBUG, 0, 0, 0, "option %s using set value %s", key, value); } while (0); } old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = this; ret = pass (value, val_p); (*__glusterfs_this_location()) = old_THIS; if (ret) return ret; ret = xlator_option_validate (this, key, value, opt, ((void *)0)); return ret; };
int xlator_option_reconf_uint64 (xlator_t *this, dict_t *options, char *key, uint64_t *val_p) { int ret = 0; volume_option_t *opt = ((void *)0); char *def_value = ((void *)0); char *set_value = ((void *)0); char *value = ((void *)0); xlator_t *old_THIS = ((void *)0); opt = xlator_volume_option_get (this, key); if (!opt) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1225, GF_LOG_WARNING, 22, 0, (100000 + 1000 + 2), "unknown option: %s", key); } while (0); ret = -1; return ret; } def_value = opt->default_value; ret = dict_get_str (options, key, &set_value); if (def_value) value = def_value; if (set_value) value = set_value; if (!value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1225, GF_LOG_TRACE, 0, 0, 0, "option %s not set", key); } while (0); *val_p = (uint64_t)0; return 0; } if (value == def_value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1225, GF_LOG_TRACE, 0, 0, 0, "option %s using default value %s", key, value); } while (0); } else { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1225, GF_LOG_DEBUG, 0, 0, 0, "option %s using set value %s", key, value); } while (0); } old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = this; ret = gf_string2uint64 (value, val_p); (*__glusterfs_this_location()) = old_THIS; if (ret) return ret; ret = xlator_option_validate (this, key, value, opt, ((void *)0)); return ret; };
int xlator_option_reconf_int64 (xlator_t *this, dict_t *options, char *key, int64_t *val_p) { int ret = 0; volume_option_t *opt = ((void *)0); char *def_value = ((void *)0); char *set_value = ((void *)0); char *value = ((void *)0); xlator_t *old_THIS = ((void *)0); opt = xlator_volume_option_get (this, key); if (!opt) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1226, GF_LOG_WARNING, 22, 0, (100000 + 1000 + 2), "unknown option: %s", key); } while (0); ret = -1; return ret; } def_value = opt->default_value; ret = dict_get_str (options, key, &set_value); if (def_value) value = def_value; if (set_value) value = set_value; if (!value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1226, GF_LOG_TRACE, 0, 0, 0, "option %s not set", key); } while (0); *val_p = (int64_t)0; return 0; } if (value == def_value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1226, GF_LOG_TRACE, 0, 0, 0, "option %s using default value %s", key, value); } while (0); } else { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1226, GF_LOG_DEBUG, 0, 0, 0, "option %s using set value %s", key, value); } while (0); } old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = this; ret = gf_string2int64 (value, val_p); (*__glusterfs_this_location()) = old_THIS; if (ret) return ret; ret = xlator_option_validate (this, key, value, opt, ((void *)0)); return ret; };
int xlator_option_reconf_uint32 (xlator_t *this, dict_t *options, char *key, uint32_t *val_p) { int ret = 0; volume_option_t *opt = ((void *)0); char *def_value = ((void *)0); char *set_value = ((void *)0); char *value = ((void *)0); xlator_t *old_THIS = ((void *)0); opt = xlator_volume_option_get (this, key); if (!opt) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1227, GF_LOG_WARNING, 22, 0, (100000 + 1000 + 2), "unknown option: %s", key); } while (0); ret = -1; return ret; } def_value = opt->default_value; ret = dict_get_str (options, key, &set_value); if (def_value) value = def_value; if (set_value) value = set_value; if (!value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1227, GF_LOG_TRACE, 0, 0, 0, "option %s not set", key); } while (0); *val_p = (uint32_t)0; return 0; } if (value == def_value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1227, GF_LOG_TRACE, 0, 0, 0, "option %s using default value %s", key, value); } while (0); } else { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1227, GF_LOG_DEBUG, 0, 0, 0, "option %s using set value %s", key, value); } while (0); } old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = this; ret = gf_string2uint32 (value, val_p); (*__glusterfs_this_location()) = old_THIS; if (ret) return ret; ret = xlator_option_validate (this, key, value, opt, ((void *)0)); return ret; };
int xlator_option_reconf_int32 (xlator_t *this, dict_t *options, char *key, int32_t *val_p) { int ret = 0; volume_option_t *opt = ((void *)0); char *def_value = ((void *)0); char *set_value = ((void *)0); char *value = ((void *)0); xlator_t *old_THIS = ((void *)0); opt = xlator_volume_option_get (this, key); if (!opt) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1228, GF_LOG_WARNING, 22, 0, (100000 + 1000 + 2), "unknown option: %s", key); } while (0); ret = -1; return ret; } def_value = opt->default_value; ret = dict_get_str (options, key, &set_value); if (def_value) value = def_value; if (set_value) value = set_value; if (!value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1228, GF_LOG_TRACE, 0, 0, 0, "option %s not set", key); } while (0); *val_p = (int32_t)0; return 0; } if (value == def_value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1228, GF_LOG_TRACE, 0, 0, 0, "option %s using default value %s", key, value); } while (0); } else { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1228, GF_LOG_DEBUG, 0, 0, 0, "option %s using set value %s", key, value); } while (0); } old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = this; ret = gf_string2int32 (value, val_p); (*__glusterfs_this_location()) = old_THIS; if (ret) return ret; ret = xlator_option_validate (this, key, value, opt, ((void *)0)); return ret; };
int xlator_option_reconf_size (xlator_t *this, dict_t *options, char *key, size_t *val_p) { int ret = 0; volume_option_t *opt = ((void *)0); char *def_value = ((void *)0); char *set_value = ((void *)0); char *value = ((void *)0); xlator_t *old_THIS = ((void *)0); opt = xlator_volume_option_get (this, key); if (!opt) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1229, GF_LOG_WARNING, 22, 0, (100000 + 1000 + 2), "unknown option: %s", key); } while (0); ret = -1; return ret; } def_value = opt->default_value; ret = dict_get_str (options, key, &set_value); if (def_value) value = def_value; if (set_value) value = set_value; if (!value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1229, GF_LOG_TRACE, 0, 0, 0, "option %s not set", key); } while (0); *val_p = (size_t)0; return 0; } if (value == def_value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1229, GF_LOG_TRACE, 0, 0, 0, "option %s using default value %s", key, value); } while (0); } else { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1229, GF_LOG_DEBUG, 0, 0, 0, "option %s using set value %s", key, value); } while (0); } old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = this; ret = gf_string2bytesize_size (value, val_p); (*__glusterfs_this_location()) = old_THIS; if (ret) return ret; ret = xlator_option_validate (this, key, value, opt, ((void *)0)); return ret; };
int xlator_option_reconf_size_uint64 (xlator_t *this, dict_t *options, char *key, uint64_t *val_p) { int ret = 0; volume_option_t *opt = ((void *)0); char *def_value = ((void *)0); char *set_value = ((void *)0); char *value = ((void *)0); xlator_t *old_THIS = ((void *)0); opt = xlator_volume_option_get (this, key); if (!opt) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1230, GF_LOG_WARNING, 22, 0, (100000 + 1000 + 2), "unknown option: %s", key); } while (0); ret = -1; return ret; } def_value = opt->default_value; ret = dict_get_str (options, key, &set_value); if (def_value) value = def_value; if (set_value) value = set_value; if (!value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1230, GF_LOG_TRACE, 0, 0, 0, "option %s not set", key); } while (0); *val_p = (uint64_t)0; return 0; } if (value == def_value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1230, GF_LOG_TRACE, 0, 0, 0, "option %s using default value %s", key, value); } while (0); } else { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1230, GF_LOG_DEBUG, 0, 0, 0, "option %s using set value %s", key, value); } while (0); } old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = this; ret = gf_string2bytesize_uint64 (value, val_p); (*__glusterfs_this_location()) = old_THIS; if (ret) return ret; ret = xlator_option_validate (this, key, value, opt, ((void *)0)); return ret; };
int xlator_option_reconf_percent (xlator_t *this, dict_t *options, char *key, double *val_p) { int ret = 0; volume_option_t *opt = ((void *)0); char *def_value = ((void *)0); char *set_value = ((void *)0); char *value = ((void *)0); xlator_t *old_THIS = ((void *)0); opt = xlator_volume_option_get (this, key); if (!opt) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1231, GF_LOG_WARNING, 22, 0, (100000 + 1000 + 2), "unknown option: %s", key); } while (0); ret = -1; return ret; } def_value = opt->default_value; ret = dict_get_str (options, key, &set_value); if (def_value) value = def_value; if (set_value) value = set_value; if (!value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1231, GF_LOG_TRACE, 0, 0, 0, "option %s not set", key); } while (0); *val_p = (double)0; return 0; } if (value == def_value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1231, GF_LOG_TRACE, 0, 0, 0, "option %s using default value %s", key, value); } while (0); } else { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1231, GF_LOG_DEBUG, 0, 0, 0, "option %s using set value %s", key, value); } while (0); } old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = this; ret = gf_string2percent (value, val_p); (*__glusterfs_this_location()) = old_THIS; if (ret) return ret; ret = xlator_option_validate (this, key, value, opt, ((void *)0)); return ret; };
int xlator_option_reconf_percent_or_size (xlator_t *this, dict_t *options, char *key, double *val_p) { int ret = 0; volume_option_t *opt = ((void *)0); char *def_value = ((void *)0); char *set_value = ((void *)0); char *value = ((void *)0); xlator_t *old_THIS = ((void *)0); opt = xlator_volume_option_get (this, key); if (!opt) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1232, GF_LOG_WARNING, 22, 0, (100000 + 1000 + 2), "unknown option: %s", key); } while (0); ret = -1; return ret; } def_value = opt->default_value; ret = dict_get_str (options, key, &set_value); if (def_value) value = def_value; if (set_value) value = set_value; if (!value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1232, GF_LOG_TRACE, 0, 0, 0, "option %s not set", key); } while (0); *val_p = (double)0; return 0; } if (value == def_value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1232, GF_LOG_TRACE, 0, 0, 0, "option %s using default value %s", key, value); } while (0); } else { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1232, GF_LOG_DEBUG, 0, 0, 0, "option %s using set value %s", key, value); } while (0); } old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = this; ret = pc_or_size (value, val_p); (*__glusterfs_this_location()) = old_THIS; if (ret) return ret; ret = xlator_option_validate (this, key, value, opt, ((void *)0)); return ret; };
int xlator_option_reconf_bool (xlator_t *this, dict_t *options, char *key, gf_boolean_t *val_p) { int ret = 0; volume_option_t *opt = ((void *)0); char *def_value = ((void *)0); char *set_value = ((void *)0); char *value = ((void *)0); xlator_t *old_THIS = ((void *)0); opt = xlator_volume_option_get (this, key); if (!opt) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1233, GF_LOG_WARNING, 22, 0, (100000 + 1000 + 2), "unknown option: %s", key); } while (0); ret = -1; return ret; } def_value = opt->default_value; ret = dict_get_str (options, key, &set_value); if (def_value) value = def_value; if (set_value) value = set_value; if (!value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1233, GF_LOG_TRACE, 0, 0, 0, "option %s not set", key); } while (0); *val_p = (gf_boolean_t)0; return 0; } if (value == def_value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1233, GF_LOG_TRACE, 0, 0, 0, "option %s using default value %s", key, value); } while (0); } else { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1233, GF_LOG_DEBUG, 0, 0, 0, "option %s using set value %s", key, value); } while (0); } old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = this; ret = gf_string2boolean (value, val_p); (*__glusterfs_this_location()) = old_THIS; if (ret) return ret; ret = xlator_option_validate (this, key, value, opt, ((void *)0)); return ret; };
int xlator_option_reconf_xlator (xlator_t *this, dict_t *options, char *key, xlator_t * *val_p) { int ret = 0; volume_option_t *opt = ((void *)0); char *def_value = ((void *)0); char *set_value = ((void *)0); char *value = ((void *)0); xlator_t *old_THIS = ((void *)0); opt = xlator_volume_option_get (this, key); if (!opt) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1234, GF_LOG_WARNING, 22, 0, (100000 + 1000 + 2), "unknown option: %s", key); } while (0); ret = -1; return ret; } def_value = opt->default_value; ret = dict_get_str (options, key, &set_value); if (def_value) value = def_value; if (set_value) value = set_value; if (!value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1234, GF_LOG_TRACE, 0, 0, 0, "option %s not set", key); } while (0); *val_p = (xlator_t *)0; return 0; } if (value == def_value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1234, GF_LOG_TRACE, 0, 0, 0, "option %s using default value %s", key, value); } while (0); } else { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1234, GF_LOG_DEBUG, 0, 0, 0, "option %s using set value %s", key, value); } while (0); } old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = this; ret = xl_by_name (value, val_p); (*__glusterfs_this_location()) = old_THIS; if (ret) return ret; ret = xlator_option_validate (this, key, value, opt, ((void *)0)); return ret; };
int xlator_option_reconf_path (xlator_t *this, dict_t *options, char *key, char * *val_p) { int ret = 0; volume_option_t *opt = ((void *)0); char *def_value = ((void *)0); char *set_value = ((void *)0); char *value = ((void *)0); xlator_t *old_THIS = ((void *)0); opt = xlator_volume_option_get (this, key); if (!opt) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1235, GF_LOG_WARNING, 22, 0, (100000 + 1000 + 2), "unknown option: %s", key); } while (0); ret = -1; return ret; } def_value = opt->default_value; ret = dict_get_str (options, key, &set_value); if (def_value) value = def_value; if (set_value) value = set_value; if (!value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1235, GF_LOG_TRACE, 0, 0, 0, "option %s not set", key); } while (0); *val_p = (char *)0; return 0; } if (value == def_value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1235, GF_LOG_TRACE, 0, 0, 0, "option %s using default value %s", key, value); } while (0); } else { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1235, GF_LOG_DEBUG, 0, 0, 0, "option %s using set value %s", key, value); } while (0); } old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = this; ret = pass (value, val_p); (*__glusterfs_this_location()) = old_THIS; if (ret) return ret; ret = xlator_option_validate (this, key, value, opt, ((void *)0)); return ret; };
int xlator_option_reconf_double (xlator_t *this, dict_t *options, char *key, double *val_p) { int ret = 0; volume_option_t *opt = ((void *)0); char *def_value = ((void *)0); char *set_value = ((void *)0); char *value = ((void *)0); xlator_t *old_THIS = ((void *)0); opt = xlator_volume_option_get (this, key); if (!opt) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1236, GF_LOG_WARNING, 22, 0, (100000 + 1000 + 2), "unknown option: %s", key); } while (0); ret = -1; return ret; } def_value = opt->default_value; ret = dict_get_str (options, key, &set_value); if (def_value) value = def_value; if (set_value) value = set_value; if (!value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1236, GF_LOG_TRACE, 0, 0, 0, "option %s not set", key); } while (0); *val_p = (double)0; return 0; } if (value == def_value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1236, GF_LOG_TRACE, 0, 0, 0, "option %s using default value %s", key, value); } while (0); } else { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1236, GF_LOG_DEBUG, 0, 0, 0, "option %s using set value %s", key, value); } while (0); } old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = this; ret = gf_string2double (value, val_p); (*__glusterfs_this_location()) = old_THIS; if (ret) return ret; ret = xlator_option_validate (this, key, value, opt, ((void *)0)); return ret; };
int xlator_option_reconf_time (xlator_t *this, dict_t *options, char *key, uint32_t *val_p) { int ret = 0; volume_option_t *opt = ((void *)0); char *def_value = ((void *)0); char *set_value = ((void *)0); char *value = ((void *)0); xlator_t *old_THIS = ((void *)0); opt = xlator_volume_option_get (this, key); if (!opt) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1237, GF_LOG_WARNING, 22, 0, (100000 + 1000 + 2), "unknown option: %s", key); } while (0); ret = -1; return ret; } def_value = opt->default_value; ret = dict_get_str (options, key, &set_value); if (def_value) value = def_value; if (set_value) value = set_value; if (!value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1237, GF_LOG_TRACE, 0, 0, 0, "option %s not set", key); } while (0); *val_p = (uint32_t)0; return 0; } if (value == def_value) { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1237, GF_LOG_TRACE, 0, 0, 0, "option %s using default value %s", key, value); } while (0); } else { do { _gf_msg (this->name, "./options.c", __FUNCTION__, 1237, GF_LOG_DEBUG, 0, 0, 0, "option %s using set value %s", key, value); } while (0); } old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = this; ret = gf_string2time (value, val_p); (*__glusterfs_this_location()) = old_THIS; if (ret) return ret; ret = xlator_option_validate (this, key, value, opt, ((void *)0)); return ret; };
