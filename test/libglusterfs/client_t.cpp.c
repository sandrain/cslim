...
# 1 "/home/hyogi/workspace/glusterfs/rpc/rpc-lib/src/rpcsvc.h" 1
# 14 "/home/hyogi/workspace/glusterfs/rpc/rpc-lib/src/rpcsvc.h"
# 1 "./event.h" 1
# 16 "./event.h"
struct event_pool;
struct event_ops;
...
# 15 "/home/hyogi/workspace/glusterfs/rpc/rpc-lib/src/rpcsvc.h" 2
# 1 "/home/hyogi/workspace/glusterfs/rpc/rpc-lib/src/rpc-transport.h" 1
# 19 "/home/hyogi/workspace/glusterfs/rpc/rpc-lib/src/rpc-transport.h"
...
# 20 "/home/hyogi/workspace/glusterfs/rpc/rpc-lib/src/rpc-transport.h" 2
# 58 "/home/hyogi/workspace/glusterfs/rpc/rpc-lib/src/rpc-transport.h"
struct rpc_transport_ops;
typedef struct rpc_transport rpc_transport_t;

# 1 "./dict.h" 1
# 62 "/home/hyogi/workspace/glusterfs/rpc/rpc-lib/src/rpc-transport.h" 2
# 1 "./compat.h" 1
# 63 "/home/hyogi/workspace/glusterfs/rpc/rpc-lib/src/rpc-transport.h" 2
# 1 "/home/hyogi/workspace/glusterfs/rpc/rpc-lib/src/rpcsvc-common.h" 1
# 15 "/home/hyogi/workspace/glusterfs/rpc/rpc-lib/src/rpcsvc-common.h"
# 1 "./list.h" 1
# 16 "/home/hyogi/workspace/glusterfs/rpc/rpc-lib/src/rpcsvc-common.h" 2

# 1 "./glusterfs.h" 1
# 18 "/home/hyogi/workspace/glusterfs/rpc/rpc-lib/src/rpcsvc-common.h" 2

# 1 "./xlator.h" 1
# 20 "/home/hyogi/workspace/glusterfs/rpc/rpc-lib/src/rpcsvc-common.h" 2
...
# 64 "/home/hyogi/workspace/glusterfs/rpc/rpc-lib/src/rpc-transport.h" 2
...
# 95 "/home/hyogi/workspace/glusterfs/rpc/rpc-lib/src/rpc-transport.h"
...
# 16 "/home/hyogi/workspace/glusterfs/rpc/rpc-lib/src/rpcsvc.h" 2
# 1 "./logging.h" 1
# 17 "/home/hyogi/workspace/glusterfs/rpc/rpc-lib/src/rpcsvc.h" 2

# 1 "./mem-pool.h" 1
# 19 "/home/hyogi/workspace/glusterfs/rpc/rpc-lib/src/rpcsvc.h" 2

# 1 "./iobuf.h" 1
# 21 "/home/hyogi/workspace/glusterfs/rpc/rpc-lib/src/rpcsvc.h" 2
# 1 "/home/hyogi/workspace/glusterfs/rpc/rpc-lib/src/xdr-rpc.h" 1
# 28 "/home/hyogi/workspace/glusterfs/rpc/rpc-lib/src/xdr-rpc.h"
# 1 "/home/hyogi/workspace/glusterfs/rpc/rpc-lib/src/xdr-common.h" 1
# 24 "/home/hyogi/workspace/glusterfs/rpc/rpc-lib/src/xdr-common.h"
...
# 29 "/home/hyogi/workspace/glusterfs/rpc/rpc-lib/src/xdr-rpc.h" 2

typedef enum {
        AUTH_GLUSTERFS = 5,
        AUTH_GLUSTERFS_v2 = 390039,
...
# 22 "/home/hyogi/workspace/glusterfs/rpc/rpc-lib/src/rpcsvc.h" 2
# 109 "/home/hyogi/workspace/glusterfs/rpc/rpc-lib/src/rpcsvc.h"
...
struct rpcsvc_request {
        ...
        int auth_err;
# 219 "/home/hyogi/workspace/glusterfs/rpc/rpc-lib/src/rpcsvc.h"
...
# 310 "/home/hyogi/workspace/glusterfs/rpc/rpc-lib/src/rpcsvc.h"
...
typedef struct rpcsvc_actor_desc {
        ...
        int procnum;
        rpcsvc_actor actor;
# 343 "/home/hyogi/workspace/glusterfs/rpc/rpc-lib/src/rpcsvc.h"
...
struct rpcsvc_program {
        ...
        dict_t *options;
# 373 "/home/hyogi/workspace/glusterfs/rpc/rpc-lib/src/rpcsvc.h"
        uint16_t progport;
        ...
        void *private;
# 394 "/home/hyogi/workspace/glusterfs/rpc/rpc-lib/src/rpcsvc.h"
        rpcsvc_notify_t notify;
...
# 431 "/home/hyogi/workspace/glusterfs/rpc/rpc-lib/src/rpcsvc.h"
extern int32_t
...
# 26 "./client_t.c"
 ...
 27
# 26 "./client_t.c"
                , GF_LOG_WARNING, 22, 1, (100000 + 1000 + 172), "!entries"); } while (0)
                                                                 ;
                return -1;
        }
...
{
        cliententry_t *oldclients = ((void *)0);
        uint32_t oldmax_clients = -1;
        int ret = -1;

        if (clienttable == ((void *)0) || nr <= clienttable->max_clients) {
                do { _gf_msg ("client_t",
 "./client_t.c"
# 52 "./client_t.c"
                , __FUNCTION__,
 53
# 52 "./client_t.c"
                , GF_LOG_ERROR, 22, 1, (100000 + 1000 + 172), "invalid argument"); } while (0)
                                                                         ;
                ret = 22;
                goto out;
        }
        ...
        clienttable->cliententries = __gf_calloc (nr, sizeof (cliententry_t), gf_common_mt_cliententry_t, "gf_common_mt_cliententry_t")
                                                                           ;
...
gf_clienttable_alloc (void)
{
        clienttable_t *clienttable = ((void *)0);
        int result = 0;

        clienttable =
                __gf_calloc (1, sizeof (clienttable_t), gf_common_mt_clienttable_t, "gf_common_mt_clienttable_t");
        if (!clienttable)
                return ((void *)0);

        pthread_mutex_init (&clienttable->lock, 0);
...
# 107 "./client_t.c"
 ...
 109
# 107 "./client_t.c"
                , GF_LOG_ERROR, 0, 0, (100000 + 1000 + 54), "gf_client_clienttable_expand failed"); } while (0)

                                                              ;
                __gf_free (clienttable);
                return ((void *)0);
        }
...
gf_client_clienttable_destroy (clienttable_t *clienttable)
{
        client_t *client = ((void *)0);
        cliententry_t *cliententries = ((void *)0);
...
# 127 "./client_t.c"
 ...
 128
# 127 "./client_t.c"
                , GF_LOG_WARNING, 22, 1, (100000 + 1000 + 172), "!clienttable"); } while (0)
                                                                     ;
                return;
        }

        pthread_mutex_lock (&clienttable->lock);
        {
                client_count = clienttable->max_clients;
                clienttable->max_clients = 0;
                cliententries = clienttable->cliententries;
                clienttable->cliententries = ((void *)0);
        }
        pthread_mutex_unlock (&clienttable->lock);
        ...
        if (cliententries != ((void *)0)) {
                ...
                __gf_free (cliententries);
                pthread_mutex_destroy (&clienttable->lock);
                __gf_free (clienttable);
        }
}
...
{
        client_t *client = ((void *)0);
        cliententry_t *cliententry = ((void *)0);
        clienttable_t *clienttable = ((void *)0);
        unsigned int i = 0;

        if (this == ((void *)0) || client_uid == ((void *)0)) {
                do { _gf_msg ("client_t",
 "./client_t.c"
# 170 "./client_t.c"
                , __FUNCTION__,
...
# 170 "./client_t.c"
        ...
        pthread_mutex_lock (&clienttable->lock);
        {
                ...
                client = __gf_calloc (1, sizeof(client_t), gf_common_mt_client_t, "gf_common_mt_client_t");
                if (client == ((void *)0)) {
                        (*__errno_location ()) = 12;
                        goto unlock;
                }
                ...
                pthread_mutex_init (&client->scratch_ctx.lock, 0);
                pthread_mutex_init (&client->ref.lock, 0);

                client->client_uid = gf_strdup (client_uid);
                if (client->client_uid == ((void *)0)) {
                        __gf_free (client);
                        client = ((void *)0);
                        (*__errno_location ()) = 12;
                        goto unlock;
                }
                client->scratch_ctx.count = 8;
                client->scratch_ctx.ctx =
                        __gf_calloc (8, sizeof (struct client_ctx), gf_common_mt_client_ctx, "gf_common_mt_client_ctx")

                                                           ;
                if (client->scratch_ctx.ctx == ((void *)0)) {
                        __gf_free (client->client_uid);
                        __gf_free (client);
                        client = ((void *)0);
                        (*__errno_location ()) = 12;
                        goto unlock;
                ...
                if (cred->flavour != 0) {
                        client->auth.data =
                                __gf_calloc (1, cred->datalen, gf_common_mt_client_t, "gf_common_mt_client_t")
                                                                 ;
                        if (client->auth.data == ((void *)0)) {
                                __gf_free (client->scratch_ctx.ctx);
                                __gf_free (client->client_uid);
                                __gf_free (client);
                                client = ((void *)0);
                                (*__errno_location ()) = 12;
...
# 279 "./client_t.c"
 ...
 282
# 279 "./client_t.c"
                , GF_LOG_DEBUG, 0, 1, (100000 + 1000 + 170), "%s: bind_ref: %d, ref: %d", client->client_uid, client->ref.bind, client->ref.count); } while (0)
...
# 302 "./client_t.c"
 ...
 305
# 302 "./client_t.c"
        , GF_LOG_DEBUG, 0, 1, (100000 + 1000 + 170), "%s: " "bind_ref: %d, ref: %d, unref: %d", client->client_uid, client->ref.bind, client->ref.count, unref); } while (0)
...
# 320 "./client_t.c"
 ...
 321
# 320 "./client_t.c"
                , GF_LOG_ERROR, 22, 1, (100000 + 1000 + 172), "null client"); } while (0)
                                                                    ;
                return ((void *)0);
        }
...
# 326 "./client_t.c"
 ...
 328
# 326 "./client_t.c"
        , GF_LOG_DEBUG, 0, 1, (100000 + 1000 + 171), "%s: " "ref-count %d", client->client_uid, client->ref.count); } while (0)
...
{
        clienttable_t *clienttable = ((void *)0);
        glusterfs_graph_t *gtrav = ((void *)0);
        xlator_t *xtrav = ((void *)0);
...
# 341 "./client_t.c"
        ...
        pthread_mutex_destroy (&client->scratch_ctx.lock);
        pthread_mutex_destroy (&client->ref.lock);

        pthread_mutex_lock (&clienttable->lock);
        {
                clienttable->cliententries[client->tbl_index].client = ((void *)0);
        ...
        for (gtrav = ((typeof(*gtrav) *)((char *)((&client->this->ctx->graphs)->next)-(unsigned long)(&((typeof(*gtrav) *)0)->list))); &gtrav->list != (&client->this->ctx->graphs); gtrav = ((typeof(*gtrav) *)((char *)(gtrav->list.next)-(unsigned long)(&((typeof(*gtrav) *)0)->list)))) {
                xtrav = gtrav->top;
                while (xtrav != ((void *)0)) {
                        if (xtrav->cbks->client_destroy != ((void *)0))
                                xtrav->cbks->client_destroy (xtrav, client);
                        xtrav = xtrav->next;
                }
        }
        __gf_free (client->auth.data);
        __gf_free (client->scratch_ctx.ctx);
        __gf_free (client->client_uid);
        __gf_free (client);
out:
...
gf_client_disconnect (client_t *client)
{
        ...
        for (gtrav = ((typeof(*gtrav) *)((char *)((&client->this->ctx->graphs)->next)-(unsigned long)(&((typeof(*gtrav) *)0)->list))); &gtrav->list != (&client->this->ctx->graphs); gtrav = ((typeof(*gtrav) *)((char *)(gtrav->list.next)-(unsigned long)(&((typeof(*gtrav) *)0)->list)))) {
                xtrav = gtrav->top;
                while (xtrav != ((void *)0)) {
                        if (xtrav->cbks->client_disconnect != ((void *)0))
...
# 404 "./client_t.c"
 ...
 405
# 404 "./client_t.c"
                , GF_LOG_ERROR, 22, 1, (100000 + 1000 + 172), "client is NULL"); } while (0)
                                                                       ;
                return;
        }
...
# 410 "./client_t.c"
 ...
 412
# 410 "./client_t.c"
        , GF_LOG_DEBUG, 0, 1, (100000 + 1000 + 171), "%s: " "ref-count %d", client->client_uid, (int)client->ref.count); } while (0)
...
# 414 "./client_t.c"
 ...
 415
# 414 "./client_t.c"
                , GF_LOG_INFO, 0, 0, (100000 + 1000 + 55), "Shutting down connection %s", client->client_uid); } while (0)
                                                                          ;
...
client_ctx_set (client_t *client, void *key, void *value)
{
        ...
        pthread_mutex_lock (&client->scratch_ctx.lock);
        {
                ret = client_ctx_set_int (client, key, value);
        }
        pthread_mutex_unlock (&client->scratch_ctx.lock);
...
clienttable_dump (clienttable_t *clienttable, char *prefix)
{
        ...
        ret = pthread_mutex_trylock (&clienttable->lock);
        {
                if (ret) {
                        do { _gf_msg ("client_t",
...
# 599 "./client_t.c"
 ...
 601
# 599 "./client_t.c"
                        , GF_LOG_WARNING, 0, 0, (100000 + 1000 + 14), "Unable to acquire lock"); } while (0)

                                                         ;
                        return;
                }
                memset(key, 0, sizeof key);
                { _gf_proc_dump_build_key(key, prefix, "maxclients"); };
                gf_proc_dump_write(key, "%d", clienttable->max_clients);
                { _gf_proc_dump_build_key(key, prefix, "first_free"); };
                gf_proc_dump_write(key, "%d", clienttable->first_free);
                for ( i = 0 ; i < clienttable->max_clients; i++) {
                        if (-2 ==
                            clienttable->cliententries[i].next_free) {
                                { _gf_proc_dump_build_key(key, prefix, "cliententry[%d]", i); }
                                                                            ;
...
gf_client_dump_fdtables_to_dict (xlator_t *this, dict_t *dict)
{
        ...
        do { if (!this) { (*__errno_location ()) = 22; do { _gf_msg ((*__glusterfs_this_location())->name, "./client_t.c", __FUNCTION__, 685, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "this"); } while (0); goto out; } } while (0);
        do { if (!dict) { (*__errno_location ()) = 22; do { _gf_msg (this->name, "./client_t.c", __FUNCTION__, 686, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "dict"); } while (0); goto out; } } while (0);
...
gf_client_dump_fdtables (xlator_t *this)
{
        ...
        do { if (!this) { (*__errno_location ()) = 22; do { _gf_msg ((*__glusterfs_this_location())->name, "./client_t.c", __FUNCTION__, 730, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "this"); } while (0); goto out; } } while (0);
...
# 740 "./client_t.c"
                ...
                for ( ; count < clienttable->max_clients; count++) {
                        ...
                        if (client->client_uid) {
                                { _gf_proc_dump_build_key(key, "conn", "%d.id", count); }
                                                                       ;
                                gf_proc_dump_write (key, "%s",
                                                    client->client_uid);
                        }

                        { _gf_proc_dump_build_key(key, "conn", "%d.ref", count); }
                                                              ;
                        gf_proc_dump_write (key, "%d", client->ref.count);
                        if (client->bound_xl) {
                                { _gf_proc_dump_build_key(key, "conn", "%d.bound_xl", count); }
                                                                             ;
                                gf_proc_dump_write (key, "%s",
...
gf_client_dump_inodes_to_dict (xlator_t *this, dict_t *dict)
{
        client_t *client = ((void *)0);
        clienttable_t *clienttable = ((void *)0);
        xlator_t *prev_bound_xl = ((void *)0);
        char key[32] = {0,};
        int count = 0;
        int ret = -1;

        do { if (!this) { (*__errno_location ()) = 22; do { _gf_msg ((*__glusterfs_this_location())->name, "./client_t.c", __FUNCTION__, 795, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "this"); } while (0); goto out; } } while (0);
        do { if (!dict) { (*__errno_location ()) = 22; do { _gf_msg (this->name, "./client_t.c", __FUNCTION__, 796, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "dict"); } while (0); goto out; } } while (0);
...
gf_client_dump_inodes (xlator_t *this)
{
        ...
        do { if (!this) { (*__errno_location ()) = 22; do { _gf_msg ((*__glusterfs_this_location())->name, "./client_t.c", __FUNCTION__, 858, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "this"); } while (0); goto out; } } while (0);
...
# 890 "./client_t.c"
                                ...
                                { _gf_proc_dump_build_key(key, "conn", "%d.bound_xl.%s", count, client->bound_xl->name); }
