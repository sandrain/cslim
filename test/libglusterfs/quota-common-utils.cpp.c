# 1 "./quota-common-utils.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "./quota-common-utils.c"
# 12 "./quota-common-utils.c"
# 1 "./dict.h" 1
# 14 "./dict.h"
...
# 15 "./quota-common-utils.c" 2
# 1 "./quota-common-utils.h" 1
# 14 "./quota-common-utils.h"
# 1 "./iatt.h" 1
# 19 "./iatt.h"
# 1 "./compat.h" 1
# 14 "./compat.h"
...
quota_data_to_meta (data_t *data, char *key, quota_meta_t *meta)
{
        ...
        if (data->len > sizeof (int64_t)) {
                ...
                meta->size = hton64 (value->size);
                meta->file_count = hton64 (value->file_count);
                if (data->len > (sizeof (int64_t)) * 2)
                        meta->dir_count = hton64 (value->dir_count);
                else
                        meta->dir_count = 0;
        } else {
                size = (int64_t *) data->data;
                meta->size = hton64 (*size);
                meta->file_count = 0;
                meta->dir_count = 0;
...
# 46 "./quota-common-utils.c"
                , __FUNCTION__,

 48
# 46 "./quota-common-utils.c"
                , GF_LOG_DEBUG, 0, 1, (100000 + 1000 + 168), "Object quota " "xattrs missing: len = %d", data->len); } while (0)
                     ...
                     ia_type_t ia_type)
{
        ...
        value = __gf_calloc (1, sizeof (quota_meta_t), gf_common_quota_meta_t, "gf_common_quota_meta_t");
        if (value == ((void *)0)) {
                goto out;
        }
        ...
        if (ret < 0) {
                do { _gf_msg ("quota",
 "./quota-common-utils.c"
# 120 "./quota-common-utils.c"
                , __FUNCTION__,
 121
# 120 "./quota-common-utils.c"
                , GF_LOG_ERROR, 0, 1, (100000 + 1000 + 147), "dict set failed"); } while (0)
                                                                            ;
                __gf_free (value);
        }
...
quota_conf_read_header (int fd, char *buf)
{
        ...
        header_len = strlen ("GlusterFS Quota conf | version: v1.2\n");
...
out:
 ...
 "./quota-common-utils.c"
# 149 "./quota-common-utils.c"
                , __FUNCTION__,

 151
# 149 "./quota-common-utils.c"
                , GF_LOG_ERROR, 0, 1, (100000 + 1000 + 194), "failed to read " "header from a quota conf"); } while (0)
...
quota_conf_read_version (int fd, float *version)
{
 ...
 "./quota-common-utils.c"
# 176 "./quota-common-utils.c"
                , __FUNCTION__,

 178
# 176 "./quota-common-utils.c"
                , GF_LOG_ERROR, 0, 1, (100000 + 1000 + 194), "invalid quota conf" " version"); } while (0)
...
out:
 ...
 "./quota-common-utils.c"
# 188 "./quota-common-utils.c"
                , __FUNCTION__,

 190
# 188 "./quota-common-utils.c"
                , GF_LOG_ERROR, 0, 1, (100000 + 1000 + 194), "failed to " "read version from a quota conf header"); } while (0)
...
out:
 ...
 "./quota-common-utils.c"
# 222 "./quota-common-utils.c"
                , __FUNCTION__,

 224
# 222 "./quota-common-utils.c"
                , GF_LOG_ERROR, 0, 1, (100000 + 1000 + 194), "failed to " "read gfid from a quota conf"); } while (0)
...
quota_conf_skip_header (int fd)
{
        return gf_skip_header_section (fd, strlen ("GlusterFS Quota conf | version: v1.2\n"));
}
