...
# 30 "./store.c"
 ...
 31
# 30 "./store.c"
                , GF_LOG_ERROR, (*__errno_location ()), 0, (100000 + 1000 + 10), "mkdir()" " failed on path %s.", path); } while (0)
                                                    ;
        } else {
                ret = 0;
        }
...
gf_store_handle_create_on_absence (gf_store_handle_t **shandle,
                                   char *path)
{
        do { if (!(shandle)) { do { _gf_msg ("", "./store.c", __FUNCTION__, 43, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "shandle"); } while (0); } } while (0);
        int32_t ret = 0;
...
# 50 "./store.c"
 ...
 52
# 50 "./store.c"
                        , GF_LOG_ERROR, 0, 0, (100000 + 1000 + 11), "Unable to" " create store handle for path: %s", path); } while (0)
...
gf_store_mkstemp (gf_store_handle_t *shandle)
{
        ...
        do { if (!shandle) { (*__errno_location ()) = 22; do { _gf_msg ("store", "./store.c", __FUNCTION__, 63, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "shandle"); } while (0); goto out; } } while (0);
        do { if (!shandle->path) { (*__errno_location ()) = 22; do { _gf_msg ("store", "./store.c", __FUNCTION__, 64, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "shandle->path"); } while (0); goto out; } } while (0);

        snprintf (tmppath, sizeof (tmppath), "%s.tmp", shandle->path);
        shandle->tmp_fd = open (tmppath, 02 | 0100 | 01000, 0600);
        if (shandle->tmp_fd < 0) {
                do { _gf_msg ("",
 "./store.c"
# 69 "./store.c"
 ...
 70
# 69 "./store.c"
                , GF_LOG_ERROR, (*__errno_location ()), 0, (100000 + 1000 + 12), "Failed to open %s.", tmppath); } while (0)
                                                      ;
        }
out:
...
# 94 "./store.c"
 ...
 95
# 94 "./store.c"
                , GF_LOG_ERROR, (*__errno_location ()), 0, (100000 + 1000 + 10), "Failed to open directory %s.", pdir); } while (0)
                                                             ;
                goto out;
        }
...
# 101 "./store.c"
 ...
 102
# 101 "./store.c"
                , GF_LOG_ERROR, (*__errno_location ()), 0, (100000 + 1000 + 10), "Failed to fsync %s.", pdir); } while (0)
                                                                          ;
                goto out;
        }
...
# 111 "./store.c"
 ...
 112
# 111 "./store.c"
                        , GF_LOG_ERROR, (*__errno_location ()), 0, (100000 + 1000 + 10), "Failed to close %s", pdir); } while (0)
                                                                                 ;
                }
        }
...
gf_store_rename_tmppath (gf_store_handle_t *shandle)
{
        ...
        do { if (!shandle) { (*__errno_location ()) = 22; do { _gf_msg ("store", "./store.c", __FUNCTION__, 128, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "shandle"); } while (0); goto out; } } while (0);
        do { if (!shandle->path) { (*__errno_location ()) = 22; do { _gf_msg ("store", "./store.c", __FUNCTION__, 129, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "shandle->path"); } while (0); goto out; } } while (0);
...
# 133 "./store.c"
 ...
 134
# 133 "./store.c"
                , GF_LOG_ERROR, (*__errno_location ()), 0, (100000 + 1000 + 12), "Failed to fsync %s", shandle->path); } while (0)
                                                            ;
                goto out;
        }
        snprintf (tmppath, sizeof (tmppath), "%s.tmp", shandle->path);
...
# 140 "./store.c"
 ...
 142
# 140 "./store.c"
                , GF_LOG_ERROR, (*__errno_location ()), 0, (100000 + 1000 + 12), "Failed to rename %s to %s", tmppath, shandle->path); } while (0)
...
gf_store_unlink_tmppath (gf_store_handle_t *shandle)
{
        ...
        do { if (!shandle) { (*__errno_location ()) = 22; do { _gf_msg ("store", "./store.c", __FUNCTION__, 161, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "shandle"); } while (0); goto out; } } while (0);
        do { if (!shandle->path) { (*__errno_location ()) = 22; do { _gf_msg ("store", "./store.c", __FUNCTION__, 162, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "shandle->path"); } while (0); goto out; } } while (0);
...
# 167 "./store.c"
 ...
 169
# 167 "./store.c"
                , GF_LOG_ERROR, (*__errno_location ()), 0, (100000 + 1000 + 12), "Failed to mv %s to %s", tmppath, shandle->path); } while (0)
                            ...
                            char **iter_val, gf_store_op_errno_t *store_errno)
{
        ...
        do { if (!(file)) { do { _gf_msg ("", "./store.c", __FUNCTION__, 192, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "file"); } while (0); } } while (0);
        do { if (!(str)) { do { _gf_msg ("", "./store.c", __FUNCTION__, 193, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "str"); } while (0); } } while (0);
        do { if (!(iter_key)) { do { _gf_msg ("", "./store.c", __FUNCTION__, 194, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "iter_key"); } while (0); } } while (0);
        do { if (!(iter_val)) { do { _gf_msg ("", "./store.c", __FUNCTION__, 195, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "iter_val"); } while (0); } } while (0);
        do { if (!(store_errno)) { do { _gf_msg ("", "./store.c", __FUNCTION__, 196, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "store_errno"); } while (0); } } while (0);
...
{
        int32_t ret = -1;
        char *scan_str = ((void *)0);
        char *iter_key = ((void *)0);
        char *iter_val = ((void *)0);
        char *free_str = ((void *)0);
        struct stat st = {0,};
        gf_store_op_errno_t store_errno = GD_STORE_SUCCESS;

        do { if (!(handle)) { do { _gf_msg ("", "./store.c", __FUNCTION__, 242, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "handle"); } while (0); } } while (0);

        if (handle->locked == 0)

                handle->fd = open (handle->path, 02);
        else

                sys_lseek (handle->fd, 0, 0);
...
# 252 "./store.c"
 ...
 253
# 252 "./store.c"
                , GF_LOG_ERROR, (*__errno_location ()), 0, (100000 + 1000 + 12), "Unable to open file %s", handle->path); } while (0)
                                                               ;
                goto out;
        }
        if (!handle->read)
...
# 269 "./store.c"
 ...
 270
# 269 "./store.c"
                , GF_LOG_WARNING, (*__errno_location ()), 0, (100000 + 1000 + 12), "stat on file %s failed", handle->path); } while (0)
                                                               ;
                ret = -1;
        ...
        scan_str = __gf_calloc (1, st.st_size + 1, gf_common_mt_char, "gf_common_mt_char")
                                                ;
...
# 297 "./store.c"
 ...
 299
# 297 "./store.c"
                        , GF_LOG_TRACE, 0, 0, 0, "error while reading key '%s': " "%s", key, gf_store_strerror (store_errno)); } while (0)

                                                                      ;
                        goto out;
                }

                do { _gf_msg ("", "./store.c", __FUNCTION__, 303, GF_LOG_TRACE, 0, 0, 0, "key %s read", iter_key); } while (0);

                if (!strcmp (key, iter_key)) {
                        do { _gf_msg ("", "./store.c", __FUNCTION__, 306, GF_LOG_DEBUG, 0, 0, 0, "key %s found", key); } while (0);
                        ret = 0;
                        if (iter_val)
...
out:
        ...
        if (handle->fd > 0 && handle->locked == 0) {
...
gf_store_save_value (int fd, char *key, char *value)
{
        ...
        do { if (!(fd > 0)) { do { _gf_msg ("", "./store.c", __FUNCTION__, 336, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "fd > 0"); } while (0); } } while (0);
        do { if (!(key)) { do { _gf_msg ("", "./store.c", __FUNCTION__, 337, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "key"); } while (0); } } while (0);
        do { if (!(value)) { do { _gf_msg ("", "./store.c", __FUNCTION__, 338, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "value"); } while (0); } } while (0);
...
# 346 "./store.c"
 ...
 347
# 346 "./store.c"
                , GF_LOG_WARNING, (*__errno_location ()), 0, (100000 + 1000 + 12), "fdopen failed."); } while (0)
                                                                ;
                ret = -1;
                goto out;
        }
...
# 354 "./store.c"
 ...
 356
# 354 "./store.c"
                , GF_LOG_WARNING, (*__errno_location ()), 0, (100000 + 1000 + 12), "Unable to store key: %s, value: %s.", key, value); } while (0)
...
# 363 "./store.c"
 ...
 364
# 363 "./store.c"
                , GF_LOG_WARNING, (*__errno_location ()), 0, (100000 + 1000 + 12), "fflush failed."); } while (0)
                                         ;
                ret = -1;
                goto out;
        }
...
out:
        ...
        do { _gf_msg ((*__glusterfs_this_location())->name, "./store.c", __FUNCTION__, 374, GF_LOG_DEBUG, 0, 0, 0, "returning: %d", ret); } while (0);
        return ret;
}
...
{
        int32_t ret = -1;
        gf_store_handle_t *shandle = ((void *)0);
        int fd = -1;
        char *spath = ((void *)0);

        shandle = __gf_calloc (1, sizeof (*shandle), gf_common_mt_store_handle_t, "gf_common_mt_store_handle_t");
        if (!shandle)
                goto out;
        ...
        fd = open (path, 02 | 0100 | 02000, 0600);
        if (fd < 0) {
                do { _gf_msg ("",
 "./store.c"
# 396 "./store.c"
 ...
 397
# 396 "./store.c"
                , GF_LOG_ERROR, (*__errno_location ()), 0, (100000 + 1000 + 12), "Failed to open file: %s.", path); } while (0)
                                                         ;
                goto out;
        }
...
out:
        ...
        do { _gf_msg ("", "./store.c", __FUNCTION__, 420, GF_LOG_DEBUG, 0, 0, 0, "Returning %d", ret); } while (0);
        return ret;
}
...
# 432 "./store.c"
 ...
 433
# 432 "./store.c"
                , GF_LOG_ERROR, (*__errno_location ()), 0, (100000 + 1000 + 32), "Path " "corresponding to %s.", path); } while (0)
                                                     ;
                goto out;
        }
        ret = gf_store_handle_new (path, handle);
out:
        do { _gf_msg ("", "./store.c", __FUNCTION__, 438, GF_LOG_DEBUG, 0, 0, 0, "Returning %d", ret); } while (0);
        return ret;
}
...
out:
        do { _gf_msg ("", "./store.c", __FUNCTION__, 459, GF_LOG_DEBUG, 0, 0, 0, "Returning %d", ret); } while (0);
...
gf_store_iter_new (gf_store_handle_t *shandle, gf_store_iter_t **iter)
{
        int32_t ret = -1;
        FILE *fp = ((void *)0);
        gf_store_iter_t *tmp_iter = ((void *)0);

        do { if (!(shandle)) { do { _gf_msg ("", "./store.c", __FUNCTION__, 471, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "shandle"); } while (0); } } while (0);
        do { if (!(iter)) { do { _gf_msg ("", "./store.c", __FUNCTION__, 472, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "iter"); } while (0); } } while (0);
...
# 476 "./store.c"
 ...
 477
# 476 "./store.c"
                , GF_LOG_ERROR, (*__errno_location ()), 0, (100000 + 1000 + 12), "Unable to open file %s", shandle->path); } while (0)
                                                                ;
                goto out;
        }

        tmp_iter = __gf_calloc (1, sizeof (*tmp_iter), gf_common_mt_store_iter_t, "gf_common_mt_store_iter_t")
                                                        ;
        if (!tmp_iter)
                goto out;
...
out:
        ...
        do { _gf_msg ("", "./store.c", __FUNCTION__, 500, GF_LOG_DEBUG, 0, 0, 0, "Returning with %d", ret); } while (0);
        return ret;
}
                             ...
                             gf_store_op_errno_t *op_errno)
{
        ...
        do { if (!(op_errno)) { do { _gf_msg ("", "./store.c", __FUNCTION__, 510, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "op_errno"); } while (0); } } while (0);
        do { if (!(storepath)) { do { _gf_msg ("", "./store.c", __FUNCTION__, 511, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "storepath"); } while (0); } } while (0);
...
# 515 "./store.c"
 ...
 517
# 515 "./store.c"
                , GF_LOG_ERROR, 0, 0, (100000 + 1000 + 2), "Glusterd " "store may be corrupted, Invalid key and value (null)" " in %s", storepath); } while (0)
...
# 521 "./store.c"
 ...
 523
# 521 "./store.c"
                , GF_LOG_ERROR, 0, 0, (100000 + 1000 + 2), "Glusterd " "store may be corrupted, Invalid key (null) in %s", storepath); } while (0)
...
# 527 "./store.c"
 ...
 529
# 527 "./store.c"
                , GF_LOG_ERROR, 0, 0, (100000 + 1000 + 2), "Glusterd " "store may be corrupted, Invalid value (null) for key" " %s in %s", key, storepath); } while (0)
                        ...
                        gf_store_op_errno_t *op_errno)
{
        ...
        do { if (!(iter)) { do { _gf_msg ("", "./store.c", __FUNCTION__, 550, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "iter"); } while (0); } } while (0);
        do { if (!(key)) { do { _gf_msg ("", "./store.c", __FUNCTION__, 551, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "key"); } while (0); } } while (0);
        do { if (!(value)) { do { _gf_msg ("", "./store.c", __FUNCTION__, 552, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "value"); } while (0); } } while (0);
...
# 556 "./store.c"
 ...
 557
# 556 "./store.c"
                , GF_LOG_WARNING, (*__errno_location ()), 0, (100000 + 1000 + 12), "stat on file failed"); } while (0)
                                              ;
                ret = -1;
                store_errno = GD_STORE_STAT_FAILED;
                goto out;
...
out:
        ...
        do { _gf_msg ("", "./store.c", __FUNCTION__, 613, GF_LOG_DEBUG, 0, 0, 0, "Returning with %d", ret); } while (0);
        return ret;
}
...
gf_store_iter_get_matching (gf_store_iter_t *iter, char *key, char **value)
{
        int32_t ret = -1;
        char *tmp_key = ((void *)0);
        char *tmp_value = ((void *)0);

        ret = gf_store_iter_get_next (iter, &tmp_key, &tmp_value, ((void *)0));
        while (!ret) {
...
# 654 "./store.c"
 ...
 656
# 654 "./store.c"
                , GF_LOG_ERROR, (*__errno_location ()), 0, (100000 + 1000 + 12), "Unable" " to close file: %s, ret: %d" , iter->filepath, ret); } while (0)
...
gf_store_lock (gf_store_handle_t *sh)
{
        ...
        do { if (!(sh)) { do { _gf_msg ("", "./store.c", __FUNCTION__, 688, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "sh"); } while (0); } } while (0);
        do { if (!(sh->path)) { do { _gf_msg ("", "./store.c", __FUNCTION__, 689, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "sh->path"); } while (0); } } while (0);
        do { if (!(sh->locked == 0)) { do { _gf_msg ("", "./store.c", __FUNCTION__, 690, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "sh->locked == F_ULOCK"); } while (0); } } while (0);

        sh->fd = open (sh->path, 02);
        if (sh->fd == -1) {
                do { _gf_msg ("",
 "./store.c"
# 694 "./store.c"
 ...
 695
# 694 "./store.c"
                , GF_LOG_ERROR, (*__errno_location ()), 0, (100000 + 1000 + 12), "Failed to open '%s'", sh->path); } while (0)
                                                        ;
                return -1;
        }
...
# 701 "./store.c"
 ...
 702
# 701 "./store.c"
                , GF_LOG_ERROR, (*__errno_location ()), 0, (100000 + 1000 + 14), "Failed to gain lock on '%s'", sh->path); } while (0)
                                                                ;
        else
...
gf_store_unlock (gf_store_handle_t *sh)
{
        do { if (!(sh)) { do { _gf_msg ("", "./store.c", __FUNCTION__, 713, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "sh"); } while (0); } } while (0);
        do { if (!(sh->locked == 1)) { do { _gf_msg ("", "./store.c", __FUNCTION__, 714, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "sh->locked == F_LOCK"); } while (0); } } while (0);

        sh->locked = 0;


        if (lockf (sh->fd, 0, 0) == -1)
                do { _gf_msg ("",
 "./store.c"
# 720 "./store.c"
                , __FUNCTION__,
 721
# 720 "./store.c"
                , GF_LOG_ERROR, (*__errno_location ()), 0, (100000 + 1000 + 15), "Failed to release lock on '%s'", sh->path); } while (0)
                                                                   ;
...
gf_store_locked_local (gf_store_handle_t *sh)
{
        do { if (!(sh)) { do { _gf_msg ("", "./store.c", __FUNCTION__, 729, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "sh"); } while (0); } } while (0);
