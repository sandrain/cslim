...
# 38 "/home/hyogi/workspace/glusterfs/contrib/uuid/uuid.h"
# 1 "./config.h" 1
# 39 "/home/hyogi/workspace/glusterfs/contrib/uuid/uuid.h" 2
...
stub_new (call_frame_t *frame,
          ...
          glusterfs_fop_t fop)
{
        call_stub_t *new = ((void *)0);

        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 25, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        new = mem_get0 (frame->this->ctx->stub_mem_pool);
        do { if (!new) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 28, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "new"); } while (0); goto out; } } while (0);

        new->frame = frame;
        new->wind = wind;
        new->fop = fop;
        new->stub_mem_pool = frame->this->ctx->stub_mem_pool;
        do { (&new->list)->next = (&new->list)->prev = &new->list; } while (0);

        do { (&new->args_cbk.entries)->next = (&new->args_cbk.entries)->prev = &new->args_cbk.entries; } while (0);
out:
        return new;
}
...
fop_lookup_stub (call_frame_t *frame, fop_lookup_t fn, loc_t *loc,
                 dict_t *xdata)
{
        call_stub_t *stub = ((void *)0);

        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 48, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);
        do { if (!loc) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 49, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "loc"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_LOOKUP);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 52, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                     ...
                     dict_t *xdata, struct iatt *postparent)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 73, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_LOOKUP);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 76, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
               ...
               loc_t *loc, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 92, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);
        do { if (!loc) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 93, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "loc"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_STAT);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 96, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                   ...
                   struct iatt *buf, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 114, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_STAT);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 117, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                ...
                fd_t *fd, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 133, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_FSTAT);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 136, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                    ...
                    struct iatt *buf, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 156, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_FSTAT);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 159, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                   ...
                   loc_t *loc, off_t off, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 175, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);
        do { if (!loc) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 176, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "loc"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_TRUNCATE);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 179, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
         ...
         struct iatt *postbuf, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 198, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_TRUNCATE);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 201, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                    ...
                    fd_t *fd, off_t off, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 217, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_FTRUNCATE);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 220, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
   ...
   struct iatt *postbuf, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 241, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_FTRUNCATE);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 244, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                 ...
                 loc_t *loc, int32_t mask, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 261, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);
        do { if (!loc) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 262, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "loc"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_ACCESS);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 265, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                     ...
                     int32_t op_ret, int32_t op_errno, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 283, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_ACCESS);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 286, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                   ...
                   loc_t *loc, size_t size, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 301, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);
        do { if (!loc) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 302, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "loc"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_READLINK);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 305, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                       ...
                       const char *path, struct iatt *stbuf, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 324, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_READLINK);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 327, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                ...
                dev_t rdev, mode_t umask, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 343, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);
        do { if (!loc) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 344, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "loc"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_MKNOD);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 347, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
      ...
      dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 369, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_MKNOD);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 372, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                ...
                loc_t *loc, mode_t mode, mode_t umask, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 388, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);
        do { if (!loc) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 389, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "loc"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_MKDIR);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 392, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                    ...
                    struct iatt *postparent, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 414, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_MKDIR);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 417, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                 ...
                 loc_t *loc, int xflag, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 433, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);
        do { if (!loc) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 434, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "loc"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_UNLINK);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 437, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
       ...
       dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 457, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_UNLINK);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 460, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                ...
                loc_t *loc, int flags, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 477, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);
        do { if (!loc) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 478, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "loc"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_RMDIR);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 481, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
      ...
      dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 501, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_RMDIR);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 504, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                  ...
                  const char *linkname, loc_t *loc, mode_t umask, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 520, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);
        do { if (!loc) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 521, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "loc"); } while (0); goto out; } } while (0);
        do { if (!linkname) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 522, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "linkname"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_SYMLINK);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 525, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
        ...
        dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 547, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_SYMLINK);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 550, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                 ...
                 loc_t *oldloc, loc_t *newloc, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 566, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);
        do { if (!oldloc) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 567, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "oldloc"); } while (0); goto out; } } while (0);
        do { if (!newloc) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 568, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "newloc"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_RENAME);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 571, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
       ...
       dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 592, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_RENAME);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 595, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
               ...
               loc_t *oldloc, loc_t *newloc, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 612, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);
        do { if (!oldloc) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 613, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "oldloc"); } while (0); goto out; } } while (0);
        do { if (!newloc) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 614, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "newloc"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_LINK);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 617, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
     ...
     dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 639, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_LINK);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 642, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                 ...
                 mode_t umask, fd_t *fd, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 659, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);
        do { if (!loc) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 660, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "loc"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_CREATE);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 663, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
       ...
       dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 688, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_CREATE);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 691, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
               ...
               loc_t *loc, int32_t flags, fd_t *fd, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 707, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);
        do { if (!loc) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 708, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "loc"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_OPEN);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 711, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                   ...
                   fd_t *fd, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 732, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_OPEN);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 735, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
  ...
  dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 751, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_READ);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 754, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                    ...
                    struct iobref *iobref, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 778, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_READ);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 781, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
   ...
   uint32_t flags, struct iobref *iobref, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 798, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);
        do { if (!vector) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 799, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "vector"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_WRITE);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 802, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                     ...
                     struct iatt *prebuf, struct iatt *postbuf, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 826, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_WRITE);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 829, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                ...
                fd_t *fd, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 845, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_FLUSH);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 848, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                    ...
                    int32_t op_ret, int32_t op_errno, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 866, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_FLUSH);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 869, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                ...
                fd_t *fd, int32_t datasync, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 884, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_FSYNC);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 887, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                    ...
                    struct iatt *prebuf, struct iatt *postbuf, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 907, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_FSYNC);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 910, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                  ...
                  loc_t *loc, fd_t *fd, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 926, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);
        do { if (!loc) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 927, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "loc"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_OPENDIR);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 930, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                      ...
                      fd_t *fd, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 950, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_OPENDIR);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 953, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                   ...
                   fd_t *fd, int32_t datasync, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 968, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_FSYNCDIR);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 971, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                       ...
                       int32_t op_ret, int32_t op_errno, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 990, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_FSYNCDIR);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 993, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                 ...
                 loc_t *loc, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1008, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);
        do { if (!loc) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1009, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "loc"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_STATFS);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1012, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                     ...
                     struct statvfs *buf, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1030, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_STATFS);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1033, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                   ...
                   int32_t flags, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1049, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);
        do { if (!loc) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1050, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "loc"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_SETXATTR);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1053, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                       ...
                       int32_t op_errno, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1076, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_SETXATTR);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1079, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                   ...
                   loc_t *loc, const char *name, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1094, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);
        do { if (!loc) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1095, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "loc"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_GETXATTR);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1098, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                       ...
                       dict_t *dict, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1119, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_GETXATTR);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1122, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                    ...
                    fd_t *fd, dict_t *dict, int32_t flags, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1138, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);
        do { if (!fd) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1139, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "fd"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_FSETXATTR);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1142, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                        ...
                        int32_t op_ret, int32_t op_errno, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1163, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_FSETXATTR);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1166, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                    ...
                    fd_t *fd, const char *name, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1181, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);
        do { if (!fd) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1182, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "fd"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_FGETXATTR);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1185, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                        ...
                        dict_t *dict, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1206, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_GETXATTR);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1209, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                      ...
                      loc_t *loc, const char *name, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1225, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);
        do { if (!loc) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1226, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "loc"); } while (0); goto out; } } while (0);
        do { if (!name) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1227, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "name"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_REMOVEXATTR);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1230, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                          ...
                          int32_t op_ret, int32_t op_errno, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1248, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_REMOVEXATTR);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1251, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                       ...
                       fd_t *fd, const char *name, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1266, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);
        do { if (!fd) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1267, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "fd"); } while (0); goto out; } } while (0);
        do { if (!name) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1268, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "name"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_FREMOVEXATTR);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1271, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                           ...
                           int32_t op_ret, int32_t op_errno, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1289, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_FREMOVEXATTR);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1292, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
             ...
             struct gf_flock *lock, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1308, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);
        do { if (!lock) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1309, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "lock"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_LK);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1312, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                 ...
                 struct gf_flock *lock, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1333, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_LK);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1336, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                  ...
                  struct gf_flock *lock, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1352, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);
        do { if (!lock) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1353, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "lock"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_INODELK);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1356, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                      ...
                      int32_t op_ret, int32_t op_errno, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1379, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_INODELK);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1382, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                   ...
                   struct gf_flock *lock, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1398, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);
        do { if (!lock) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1399, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "lock"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_FINODELK);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1402, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                       ...
                       int32_t op_ret, int32_t op_errno, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1428, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_FINODELK);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1431, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                  ...
                  entrylk_cmd cmd, entrylk_type type, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1447, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_ENTRYLK);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1450, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                      ...
                      int32_t op_ret, int32_t op_errno, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1478, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_ENTRYLK);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1481, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                   ...
                   entrylk_cmd cmd, entrylk_type type, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1497, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_FENTRYLK);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1500, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                       ...
                       int32_t op_ret, int32_t op_errno, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1527, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_FENTRYLK);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1530, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                       ...
                       gf_dirent_t *entries, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1546, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_READDIRP);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1549, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                      ...
                      gf_dirent_t *entries, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1566, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_READDIR);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1569, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                  ...
                  off_t off, dict_t *xdata)
{
        ...
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1587, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                   ...
                   fd_t *fd, size_t size, off_t off, dict_t *xdata)
{
        ...
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1608, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                    ...
                    fd_t *fd, off_t offset, int32_t len, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1627, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);
        do { if (!fd) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1628, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "fd"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_RCHECKSUM);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1631, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
   ...
   dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1652, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_RCHECKSUM);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1655, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                      ...
                      int32_t op_errno, dict_t *xattr, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1671, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_XATTROP);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1674, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
...
{
        call_stub_t *stub = ((void *)0);
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1690, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_FXATTROP);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1693, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                  ...
                  dict_t *xattr, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1710, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);
        do { if (!xattr) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1711, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "xattr"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_XATTROP);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1714, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                   ...
                   dict_t *xattr, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1737, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);
        do { if (!xattr) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1738, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "xattr"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_FXATTROP);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1741, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
        ...
        dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1765, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_SETATTR);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1768, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
         ...
         dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1786, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_FSETATTR);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1789, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                  ...
                  int32_t valid, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1806, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);
        do { if (!fn) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1807, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "fn"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_SETATTR);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1810, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                   ...
                   int32_t valid, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1835, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);
        do { if (!fn) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1836, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "fn"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_FSETATTR);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1839, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
         ...
         dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1865, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_FALLOCATE);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1868, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
     ...
     int32_t mode, off_t offset, size_t len, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1884, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);
        do { if (!fn) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1885, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "fn"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_FALLOCATE);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1888, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
       ...
       dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1914, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_DISCARD);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1917, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
   ...
   off_t offset, size_t len, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1933, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);
        do { if (!fn) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1934, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "fn"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_DISCARD);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1937, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                     ...
                     dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1962, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_ZEROFILL);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1965, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                 ...
                 off_t offset, off_t len, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1981, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);
        do { if (!fn) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1982, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "fn"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_ZEROFILL);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 1985, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                  ...
                  int32_t op_ret, int32_t op_errno, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 2009, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_IPC);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 2012, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
              ...
              int32_t op, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 2027, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);
        do { if (!fn) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 2028, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "fn"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_IPC);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 2031, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
                   ...
                   dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 2052, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 0, GF_FOP_SEEK);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 2055, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
               ...
               off_t offset, gf_seek_what_t what, dict_t *xdata)
{
        ...
        do { if (!frame) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 2071, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "frame"); } while (0); goto out; } } while (0);
        do { if (!fn) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 2072, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "fn"); } while (0); goto out; } } while (0);

        stub = stub_new (frame, 1, GF_FOP_SEEK);
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 2075, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
...
{
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 2096, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
...
# 2336 "./call-stub.c"
 ...
 2338
# 2336 "./call-stub.c"
                , GF_LOG_ERROR, 22, 1, (100000 + 1000 + 2), "Invalid value of FOP" " (%d)", stub->fop); } while (0)
...
{
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 2360, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);

        switch (stub->fop) {
        case GF_FOP_OPEN:
  do { if (stub->fn_cbk.open) stub->fn_cbk.open (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.fd, stub->args_cbk.xdata); else do { fop_open_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack",
 "./call-stub.c"
# 2364 "./call-stub.c"
  , __FUNCTION__,
 2365
# 2364 "./call-stub.c"
  , GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_open_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.fd, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0)
                             ;
                break;
        case GF_FOP_CREATE:
  do { if (stub->fn_cbk.create) stub->fn_cbk.create (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.fd, stub->args_cbk.inode, &stub->args_cbk.stat, &stub->args_cbk.preparent, &stub->args_cbk.postparent, stub->args_cbk.xdata); else do { fop_create_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack",
...
# 2368 "./call-stub.c"
 ...
 2372
# 2368 "./call-stub.c"
  , GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_create_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.fd, stub->args_cbk.inode, &stub->args_cbk.stat, &stub->args_cbk.preparent, &stub->args_cbk.postparent, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0)
                ...
                break;
        case GF_FOP_STAT:
  do { if (stub->fn_cbk.stat) stub->fn_cbk.stat (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, &stub->args_cbk.stat, stub->args_cbk.xdata); else do { fop_stat_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack",
 "./call-stub.c"
# 2375 "./call-stub.c"
  , __FUNCTION__,
 2376
# 2375 "./call-stub.c"
  , GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_stat_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, &stub->args_cbk.stat, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0)
                             ;
                break;
        case GF_FOP_READLINK:
  do { if (stub->fn_cbk.readlink) stub->fn_cbk.readlink (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.buf, &stub->args_cbk.stat, stub->args.xdata); else do { fop_readlink_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack",
 "./call-stub.c"
# 2379 "./call-stub.c"
  , __FUNCTION__,
 2380
# 2379 "./call-stub.c"
  , GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_readlink_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.buf, &stub->args_cbk.stat, stub->args.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0)
                                               ;
  break;
        case GF_FOP_MKNOD:
  do { if (stub->fn_cbk.mknod) stub->fn_cbk.mknod (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.inode, &stub->args_cbk.stat, &stub->args_cbk.preparent, &stub->args_cbk.postparent, stub->args_cbk.xdata); else do { fop_mknod_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack",
...
# 2383 "./call-stub.c"
 ...
 2385
# 2383 "./call-stub.c"
  , GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_mknod_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.inode, &stub->args_cbk.stat, &stub->args_cbk.preparent, &stub->args_cbk.postparent, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0)

                                                         ;
  break;
        case GF_FOP_MKDIR:
  do { if (stub->fn_cbk.mkdir) stub->fn_cbk.mkdir (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.inode, &stub->args_cbk.stat, &stub->args_cbk.preparent, &stub->args_cbk.postparent, stub->args_cbk.xdata); else do { fop_mkdir_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack",
...
# 2388 "./call-stub.c"
 ...
 2390
# 2388 "./call-stub.c"
  , GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_mkdir_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.inode, &stub->args_cbk.stat, &stub->args_cbk.preparent, &stub->args_cbk.postparent, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0)

                                                         ;
  break;
        case GF_FOP_UNLINK:
  do { if (stub->fn_cbk.unlink) stub->fn_cbk.unlink (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, &stub->args_cbk.preparent, &stub->args_cbk.postparent, stub->args_cbk.xdata); else do { fop_unlink_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack",
 "./call-stub.c"
# 2393 "./call-stub.c"
  , __FUNCTION__,
 2394
# 2393 "./call-stub.c"
  , GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_unlink_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, &stub->args_cbk.preparent, &stub->args_cbk.postparent, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0)
                                                         ;
  break;
        case GF_FOP_RMDIR:
  do { if (stub->fn_cbk.rmdir) stub->fn_cbk.rmdir (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, &stub->args_cbk.preparent, &stub->args_cbk.postparent, stub->args_cbk.xdata); else do { fop_rmdir_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack",
 "./call-stub.c"
# 2397 "./call-stub.c"
  , __FUNCTION__,
 2398
# 2397 "./call-stub.c"
  , GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_rmdir_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, &stub->args_cbk.preparent, &stub->args_cbk.postparent, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0)
                                                         ;
  break;
        case GF_FOP_SYMLINK:
  do { if (stub->fn_cbk.symlink) stub->fn_cbk.symlink (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.inode, &stub->args_cbk.stat, &stub->args_cbk.preparent, &stub->args_cbk.postparent, stub->args_cbk.xdata); else do { fop_symlink_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack",
...
# 2401 "./call-stub.c"
 ...
 2403
# 2401 "./call-stub.c"
  , GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_symlink_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.inode, &stub->args_cbk.stat, &stub->args_cbk.preparent, &stub->args_cbk.postparent, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0)

                                                         ;
  break;
        case GF_FOP_RENAME:
  do { if (stub->fn_cbk.rename) stub->fn_cbk.rename (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, &stub->args_cbk.stat, &stub->args_cbk.preparent, &stub->args_cbk.postparent, &stub->args_cbk.preparent2, &stub->args_cbk.postparent2, stub->args_cbk.xdata); else do { fop_rename_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack",
...
# 2406 "./call-stub.c"
 ...
 2411
# 2406 "./call-stub.c"
  , GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_rename_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, &stub->args_cbk.stat, &stub->args_cbk.preparent, &stub->args_cbk.postparent, &stub->args_cbk.preparent2, &stub->args_cbk.postparent2, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0)
  ...
  break;
        case GF_FOP_LINK:
  do { if (stub->fn_cbk.link) stub->fn_cbk.link (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.inode, &stub->args_cbk.stat, &stub->args_cbk.preparent, &stub->args_cbk.postparent, stub->args_cbk.xdata); else do { fop_link_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack",
...
# 2414 "./call-stub.c"
 ...
 2416
# 2414 "./call-stub.c"
  , GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_link_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.inode, &stub->args_cbk.stat, &stub->args_cbk.preparent, &stub->args_cbk.postparent, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0)

                                                         ;
  break;
        case GF_FOP_TRUNCATE:
  do { if (stub->fn_cbk.truncate) stub->fn_cbk.truncate (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, &stub->args_cbk.prestat, &stub->args_cbk.poststat, stub->args_cbk.xdata); else do { fop_truncate_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack",
 "./call-stub.c"
# 2419 "./call-stub.c"
  , __FUNCTION__,
 2420
# 2419 "./call-stub.c"
  , GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_truncate_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, &stub->args_cbk.prestat, &stub->args_cbk.poststat, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0)
                                                       ;
  break;
        case GF_FOP_READ:
  do { if (stub->fn_cbk.readv) stub->fn_cbk.readv (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.vector, stub->args_cbk.count, &stub->args_cbk.stat, stub->args_cbk.iobref, stub->args_cbk.xdata); else do { fop_readv_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack",
...
# 2423 "./call-stub.c"
 ...
 2425
# 2423 "./call-stub.c"
  , GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_readv_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.vector, stub->args_cbk.count, &stub->args_cbk.stat, stub->args_cbk.iobref, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0)

                                                    ;
  break;
        case GF_FOP_WRITE:
  do { if (stub->fn_cbk.writev) stub->fn_cbk.writev (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, &stub->args_cbk.prestat, &stub->args_cbk.poststat, stub->args_cbk.xdata); else do { fop_writev_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack",
 "./call-stub.c"
# 2428 "./call-stub.c"
  , __FUNCTION__,
 2429
# 2428 "./call-stub.c"
  , GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_writev_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, &stub->args_cbk.prestat, &stub->args_cbk.poststat, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0)
                                                       ;
  break;
        case GF_FOP_STATFS:
  do { if (stub->fn_cbk.statfs) stub->fn_cbk.statfs (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, &stub->args_cbk.statvfs, stub->args_cbk.xdata); else do { fop_statfs_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack",
 "./call-stub.c"
# 2432 "./call-stub.c"
  , __FUNCTION__,
 2433
# 2432 "./call-stub.c"
  , GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_statfs_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, &stub->args_cbk.statvfs, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0)
                             ;
  break;
        case GF_FOP_FLUSH:
  do { if (stub->fn_cbk.flush) stub->fn_cbk.flush (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.xdata); else do { fop_flush_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack", "./call-stub.c", __FUNCTION__, 2436, GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_flush_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0);
  break;
        case GF_FOP_FSYNC:
  do { if (stub->fn_cbk.fsync) stub->fn_cbk.fsync (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, &stub->args_cbk.prestat, &stub->args_cbk.poststat, stub->args_cbk.xdata); else do { fop_fsync_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack",
 "./call-stub.c"
# 2439 "./call-stub.c"
  , __FUNCTION__,
 2440
# 2439 "./call-stub.c"
  , GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_fsync_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, &stub->args_cbk.prestat, &stub->args_cbk.poststat, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0)
                                                       ;
  break;
        case GF_FOP_SETXATTR:
  do { if (stub->fn_cbk.setxattr) stub->fn_cbk.setxattr (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.xdata); else do { fop_setxattr_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack", "./call-stub.c", __FUNCTION__, 2443, GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_setxattr_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0);
  break;
        case GF_FOP_GETXATTR:
  do { if (stub->fn_cbk.getxattr) stub->fn_cbk.getxattr (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.xattr, stub->args_cbk.xdata); else do { fop_getxattr_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack",
 "./call-stub.c"
# 2446 "./call-stub.c"
  , __FUNCTION__,
 2447
# 2446 "./call-stub.c"
  , GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_getxattr_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.xattr, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0)
                             ;
  break;
        case GF_FOP_FSETXATTR:
  do { if (stub->fn_cbk.fsetxattr) stub->fn_cbk.fsetxattr (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.xdata); else do { fop_fsetxattr_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack", "./call-stub.c", __FUNCTION__, 2450, GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_fsetxattr_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0);
  break;
        case GF_FOP_FGETXATTR:
  do { if (stub->fn_cbk.fgetxattr) stub->fn_cbk.fgetxattr (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.xattr, stub->args_cbk.xdata); else do { fop_fgetxattr_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack",
 "./call-stub.c"
# 2453 "./call-stub.c"
  , __FUNCTION__,
 2454
# 2453 "./call-stub.c"
  , GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_fgetxattr_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.xattr, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0)
                             ;
  break;
        case GF_FOP_REMOVEXATTR:
  do { if (stub->fn_cbk.removexattr) stub->fn_cbk.removexattr (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.xdata); else do { fop_removexattr_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack", "./call-stub.c", __FUNCTION__, 2457, GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_removexattr_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0);
  break;
        case GF_FOP_FREMOVEXATTR:
  do { if (stub->fn_cbk.fremovexattr) stub->fn_cbk.fremovexattr (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.xdata); else do { fop_fremovexattr_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack", "./call-stub.c", __FUNCTION__, 2460, GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_fremovexattr_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0);
  break;
        case GF_FOP_OPENDIR:
  do { if (stub->fn_cbk.opendir) stub->fn_cbk.opendir (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.fd, stub->args_cbk.xdata); else do { fop_opendir_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack",
 "./call-stub.c"
# 2463 "./call-stub.c"
  , __FUNCTION__,
 2464
# 2463 "./call-stub.c"
  , GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_opendir_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.fd, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0)
                             ;
  break;
        case GF_FOP_FSYNCDIR:
  do { if (stub->fn_cbk.fsyncdir) stub->fn_cbk.fsyncdir (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.xdata); else do { fop_fsyncdir_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack", "./call-stub.c", __FUNCTION__, 2467, GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_fsyncdir_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0);
                break;
        case GF_FOP_ACCESS:
  do { if (stub->fn_cbk.access) stub->fn_cbk.access (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.xdata); else do { fop_access_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack", "./call-stub.c", __FUNCTION__, 2470, GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_access_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0);
                break;
        case GF_FOP_FTRUNCATE:
  do { if (stub->fn_cbk.ftruncate) stub->fn_cbk.ftruncate (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, &stub->args_cbk.prestat, &stub->args_cbk.poststat, stub->args_cbk.xdata); else do { fop_ftruncate_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack",
 "./call-stub.c"
# 2473 "./call-stub.c"
  , __FUNCTION__,
 2474
# 2473 "./call-stub.c"
  , GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_ftruncate_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, &stub->args_cbk.prestat, &stub->args_cbk.poststat, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0)
                                                       ;
                break;
        case GF_FOP_FSTAT:
  do { if (stub->fn_cbk.fstat) stub->fn_cbk.fstat (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, &stub->args_cbk.stat, stub->args_cbk.xdata); else do { fop_fstat_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack",
 "./call-stub.c"
# 2477 "./call-stub.c"
  , __FUNCTION__,
 2478
# 2477 "./call-stub.c"
  , GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_fstat_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, &stub->args_cbk.stat, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0)
                             ;
                break;
        case GF_FOP_LK:
  do { if (stub->fn_cbk.lk) stub->fn_cbk.lk (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, &stub->args_cbk.lock, stub->args_cbk.xdata); else do { fop_lk_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack",
 "./call-stub.c"
# 2481 "./call-stub.c"
  , __FUNCTION__,
 2482
# 2481 "./call-stub.c"
  , GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_lk_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, &stub->args_cbk.lock, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0)
                             ;
  break;
        case GF_FOP_INODELK:
  do { if (stub->fn_cbk.inodelk) stub->fn_cbk.inodelk (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.xdata); else do { fop_inodelk_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack", "./call-stub.c", __FUNCTION__, 2485, GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_inodelk_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0);
                break;
        case GF_FOP_FINODELK:
  do { if (stub->fn_cbk.finodelk) stub->fn_cbk.finodelk (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.xdata); else do { fop_finodelk_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack", "./call-stub.c", __FUNCTION__, 2488, GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_finodelk_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0);
                break;
        case GF_FOP_ENTRYLK:
  do { if (stub->fn_cbk.entrylk) stub->fn_cbk.entrylk (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.xdata); else do { fop_entrylk_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack", "./call-stub.c", __FUNCTION__, 2491, GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_entrylk_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0);
  break;
        case GF_FOP_FENTRYLK:
  do { if (stub->fn_cbk.fentrylk) stub->fn_cbk.fentrylk (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.xdata); else do { fop_fentrylk_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack", "./call-stub.c", __FUNCTION__, 2494, GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_fentrylk_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0);
                break;
        case GF_FOP_LOOKUP:
  do { if (stub->fn_cbk.lookup) stub->fn_cbk.lookup (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.inode, &stub->args_cbk.stat, stub->args_cbk.xdata, &stub->args_cbk.postparent); else do { fop_lookup_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack",
...
# 2497 "./call-stub.c"
 ...
 2499
# 2497 "./call-stub.c"
  , GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_lookup_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.inode, &stub->args_cbk.stat, stub->args_cbk.xdata, &stub->args_cbk.postparent); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0)

                                   ;
                break;
        case GF_FOP_RCHECKSUM:
  do { if (stub->fn_cbk.rchecksum) stub->fn_cbk.rchecksum (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.weak_checksum, stub->args_cbk.strong_checksum, stub->args_cbk.xdata); else do { fop_rchecksum_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack",
 "./call-stub.c"
# 2502 "./call-stub.c"
  , __FUNCTION__,
 2503
# 2502 "./call-stub.c"
  , GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_rchecksum_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.weak_checksum, stub->args_cbk.strong_checksum, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0)
                                                             ;
  break;
        case GF_FOP_READDIR:
  do { if (stub->fn_cbk.readdir) stub->fn_cbk.readdir (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, &stub->args_cbk.entries, stub->args_cbk.xdata); else do { fop_readdir_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack",
 "./call-stub.c"
# 2506 "./call-stub.c"
  , __FUNCTION__,
 2507
# 2506 "./call-stub.c"
  , GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_readdir_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, &stub->args_cbk.entries, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0)
                             ;
  break;
        case GF_FOP_READDIRP:
  do { if (stub->fn_cbk.readdir) stub->fn_cbk.readdir (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, &stub->args_cbk.entries, stub->args_cbk.xdata); else do { fop_readdir_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack",
...
# 2510 "./call-stub.c"
  , GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_readdir_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, &stub->args_cbk.entries, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0)
                ...
                break;
        case GF_FOP_XATTROP:
  do { if (stub->fn_cbk.xattrop) stub->fn_cbk.xattrop (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.xattr, stub->args_cbk.xdata); else do { fop_xattrop_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack",
 "./call-stub.c"
# 2514 "./call-stub.c"
  , __FUNCTION__,
 2515
# 2514 "./call-stub.c"
  , GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_xattrop_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.xattr, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0)
                             ;
  break;
        case GF_FOP_FXATTROP:
  do { if (stub->fn_cbk.fxattrop) stub->fn_cbk.fxattrop (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.xattr, stub->args_cbk.xdata); else do { fop_fxattrop_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack",
 "./call-stub.c"
# 2518 "./call-stub.c"
  , __FUNCTION__,
 2519
# 2518 "./call-stub.c"
  , GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_fxattrop_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.xattr, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0)
                             ;
  break;
        case GF_FOP_SETATTR:
  do { if (stub->fn_cbk.setattr) stub->fn_cbk.setattr (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, &stub->args_cbk.prestat, &stub->args_cbk.poststat, stub->args_cbk.xdata); else do { fop_setattr_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack",
 "./call-stub.c"
# 2522 "./call-stub.c"
  , __FUNCTION__,
 2523
# 2522 "./call-stub.c"
  , GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_setattr_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, &stub->args_cbk.prestat, &stub->args_cbk.poststat, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0)
                                                       ;
                break;
        case GF_FOP_FSETATTR:
  do { if (stub->fn_cbk.fsetattr) stub->fn_cbk.fsetattr (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, &stub->args_cbk.prestat, &stub->args_cbk.poststat, stub->args_cbk.xdata); else do { fop_fsetattr_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack",
 "./call-stub.c"
# 2526 "./call-stub.c"
  , __FUNCTION__,
 2527
# 2526 "./call-stub.c"
  , GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_fsetattr_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, &stub->args_cbk.prestat, &stub->args_cbk.poststat, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0)
                                                       ;
                break;
 case GF_FOP_FALLOCATE:
  do { if (stub->fn_cbk.fallocate) stub->fn_cbk.fallocate (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, &stub->args_cbk.prestat, &stub->args_cbk.poststat, stub->args_cbk.xdata); else do { fop_fallocate_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack",
 "./call-stub.c"
# 2530 "./call-stub.c"
  , __FUNCTION__,
 2531
# 2530 "./call-stub.c"
  , GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_fallocate_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, &stub->args_cbk.prestat, &stub->args_cbk.poststat, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0)
                                                      ;
  break;
 case GF_FOP_DISCARD:
  do { if (stub->fn_cbk.discard) stub->fn_cbk.discard (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, &stub->args_cbk.prestat, &stub->args_cbk.poststat, stub->args_cbk.xdata); else do { fop_discard_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack",
 "./call-stub.c"
# 2534 "./call-stub.c"
  , __FUNCTION__,
 2535
# 2534 "./call-stub.c"
  , GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_discard_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, &stub->args_cbk.prestat, &stub->args_cbk.poststat, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0)
                                                      ;
  break;
        case GF_FOP_ZEROFILL:
                do { if (stub->fn_cbk.zerofill) stub->fn_cbk.zerofill (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, &stub->args_cbk.prestat, &stub->args_cbk.poststat, stub->args_cbk.xdata); else do { fop_zerofill_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack",
 "./call-stub.c"
# 2538 "./call-stub.c"
                , __FUNCTION__,
 2539
# 2538 "./call-stub.c"
                , GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_zerofill_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, &stub->args_cbk.prestat, &stub->args_cbk.poststat, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0)
                                                                           ;
                break;
        case GF_FOP_IPC:
                do { if (stub->fn_cbk.ipc) stub->fn_cbk.ipc (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.xdata); else do { fop_ipc_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack", "./call-stub.c", __FUNCTION__, 2542, GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_ipc_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0);
                break;
        case GF_FOP_SEEK:
                do { if (stub->fn_cbk.seek) stub->fn_cbk.seek (stub->frame, stub->frame->cookie, stub->frame->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.offset, stub->args_cbk.xdata); else do { fop_seek_cbk_t fn = ((void *)0); call_frame_t *_parent = ((void *)0); xlator_t *old_THIS = ((void *)0); if (!stub->frame) { do { _gf_msg ("stack",
 "./call-stub.c"
# 2545 "./call-stub.c"
                , __FUNCTION__,
 2546
# 2545 "./call-stub.c"
                , GF_LOG_CRITICAL, 0, 0, (100000 + 1000 + 103), "!frame"); } while (0); break; } fn = (fop_seek_cbk_t )stub->frame->ret; _parent = stub->frame->parent; pthread_mutex_lock (&stub->frame->root->stack_lock); { _parent->ref_count--; } pthread_mutex_unlock (&stub->frame->root->stack_lock); old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = _parent->this; stub->frame->complete = _gf_true; stub->frame->unwind_from = __FUNCTION__; if (stub->frame->this->ctx->measure_latency) gf_latency_end (stub->frame); fn (_parent, stub->frame->cookie, _parent->this, stub->args_cbk.op_ret, stub->args_cbk.op_errno, stub->args_cbk.offset, stub->args_cbk.xdata); (*__glusterfs_this_location()) = old_THIS; } while (0); } while (0)
                                                  ;
                break;
...
call_stub_wipe_args (call_stub_t *stub)
{
 ...
 __gf_free ((char *)stub->args.linkname);

 __gf_free (stub->args.vector);
 ...
 __gf_free ((char *)stub->args.name);

 __gf_free ((char *)stub->args.volume);
...
{
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 2599, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);
...
{
        xlator_t *old_THIS = ((void *)0);

        (*__errno_location ()) = 22;
        do { if (!stub) { (*__errno_location ()) = 22; do { _gf_msg ("call-stub", "./call-stub.c", __FUNCTION__, 2620, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "stub"); } while (0); goto out; } } while (0);

        list_del_init (&stub->list);

        old_THIS = (*__glusterfs_this_location());
        (*__glusterfs_this_location()) = stub->frame->this;
        {
                if (stub->wind)
        ...
        (*__glusterfs_this_location()) = old_THIS;
