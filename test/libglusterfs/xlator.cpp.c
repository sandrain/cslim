...
# 33 "./xlator.c"
 ...
 34
# 33 "./xlator.c"
                , GF_LOG_WARNING, 22, 1, (100000 + 1000 + 172), "invalid argument"); } while (0)
                                                                         ;
                return;
        }

        do { if (!xl->fops->create) xl->fops->create = default_create; } while (0);
        do { if (!xl->fops->open) xl->fops->open = default_open; } while (0);
        do { if (!xl->fops->stat) xl->fops->stat = default_stat; } while (0);
        do { if (!xl->fops->readlink) xl->fops->readlink = default_readlink; } while (0);
        do { if (!xl->fops->mknod) xl->fops->mknod = default_mknod; } while (0);
        do { if (!xl->fops->mkdir) xl->fops->mkdir = default_mkdir; } while (0);
        do { if (!xl->fops->unlink) xl->fops->unlink = default_unlink; } while (0);
        do { if (!xl->fops->rmdir) xl->fops->rmdir = default_rmdir; } while (0);
        do { if (!xl->fops->symlink) xl->fops->symlink = default_symlink; } while (0);
        do { if (!xl->fops->rename) xl->fops->rename = default_rename; } while (0);
        do { if (!xl->fops->link) xl->fops->link = default_link; } while (0);
        do { if (!xl->fops->truncate) xl->fops->truncate = default_truncate; } while (0);
        do { if (!xl->fops->readv) xl->fops->readv = default_readv; } while (0);
        do { if (!xl->fops->writev) xl->fops->writev = default_writev; } while (0);
        do { if (!xl->fops->statfs) xl->fops->statfs = default_statfs; } while (0);
        do { if (!xl->fops->flush) xl->fops->flush = default_flush; } while (0);
        do { if (!xl->fops->fsync) xl->fops->fsync = default_fsync; } while (0);
        do { if (!xl->fops->setxattr) xl->fops->setxattr = default_setxattr; } while (0);
        do { if (!xl->fops->getxattr) xl->fops->getxattr = default_getxattr; } while (0);
        do { if (!xl->fops->fsetxattr) xl->fops->fsetxattr = default_fsetxattr; } while (0);
        do { if (!xl->fops->fgetxattr) xl->fops->fgetxattr = default_fgetxattr; } while (0);
        do { if (!xl->fops->removexattr) xl->fops->removexattr = default_removexattr; } while (0);
        do { if (!xl->fops->fremovexattr) xl->fops->fremovexattr = default_fremovexattr; } while (0);
        do { if (!xl->fops->opendir) xl->fops->opendir = default_opendir; } while (0);
        do { if (!xl->fops->readdir) xl->fops->readdir = default_readdir; } while (0);
        do { if (!xl->fops->readdirp) xl->fops->readdirp = default_readdirp; } while (0);
        do { if (!xl->fops->fsyncdir) xl->fops->fsyncdir = default_fsyncdir; } while (0);
        do { if (!xl->fops->access) xl->fops->access = default_access; } while (0);
        do { if (!xl->fops->ftruncate) xl->fops->ftruncate = default_ftruncate; } while (0);
        do { if (!xl->fops->fstat) xl->fops->fstat = default_fstat; } while (0);
        do { if (!xl->fops->lk) xl->fops->lk = default_lk; } while (0);
        do { if (!xl->fops->inodelk) xl->fops->inodelk = default_inodelk; } while (0);
        do { if (!xl->fops->finodelk) xl->fops->finodelk = default_finodelk; } while (0);
        do { if (!xl->fops->entrylk) xl->fops->entrylk = default_entrylk; } while (0);
        do { if (!xl->fops->fentrylk) xl->fops->fentrylk = default_fentrylk; } while (0);
        do { if (!xl->fops->lookup) xl->fops->lookup = default_lookup; } while (0);
        do { if (!xl->fops->rchecksum) xl->fops->rchecksum = default_rchecksum; } while (0);
        do { if (!xl->fops->xattrop) xl->fops->xattrop = default_xattrop; } while (0);
        do { if (!xl->fops->fxattrop) xl->fops->fxattrop = default_fxattrop; } while (0);
        do { if (!xl->fops->setattr) xl->fops->setattr = default_setattr; } while (0);
        do { if (!xl->fops->fsetattr) xl->fops->fsetattr = default_fsetattr; } while (0);
 do { if (!xl->fops->fallocate) xl->fops->fallocate = default_fallocate; } while (0);
 do { if (!xl->fops->discard) xl->fops->discard = default_discard; } while (0);
        do { if (!xl->fops->zerofill) xl->fops->zerofill = default_zerofill; } while (0);
        do { if (!xl->fops->ipc) xl->fops->ipc = default_ipc; } while (0);
        do { if (!xl->fops->seek) xl->fops->seek = default_seek; } while (0);

        do { if (!xl->fops->getspec) xl->fops->getspec = default_getspec; } while (0);

        do { if (!xl->cbks->release) xl->cbks->release = default_release; } while (0);
        do { if (!xl->cbks->releasedir) xl->cbks->releasedir = default_releasedir; } while (0);
        do { if (!xl->cbks->forget) xl->cbks->forget = default_forget; } while (0);
...
{
        do { if (!xl) { (*__errno_location ()) = 22; do { _gf_msg ("xlator", "./xlator.c", __FUNCTION__, 104, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "xl"); } while (0); goto out; } } while (0);
        do { if (!type) { (*__errno_location ()) = 22; do { _gf_msg ("xlator", "./xlator.c", __FUNCTION__, 105, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "type"); } while (0); goto out; } } while (0);
                       ...
                       volume_opt_list_t *opt_list)
{
        ...
        do { if (!xlator_type) { (*__errno_location ()) = 22; do { _gf_msg ("xlator", "./xlator.c", __FUNCTION__, 125, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "xlator_type"); } while (0); goto out; } } while (0);
        ...
        do { _gf_msg ("xlator", "./xlator.c", __FUNCTION__, 139, GF_LOG_TRACE, 0, 0, 0, "attempt to load file %s", name); } while (0);

        handle = dlopen (name, 0x00002|0x00100);
        if (!handle) {
                do { _gf_msg ("xlator",
 "./xlator.c"
# 143 "./xlator.c"
 ...
 144
# 143 "./xlator.c"
                , GF_LOG_WARNING, 0, 0, (100000 + 1000 + 95), "%s", dlerror ()); } while (0)
                                         ;
                goto out;
        }
...
# 150 "./xlator.c"
 ...
 151
# 150 "./xlator.c"
                , GF_LOG_ERROR, 0, 0, (100000 + 1000 + 96), "Failed to load xlator opt table"); } while (0)
                                                          ;
                goto out;
        }
 ...
 out:
        ...
        do { _gf_msg ("xlator", "./xlator.c", __FUNCTION__, 164, GF_LOG_DEBUG, 0, 0, 0, "Returning %d", ret); } while (0);
        return ret;
...
xlator_dynload (xlator_t *xl)
{
        ...
        class_methods_t *vtbl = ((void *)0);

        do { if (!xl) { (*__errno_location ()) = 22; do { _gf_msg ("xlator", "./xlator.c", __FUNCTION__, 179, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "xl"); } while (0); goto out; } } while (0);

        do { (&xl->volume_options)->next = (&xl->volume_options)->prev = &xl->volume_options; } while (0);
        ...
        do { _gf_msg ("xlator", "./xlator.c", __FUNCTION__, 190, GF_LOG_TRACE, 0, 0, 0, "attempt to load file %s", name); } while (0);
...
# 201 "./xlator.c"
 ...
 202
# 201 "./xlator.c"
                , GF_LOG_WARNING, 0, 0, (100000 + 1000 + 97), "dlsym(fops) on %s", dlerror ()); } while (0)
                                                        ;
                goto out;
        }
...
# 207 "./xlator.c"
 ...
 208
# 207 "./xlator.c"
                , GF_LOG_WARNING, 0, 0, (100000 + 1000 + 97), "dlsym(cbks) on %s", dlerror ()); } while (0)
                                                        ;
                goto out;
        }
        ...
        if (vtbl) {
                ...
                if (!(*((void **) ((void *) &xl->init)) = dlsym (handle, "init"))) {
                        do { _gf_msg ("xlator",
...
# 226 "./xlator.c"
 ...
 228
# 226 "./xlator.c"
                        , GF_LOG_WARNING, 0, 0, (100000 + 1000 + 97), "dlsym(init) on %s", dlerror ()); } while (0)

                                           ;
                        goto out;
                }

                if (!(*((void **) ((void *) &(xl->fini))) = dlsym (handle, "fini"))) {
                        do { _gf_msg ("xlator",
...
# 233 "./xlator.c"
 ...
 235
# 233 "./xlator.c"
                        , GF_LOG_WARNING, 0, 0, (100000 + 1000 + 97), "dlsym(fini) on %s", dlerror ()); } while (0)

                                           ;
                        goto out;
                }
                if (!(*((void **) ((void *) &(xl->reconfigure))) = dlsym (handle,
                                                         "reconfigure"))) {
                        do { _gf_msg ("xlator",
 "./xlator.c"
# 240 "./xlator.c"
 ...
 241
# 240 "./xlator.c"
                        , GF_LOG_TRACE, 0, 0, 0, "dlsym(reconfigure) on %s " "-- neglecting", dlerror()); } while (0)
                                                                 ;
                }
                if (!(*((void **) ((void *) &(xl->notify))) = dlsym (handle, "notify"))) {
                        do { _gf_msg ("xlator",
 "./xlator.c"
# 244 "./xlator.c"
                        , __FUNCTION__,
 245
# 244 "./xlator.c"
                        , GF_LOG_TRACE, 0, 0, 0, "dlsym(notify) on %s -- " "neglecting", dlerror ()); } while (0)
                                                               ;
                }
...
# 251 "./xlator.c"
 ...
 252
# 251 "./xlator.c"
                , GF_LOG_TRACE, 0, 0, 0, "dlsym(dumpops) on %s -- " "neglecting", dlerror ()); } while (0)
                                                       ;
        }

        if (!(*((void **) ((void *) &(xl->mem_acct_init))) = dlsym (handle, "mem_acct_init"))) {
                do { _gf_msg (xl->name,
 "./xlator.c"
# 256 "./xlator.c"
                , __FUNCTION__,
 257
# 256 "./xlator.c"
                , GF_LOG_TRACE, 0, 0, 0, "dlsym(mem_acct_init) on %s -- " "neglecting", dlerror ()); } while (0)
                                                       ;
        }

        vol_opt = __gf_calloc (1, sizeof (volume_opt_list_t), gf_common_mt_volume_opt_list_t, "gf_common_mt_volume_opt_list_t")
                                                        ;
...
# 269 "./xlator.c"
 ...
 270
# 269 "./xlator.c"
                , GF_LOG_TRACE, 0, 0, 0, "Strict option validation not " "enforced -- neglecting"); } while (0)
                                                       ;
        }
        do { (&vol_opt->list)->next = (&vol_opt->list)->prev = &vol_opt->list; } while (0);
...
# 304 "./xlator.c"
 ...
 307
# 304 "./xlator.c"
                        , GF_LOG_WARNING, 0, 0, (100000 + 1000 + 2), "input data is NULL. " "Cannot update the lru limit of the inode" " table. Continuing with older value"); } while (0)
...
xlator_foreach (xlator_t *this,
                ...
                void *data)
{
        xlator_t *first = ((void *)0);
        xlator_t *old_THIS = ((void *)0);

        do { if (!this) { (*__errno_location ()) = 22; do { _gf_msg ("xlator", "./xlator.c", __FUNCTION__, 327, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "this"); } while (0); goto out; } } while (0);
        do { if (!fn) { (*__errno_location ()) = 22; do { _gf_msg ("xlator", "./xlator.c", __FUNCTION__, 328, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "fn"); } while (0); goto out; } } while (0);
        ...
        while (first) {
                ...
                (*__glusterfs_this_location()) = first;
...
{
        xlator_t *search = ((void *)0);

        do { if (!any) { (*__errno_location ()) = 22; do { _gf_msg ("xlator", "./xlator.c", __FUNCTION__, 373, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "any"); } while (0); goto out; } } while (0);
        do { if (!name) { (*__errno_location ()) = 22; do { _gf_msg ("xlator", "./xlator.c", __FUNCTION__, 374, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "name"); } while (0); goto out; } } while (0);
...
xlator_init (xlator_t *xl)
{
        ...
        do { if (!xl) { (*__errno_location ()) = 22; do { _gf_msg ("xlator", "./xlator.c", __FUNCTION__, 413, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "xl"); } while (0); goto out; } } while (0);

        if (xl->mem_acct_init)
                xl->mem_acct_init (xl);

        xl->instance_name = ((void *)0);
        if (!xl->init) {
                do { _gf_msg (xl->name,
 "./xlator.c"
# 420 "./xlator.c"
 ...
 421
# 420 "./xlator.c"
                , GF_LOG_WARNING, 0, 0, (100000 + 1000 + 89), "No init() found"); } while (0)
                                          ;
                goto out;
        }
...
# 428 "./xlator.c"
 ...
 430
# 428 "./xlator.c"
                , GF_LOG_ERROR, 0, 0, (100000 + 1000 + 19), "Initialization of volume '%s' failed," " review your volfile again", xl->name); } while (0)
...
xlator_fini_rec (xlator_t *xl)
{
        ...
        do { if (!xl) { (*__errno_location ()) = 22; do { _gf_msg ("xlator", "./xlator.c", __FUNCTION__, 448, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "xl"); } while (0); goto out; } } while (0);
        ...
        while (trav) {
                ...
                do { _gf_msg (trav->xlator->name, "./xlator.c", __FUNCTION__, 458, GF_LOG_DEBUG, 0, 0, 0, "fini done"); } while (0);
                trav = trav->next;
        }
        ...
        if (xl->init_succeeded) {
                if (xl->fini) {
                        ...
                        do { _gf_msg (xl->name, "./xlator.c", __FUNCTION__, 474, GF_LOG_DEBUG, 0, 0, 0, "No fini() found"); } while (0);
                }
                xl->init_succeeded = 0;
        }
...
xlator_mem_acct_init (xlator_t *xl, int num_types)
{
        ...
        xl->mem_acct = __gf_default_malloc(sizeof(struct mem_acct) + sizeof(struct mem_acct_rec) * num_types)
                                                                         ;
        ...
        pthread_mutex_init (&xl->mem_acct->lock, 0);
        ...
        for (i = 0; i < num_types; i++) {
                ...
                if (ret) {
                        fprintf(stderr, "Unable to lock..errno : %d",(*__errno_location ()));
                }
        }
...
xlator_tree_fini (xlator_t *xl)
{
        ...
        do { if (!xl) { (*__errno_location ()) = 22; do { _gf_msg ("xlator", "./xlator.c", __FUNCTION__, 546, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "xl"); } while (0); goto out; } } while (0);
...
{
        uint32_t i = 0;
        struct mem_acct *mem_acct = ((void *)0);
        ...
        if (mem_acct) {
                for (i = 0; i < mem_acct->num_types; i++) {
                        pthread_mutex_destroy (&(mem_acct->rec[i].lock));
                }
                if (__sync_sub_and_fetch(&mem_acct->refcnt, 1) == 0) {
                        do { if (mem_acct != ((void *)0)) { free ((void *)mem_acct); mem_acct = (void *)0xeeeeeeee; } } while (0);
                        xl->mem_acct = ((void *)0);
                }
        }
...
xlator_members_free (xlator_t *xl)
{
        ...
        for (vol_opt = ((typeof(*vol_opt) *)((char *)((&xl->volume_options)->next)-(unsigned long)(&((typeof(*vol_opt) *)0)->list))), tmp = ((typeof(*vol_opt) *)((char *)(vol_opt->list.next)-(unsigned long)(&((typeof(*vol_opt) *)0)->list))); &vol_opt->list != (&xl->volume_options); vol_opt = tmp, tmp = ((typeof(*tmp) *)((char *)(tmp->list.next)-(unsigned long)(&((typeof(*tmp) *)0)->list)))) {
...
# 653 "./xlator.c"
 ...
 654
# 653 "./xlator.c"
                , GF_LOG_ERROR, 0, 0, (100000 + 1000 + 98), "Translator tree not found"); } while (0)
                                                    ;
                return -1;
        }
...
inode_path:
        if (loc->inode && !gf_uuid_is_null (loc->inode->gfid)) {
                ret = inode_path (loc->inode, ((void *)0), (char **)&loc->path);
...
loc_copy_overload_parent (loc_t *dst, loc_t *src, inode_t *parent)
{
        ...
        do { if (!dst) { (*__errno_location ()) = 22; do { _gf_msg ("xlator", "./xlator.c", __FUNCTION__, 808, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "dst"); } while (0); goto err; } } while (0);
        do { if (!src) { (*__errno_location ()) = 22; do { _gf_msg ("xlator", "./xlator.c", __FUNCTION__, 809, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "src"); } while (0); goto err; } } while (0);
        do { if (!parent) { (*__errno_location ()) = 22; do { _gf_msg ("xlator", "./xlator.c", __FUNCTION__, 810, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "parent"); } while (0); goto err; } } while (0);
...
loc_copy (loc_t *dst, loc_t *src)
{
        ...
        do { if (!dst) { (*__errno_location ()) = 22; do { _gf_msg ("xlator", "./xlator.c", __FUNCTION__, 849, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "dst"); } while (0); goto err; } } while (0);
        do { if (!src) { (*__errno_location ()) = 22; do { _gf_msg ("xlator", "./xlator.c", __FUNCTION__, 850, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "src"); } while (0); goto err; } } while (0);
...
loc_build_child (loc_t *child, loc_t *parent, char *name)
{
        ...
        do { if (!child) { (*__errno_location ()) = 22; do { _gf_msg ("xlator", "./xlator.c", __FUNCTION__, 901, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "child"); } while (0); goto out; } } while (0);
        do { if (!parent) { (*__errno_location ()) = 22; do { _gf_msg ("xlator", "./xlator.c", __FUNCTION__, 902, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "parent"); } while (0); goto out; } } while (0);
        do { if (!name) { (*__errno_location ()) = 22; do { _gf_msg ("xlator", "./xlator.c", __FUNCTION__, 903, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "name"); } while (0); goto out; } } while (0);
...
is_gf_log_command (xlator_t *this, const char *name, char *value)
{
        ...
        if (fnmatch ("trusted.glusterfs*set-log-level", name, (1 << 1)))
                goto out;
...
# 986 "./xlator.c"
 ...
 989
# 986 "./xlator.c"
                , gf_log_get_loglevel(), 0, 0, (100000 + 1000 + 202), "setting log level to %d (old-value=%d)", log_level, gf_log_get_loglevel()); } while (0)
...
# 997 "./xlator.c"
 ...
 1000
# 997 "./xlator.c"
                , gf_log_get_xl_loglevel (this), 0, 0, (100000 + 1000 + 202), "setting log level to %d (old-value=%d)", log_level, gf_log_get_xl_loglevel (this)); } while (0)
        ...
        while (trav) {
                snprintf (key, 1024, "trusted.glusterfs.%s.set-log-level",
                          trav->name);
                if (fnmatch (name, key, (1 << 1)) == 0) {
                        do { _gf_msg (trav->name,
...
# 1017 "./xlator.c"
 ...
 1020
# 1017 "./xlator.c"
                        , gf_log_get_xl_loglevel (trav), 0, 0, (100000 + 1000 + 202), "setting log level to %d (old-value=%d)", log_level, gf_log_get_xl_loglevel (trav)); } while (0)
...
# 1053 "./xlator.c"
 ...
 1055
# 1053 "./xlator.c"
                , GF_LOG_ERROR, 0, 0, (100000 + 1000 + 89), "Invalid log-level. possible values are " "DEBUG|WARNING|ERROR|CRITICAL|NONE|TRACE"); } while (0)
