...
cluster_lookup_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                    ...
                    struct iatt *buf, dict_t *xdata, struct iatt *postparent)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_lookup_cbk_store (&__local->replies[__i], op_ret, op_errno, inode, buf, xdata, postparent); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0)
                                   ;
        return 0;
}
...
cluster_stat_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                  ...
                  dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_stat_cbk_store (&__local->replies[__i], op_ret, op_errno, buf, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0);
        return 0;
}
...
cluster_truncate_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                      ...
                      dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_truncate_cbk_store (&__local->replies[__i], op_ret, op_errno, prebuf, postbuf, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0)
                                ;
        return 0;
}
...
cluster_ftruncate_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                       ...
                       dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_ftruncate_cbk_store (&__local->replies[__i], op_ret, op_errno, prebuf, postbuf, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0)
                                ;
        return 0;
}
...
cluster_access_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                    ...
                    dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_access_cbk_store (&__local->replies[__i], op_ret, op_errno, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0);
        return 0;
}
...
cluster_readlink_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                      ...
                      struct iatt *buf, dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_readlink_cbk_store (&__local->replies[__i], op_ret, op_errno, path, buf, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0)
                       ;
        return 0;
}
...
cluster_mknod_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                   ...
                   struct iatt *postparent, dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_mknod_cbk_store (&__local->replies[__i], op_ret, op_errno, inode, buf, preparent, postparent, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0)
                                                   ;
        return 0;
}
...
cluster_mkdir_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                   ...
                   struct iatt *postparent, dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_mkdir_cbk_store (&__local->replies[__i], op_ret, op_errno, inode, buf, preparent, postparent, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0)
                                                   ;
        return 0;
}
...
cluster_unlink_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                    ...
                    struct iatt *postparent, dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_unlink_cbk_store (&__local->replies[__i], op_ret, op_errno, preparent, postparent, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0)
                                   ;
        return 0;
}
...
cluster_rmdir_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                   ...
                   dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_rmdir_cbk_store (&__local->replies[__i], op_ret, op_errno, preparent, postparent, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0)
                                   ;
        return 0;
}
...
cluster_symlink_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                     ...
                     struct iatt *postparent, dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_symlink_cbk_store (&__local->replies[__i], op_ret, op_errno, inode, buf, preparent, postparent, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0)
                                              ;
        return 0;
}
...
cluster_rename_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                    ...
                    dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_rename_cbk_store (&__local->replies[__i], op_ret, op_errno, buf, preoldparent, postoldparent, prenewparent, postnewparent, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0)
                                                                   ;
        return 0;
}
...
cluster_link_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                  ...
                  dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_link_cbk_store (&__local->replies[__i], op_ret, op_errno, inode, buf, preparent, postparent, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0)
                                              ;
        return 0;
}
...
cluster_create_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                    ...
                    dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_create_cbk_store (&__local->replies[__i], op_ret, op_errno, fd, inode, buf, preparent, postparent, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0)
                                              ;
        return 0;
}
...
cluster_open_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                  ...
                  dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_open_cbk_store (&__local->replies[__i], op_ret, op_errno, fd, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0);
        return 0;
}
...
cluster_readv_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                   ...
                   dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_readv_cbk_store (&__local->replies[__i], op_ret, op_errno, vector, count, stbuf, iobref, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0)
                                      ;
        return 0;
}
...
cluster_writev_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                    ...
                    dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_writev_cbk_store (&__local->replies[__i], op_ret, op_errno, prebuf, postbuf, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0)
                       ;
        return 0;
}
...
cluster_flush_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                   ...
                   dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_flush_cbk_store (&__local->replies[__i], op_ret, op_errno, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0);
        return 0;
}
...
cluster_fsync_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                   ...
                   dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_fsync_cbk_store (&__local->replies[__i], op_ret, op_errno, prebuf, postbuf, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0)
                       ;
        return 0;
}
...
cluster_fstat_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                   ...
                   dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_fstat_cbk_store (&__local->replies[__i], op_ret, op_errno, buf, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0);
        return 0;
}
...
cluster_opendir_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                     ...
                     dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_opendir_cbk_store (&__local->replies[__i], op_ret, op_errno, fd, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0);
        return 0;
}
...
cluster_fsyncdir_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                      ...
                      dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_fsyncdir_cbk_store (&__local->replies[__i], op_ret, op_errno, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0);
        return 0;
}
...
cluster_statfs_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                    ...
                    dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_statfs_cbk_store (&__local->replies[__i], op_ret, op_errno, buf, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0);
        return 0;
}
...
cluster_setxattr_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                      ...
                      dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_setxattr_cbk_store (&__local->replies[__i], op_ret, op_errno, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0);
        return 0;
}
...
cluster_fsetxattr_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                       ...
                       dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_fsetxattr_cbk_store (&__local->replies[__i], op_ret, op_errno, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0);
        return 0;
}
...
cluster_fgetxattr_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                       ...
                       dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_fgetxattr_cbk_store (&__local->replies[__i], op_ret, op_errno, dict, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0);
        return 0;
}
...
cluster_getxattr_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                      ...
                      dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_getxattr_cbk_store (&__local->replies[__i], op_ret, op_errno, dict, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0);
        return 0;
}
...
cluster_xattrop_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                     ...
                     dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_xattrop_cbk_store (&__local->replies[__i], op_ret, op_errno, dict, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0);
        return 0;
}
...
cluster_fxattrop_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                      ...
                      dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_fxattrop_cbk_store (&__local->replies[__i], op_ret, op_errno, dict, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0);
        return 0;
}
...
cluster_removexattr_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                         ...
                         dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_removexattr_cbk_store (&__local->replies[__i], op_ret, op_errno, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0);
        return 0;
}
...
cluster_fremovexattr_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                          ...
                          dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_fremovexattr_cbk_store (&__local->replies[__i], op_ret, op_errno, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0);
        return 0;
}
...
cluster_lk_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                ...
                dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_lk_cbk_store (&__local->replies[__i], op_ret, op_errno, lock, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0);
        return 0;
}
...
cluster_inodelk_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                     ...
                     dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_inodelk_cbk_store (&__local->replies[__i], op_ret, op_errno, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0);
        return 0;
}
...
cluster_finodelk_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                      ...
                      dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_finodelk_cbk_store (&__local->replies[__i], op_ret, op_errno, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0);
        return 0;
}
...
cluster_entrylk_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                     ...
                     dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_entrylk_cbk_store (&__local->replies[__i], op_ret, op_errno, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0);
        return 0;
}
...
cluster_fentrylk_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                      ...
                      dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_fentrylk_cbk_store (&__local->replies[__i], op_ret, op_errno, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0);
        return 0;
}
...
cluster_rchecksum_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                       ...
                       dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_rchecksum_cbk_store (&__local->replies[__i], op_ret, op_errno, weak_checksum, strong_checksum, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0)
                                                    ;
        return 0;
}
...
cluster_readdir_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                     ...
                     dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_readdir_cbk_store (&__local->replies[__i], op_ret, op_errno, entries, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0);
        return 0;
}
...
cluster_readdirp_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                      ...
                      dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_readdirp_cbk_store (&__local->replies[__i], op_ret, op_errno, entries, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0);
        return 0;
}
...
cluster_setattr_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                     ...
                     dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_setattr_cbk_store (&__local->replies[__i], op_ret, op_errno, statpre, statpost, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0)
                                 ;
        return 0;
}
...
cluster_fsetattr_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                      ...
                      dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_fsetattr_cbk_store (&__local->replies[__i], op_ret, op_errno, statpre, statpost, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0)
                                 ;
        return 0;
}
...
cluster_fallocate_cbk(call_frame_t *frame, void *cookie, xlator_t *this,
                      ...
                      struct iatt *post, dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_fallocate_cbk_store (&__local->replies[__i], op_ret, op_errno, pre, post, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0);
        return 0;
}
...
cluster_discard_cbk(call_frame_t *frame, void *cookie, xlator_t *this,
                    ...
                    struct iatt *post, dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_discard_cbk_store (&__local->replies[__i], op_ret, op_errno, pre, post, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0);
        return 0;
}
...
cluster_zerofill_cbk(call_frame_t *frame, void *cookie, xlator_t *this,
                    ...
                    struct iatt *post, dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_zerofill_cbk_store (&__local->replies[__i], op_ret, op_errno, pre, post, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0)
                             ;
        return 0;
}
...
cluster_ipc_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
                 int32_t op_ret, int32_t op_errno, dict_t *xdata)
{
        do { cluster_local_t *__local = frame->local; int __i = (long)cookie; args_ipc_cbk_store (&__local->replies[__i], op_ret, op_errno, xdata); __local->replies[__i].valid = 1; syncbarrier_wake (&__local->barrier); } while (0);
        return 0;
}
                 ...
                 inode_t *inode, off_t off, size_t size)
{
        ...
        output = __builtin_alloca (numsubvols);
        loc.inode = inode_ref (inode);
        gf_uuid_copy (loc.gfid, inode->gfid);
        do { int __i = 0; int __count = 0; cluster_local_t __local = {0,}; void *__old_local = frame->local; __local.replies = replies; memset (locked_on, 0, numsubvols); cluster_replies_wipe (replies, numsubvols); for (__i = 0; __i < numsubvols; __i++) do { (&replies[__i].entries.list)->next = (&replies[__i].entries.list)->prev = &replies[__i].entries.list; } while (0); if (syncbarrier_init (&__local.barrier)) break; frame->local = &__local; for (__i = 0; __i < numsubvols; __i++) { if (!on[__i]) continue; do { call_frame_t *_new = ((void *)0); xlator_t *old_THIS = ((void *)0); _new = mem_get0 (frame->root->pool->frame_mem_pool); if (!_new) { break; } typeof(subvols[__i]->fops->inodelk_cbk) tmp_cbk = cluster_inodelk_cbk; _new->root = frame->root; _new->this = subvols[__i]; _new->ret = (ret_fn_t) tmp_cbk; _new->parent = frame; _new->cookie = (void *)(long) __i; _new->wind_from = __FUNCTION__; _new->wind_to = "subvols[__i]->fops->inodelk"; _new->unwind_to = "cluster_inodelk_cbk"; pthread_mutex_init (&_new->lock, 0); pthread_mutex_lock (&frame->root->stack_lock); { list_add (&_new->frames, &frame->root->myframes); frame->ref_count++; } pthread_mutex_unlock (&frame->root->stack_lock); subvols[__i]->fops->inodelk_cbk = cluster_inodelk_cbk; old_THIS = (*__glusterfs_this_location()); (*__glusterfs_this_location()) = subvols[__i]; if (subvols[__i]->ctx->measure_latency) gf_latency_begin (_new, subvols[__i]->fops->inodelk); subvols[__i]->fops->inodelk (_new, subvols[__i], dom, &loc, 6, &flock, ((void *)0)); (*__glusterfs_this_location()) = old_THIS; } while (0); __count++; } syncbarrier_wait (&__local.barrier, __count); syncbarrier_destroy (&__local.barrier); frame->local = __old_local; STACK_RESET (frame->root); } while (0)
                                                              ;
        ...
        for (i = 0; i < numsubvols; i++) {
                if (replies[i].op_ret == -1 && replies[i].op_errno == 11) {
