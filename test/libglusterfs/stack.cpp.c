...
create_frame (xlator_t *xl, call_pool_t *pool)
{
        ...
        do { (&stack->myframes)->next = (&stack->myframes)->prev = &stack->myframes; } while (0);
        ...
        do { (&frame->frames)->next = (&frame->frames)->prev = &frame->frames; } while (0);
        ...
        if (stack->ctx->measure_latency) {
                if (gettimeofday (&stack->tv, ((void *)0)) == -1)
                        do { _gf_msg ("stack",
...
# 48 "./stack.c"
        ...
        pthread_mutex_init (&stack->stack_lock, 0);
...
gf_proc_dump_call_frame (call_frame_t *call_frame, const char *key_buf,...)
{
        ...
        do { if (!(key_buf)) { do { _gf_msg ("", "./stack.c", __FUNCTION__, 80, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "key_buf"); } while (0); } } while (0);
        ...
        ret = pthread_mutex_trylock (&call_frame->lock);
        if (ret)
                goto out;
...
gf_proc_dump_call_stack (call_stack_t *call_stack, const char *key_buf,...)
{
        ...
        do { if (!(key_buf)) { do { _gf_msg ("", "./stack.c", __FUNCTION__, 145, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "key_buf"); } while (0); } } while (0);
        ...
        for (trav = ((typeof(*trav) *)((char *)((&call_stack->myframes)->next)-(unsigned long)(&((typeof(*trav) *)0)->frames))); &trav->frames != (&call_stack->myframes); trav = ((typeof(*trav) *)((char *)(trav->frames.next)-(unsigned long)(&((typeof(*trav) *)0)->frames)))) {
...
gf_proc_dump_pending_frames (call_pool_t *call_pool)
{
        ...
        ret = pthread_mutex_trylock (&(call_pool->lock));
        if (ret)
                goto out;
        ...
        for (trav = ((typeof(*trav) *)((char *)((&call_pool->all_frames)->next)-(unsigned long)(&((typeof(*trav) *)0)->all_frames))); &trav->all_frames != (&call_pool->all_frames); trav = ((typeof(*trav) *)((char *)(trav->all_frames.next)-(unsigned long)(&((typeof(*trav) *)0)->all_frames)))) {
                gf_proc_dump_add_section("global.callpool.stack.%d",i);
                gf_proc_dump_call_stack(trav, "global.callpool.stack.%d", i);
                i++;
        }
        pthread_mutex_unlock (&(call_pool->lock));
...
# 393 "./stack.c"
 ...
 395
# 393 "./stack.c"
                , GF_LOG_WARNING, (*__errno_location ()), 0, (100000 + 1000 + 201), "Unable to dump call " "pool to dict."); } while (0)
...
__is_fuse_call (call_frame_t *frame)
{
        ...
        do { if (!(frame)) { do { _gf_msg ("", "./stack.c", __FUNCTION__, 420, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "frame"); } while (0); } } while (0);
        do { if (!(frame->root)) { do { _gf_msg ("", "./stack.c", __FUNCTION__, 421, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "frame->root"); } while (0); } } while (0);
