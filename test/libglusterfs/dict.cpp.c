...
__swap32 (uint32_t x)
{
 return (((((x&0x0000ffffU&0x00ffU) << 8)|(((x&0x0000ffffU&0xff00U) >> 8))) << 16)|(((((x&0xffff0000U) >> 16&0x00ffU) << 8)|((((x&0xffff0000U) >> 16&0xff00U) >> 8)))));
}
...
__swap64 (uint64_t x)
{
 return (((((((x&0x00000000ffffffffULL&0x0000ffffU&0x00ffU) << 8)|(((x&0x00000000ffffffffULL&0x0000ffffU&0xff00U) >> 8))) << 16)|(((((x&0x00000000ffffffffULL&0xffff0000U) >> 16&0x00ffU) << 8)|((((x&0x00000000ffffffffULL&0xffff0000U) >> 16&0xff00U) >> 8))))) << 32)|(((((((x&0xffffffff00000000ULL) >> 32&0x0000ffffU&0x00ffU) << 8)|((((x&0xffffffff00000000ULL) >> 32&0x0000ffffU&0xff00U) >> 8))) << 16)|((((((x&0xffffffff00000000ULL) >> 32&0xffff0000U) >> 16&0x00ffU) << 8)|(((((x&0xffffffff00000000ULL) >> 32&0xffff0000U) >> 16&0xff00U) >> 8)))))));
}
...
__byte_order_be16 (uint16_t i)
{
 ...
 return (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (i); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }));
}
...
get_new_data ()
{
        ...
        data = mem_get0 ((*__glusterfs_this_location())->ctx->dict_data_pool);
        if (!data) {
                return ((void *)0);
        }
...
{
        dict_t *dict = mem_get0 ((*__glusterfs_this_location())->ctx->dict_pool);
...
# 78 "./dict.c"
                do { if (!(size_hint <= (sizeof(data_pair_t) / sizeof(data_pair_t *)))) { do { _gf_msg ("",
 "./dict.c"
# 78 "./dict.c"
                , __FUNCTION__,
 79
# 78 "./dict.c"
                , GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "size_hint <= (sizeof(data_pair_t) / sizeof(data_pair_t *))"); } while (0); } } while (0)
                                                                         ;
                dict->members = mem_get0 ((*__glusterfs_this_location())->ctx->dict_pair_pool);
                if (!dict->members) {
                        mem_put (dict);
                        return ((void *)0);
                }
        ...
        pthread_mutex_init (&dict->lock, 0);
...
# 116 "./dict.c"
 ...
 119
# 116 "./dict.c"
  , GF_LOG_ERROR, 22, 1, (100000 + 1000 + 172), "input arguments are provided " "with value data_t as NULL"); } while (0)
...
# 157 "./dict.c"
 ...
 158
# 157 "./dict.c"
                , GF_LOG_DEBUG, 0, 0, 0, "'%s' found only on one dict", key1); } while (0)
                                   ;
        } else {
                do { _gf_msg ((*__glusterfs_this_location())->name,
 "./dict.c"
# 160 "./dict.c"
 ...
 161
# 160 "./dict.c"
                , GF_LOG_DEBUG, 0, 0, 0, "'%s' is different in two dicts " "(%u, %u)", key1, value1->len, value2->len); } while (0)
                                                                         ;
        }
                 ...
                 gf_boolean_t (*value_ignore) (char *k))
{
        ...
        if (!two) {
                num_matches1 = dict_foreach_match (one, match, ((void *)0),
                                                   dict_null_foreach_fn, ((void *)0));
                goto done;
        } else {
                num_matches1 = dict_foreach_match (one, match, ((void *)0),
                                                   key_value_cmp, &cmp);
        ...
        num_matches2 = dict_foreach_match (two, match, ((void *)0),
                                           dict_null_foreach_fn, ((void *)0));
done:
...
# 238 "./dict.c"
 ...
 239
# 238 "./dict.c"
                , GF_LOG_WARNING, 0, 1, (100000 + 1000 + 148), "old is NULL"); } while (0)
                                                ;
                return ((void *)0);
        }

        data_t *newdata = mem_get0 ((*__glusterfs_this_location())->ctx->dict_data_pool);
        if (!newdata) {
                return ((void *)0);
        }
        ...
        pthread_mutex_init (&newdata->lock, 0);
        return newdata;

err_out:

        do { if (newdata->data != ((void *)0)) { free ((void *)newdata->data); newdata->data = (void *)0xeeeeeeee; } } while (0);
        mem_put (newdata);
...
# 273 "./dict.c"
        ...
        for (pair = this->members[hashval]; pair != ((void *)0); pair = pair->hash_next) {
...
dict_set_lk (dict_t *this, char *key, data_t *value, gf_boolean_t replace)
{
        ...
        if (this->free_pair_in_use) {
                pair = mem_get0 ((*__glusterfs_this_location())->ctx->dict_pair_pool);
                if (!pair) {
                        if (key_free)
                                __gf_free (key);
                        return -1;
        ...
        if (key_free) {
                ...
                pair->key = (char *) __gf_calloc (1, strlen (key) + 1, gf_common_mt_char, "gf_common_mt_char")
                                                                  ;
                if (!pair->key) {
...
int_to_data (int64_t value)
{
        ...
        if (-1 == ret) {
                do { _gf_msg ("dict", "./dict.c", __FUNCTION__, 667, GF_LOG_DEBUG, 0, 0, 0, "asprintf failed"); } while (0);
                return ((void *)0);
        }
...
data_from_int32 (int32_t value)
{
        ...
        if (-1 == ret) {
                do { _gf_msg ("dict", "./dict.c", __FUNCTION__, 705, GF_LOG_DEBUG, 0, 0, 0, "asprintf failed"); } while (0);
                return ((void *)0);
        }
...
data_from_uint32 (uint32_t value)
{
        ...
        if (-1 == ret) {
                do { _gf_msg ("dict", "./dict.c", __FUNCTION__, 807, GF_LOG_DEBUG, 0, 0, 0, "asprintf failed"); } while (0);
                return ((void *)0);
        }
...
# 856 "./dict.c"
 ...
 857
# 856 "./dict.c"
                , GF_LOG_WARNING, 22, 1, (100000 + 1000 + 172), "value is NULL"); } while (0)
                                                                      ;
                return ((void *)0);
        }
        data_t *data = get_new_data ();
...
# 931 "./dict.c"
 ...
 932
# 931 "./dict.c"
                , GF_LOG_WARNING, 22, 1, (100000 + 1000 + 172), "data is NULL"); } while (0)
                                                                     ;
                return -1;
        }

        char *str = __builtin_alloca (data->len + 1);
        if (!str)
                return -1;

        memcpy (str, data->data, data->len);
        str[data->len] = '\0';
        return (int64_t) strtoull (str, ((void *)0), 0);
}
...
# 970 "./dict.c"
        ...
        (*__errno_location ()) = 0;
        value = strtol (str, ((void *)0), 0);

        if ((value > 32767) || (value < (-32767 - 1))) {
                (*__errno_location ()) = 34;
                do { _gf_msg ("dict",
...
# 987 "./dict.c"
 ...
 989
# 987 "./dict.c"
                , GF_LOG_WARNING, (*__errno_location ()), 1, (100000 + 1000 + 141), "Error in data" " conversion: detected overflow"); } while (0)
...
# 1081 "./dict.c"
 ...
 1084
# 1081 "./dict.c"
  , GF_LOG_WARNING, (*__errno_location ()), 1, (100000 + 1000 + 141), "Error in data conversion: " "overflow detected"); } while (0)
...
# 1114 "./dict.c"
 ...
 1116
# 1114 "./dict.c"
  , GF_LOG_WARNING, (*__errno_location ()), 1, (100000 + 1000 + 141), "data " "conversion overflow detected"); } while (0)
              ...
              void *data)
{
        ...
        ret = dict_foreach_match (dict, dict_match_everything, ((void *)0), fn, data);
...
# 1221 "./dict.c"
 ...
 1223
# 1221 "./dict.c"
                , GF_LOG_WARNING, 22, 1, (100000 + 1000 + 172), "dict|match|action is " "NULL"); } while (0)
        ...
        int ret = -1;
        int count = 0;
        data_pair_t *pairs = ((void *)0);
        data_pair_t *next = ((void *)0);
...
# 1388 "./dict.c"
 ...
 1390
# 1388 "./dict.c"
                , GF_LOG_WARNING, 22, 1, (100000 + 1000 + 172), "dict OR key (%s) is NULL", key); } while (0)
...
data_to_int8_ptr (data_t *data, int8_t *val)
{
        ...
        str = __builtin_alloca (data->len + 1);
        if (!str) {
                ret = -12;
                goto err;
        }
                     ...
                     gf_boolean_t is_static)
{
        ...
        if (!ptr || (size > (9223372036854775807L * 2UL + 1UL))) {
                ret = -22;
                goto err;
        }
...
# 2406 "./dict.c"
 ...
 2407
# 2406 "./dict.c"
                , GF_LOG_ERROR, 22, 0, (100000 + 1000 + 3), "count (%d) < 0!", count); } while (0)
                                                                              ;
                goto out;
        }
...
# 2415 "./dict.c"
 ...
 2417
# 2415 "./dict.c"
                        , GF_LOG_ERROR, 22, 0, (100000 + 1000 + 4), "less than count data pairs found!"); } while (0)
...
# 2424 "./dict.c"
 ...
 2425
# 2424 "./dict.c"
                        , GF_LOG_ERROR, 22, 0, (100000 + 1000 + 148), "pair->key is null!"); } while (0)
                                                                      ;
                        goto out;
                }
...
# 2432 "./dict.c"
 ...
 2433
# 2432 "./dict.c"
                        , GF_LOG_ERROR, 22, 0, (100000 + 1000 + 148), "pair->value is null!"); } while (0)
                                                                        ;
                        goto out;
                }
...
# 2438 "./dict.c"
 ...
 2440
# 2438 "./dict.c"
                        , GF_LOG_ERROR, 22, 0, (100000 + 1000 + 5), "value->len (%d) < 0", pair->value->len); } while (0)
...
# 2479 "./dict.c"
 ...
 2480
# 2479 "./dict.c"
                , GF_LOG_ERROR, 22, 0, (100000 + 1000 + 172), "buf is null!"); } while (0)
                                       ;
                goto out;
        }
...
# 2499 "./dict.c"
 ...
 2501
# 2499 "./dict.c"
                        , GF_LOG_ERROR, 0, 0, (100000 + 1000 + 6), "less than count data pairs found!"); } while (0)
...
# 2506 "./dict.c"
 ...
 2507
# 2506 "./dict.c"
                        , GF_LOG_ERROR, 0, 0, (100000 + 1000 + 148), "pair->key is null!"); } while (0)
                                                     ;
                        goto out;
                }
...
# 2517 "./dict.c"
 ...
 2519
# 2517 "./dict.c"
                        , GF_LOG_ERROR, 0, 0, (100000 + 1000 + 148), "pair->value is null!"); } while (0)
...
# 2827 "./dict.c"
 ...
 2828
# 2827 "./dict.c"
                , GF_LOG_ERROR, 22, 0, (100000 + 1000 + 172), "count (%d) < 0", count); } while (0)
                                                ;
                goto out;
        }
...
# 2843 "./dict.c"
 ...
 2845
# 2843 "./dict.c"
                        , GF_LOG_ERROR, 0, 0, (100000 + 1000 + 7), "key or value is null"); } while (0)
...
# 2850 "./dict.c"
 ...
 2852
# 2850 "./dict.c"
                        , GF_LOG_ERROR, 0, 0, (100000 + 1000 + 9), "null value found in dict"); } while (0)

                                                           ;
                        goto out;
                }

                vallen = pair->value->len - 1;
                memcpy (buf, pair->value->data, vallen);
                buf += vallen;
                *buf++ = delimiter;
