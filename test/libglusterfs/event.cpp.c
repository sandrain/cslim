                ...
                void *data, int poll_in, int poll_out)
{
        ...
        do { if (!event_pool) { (*__errno_location ()) = 22; do { _gf_msg ("event", "./event.c", __FUNCTION__, 65, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "event_pool"); } while (0); goto out; } } while (0);
...
event_unregister (struct event_pool *event_pool, int fd, int idx)
{
        ...
        do { if (!event_pool) { (*__errno_location ()) = 22; do { _gf_msg ("event", "./event.c", __FUNCTION__, 79, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "event_pool"); } while (0); goto out; } } while (0);
...
event_unregister_close (struct event_pool *event_pool, int fd, int idx)
{
        ...
        do { if (!event_pool) { (*__errno_location ()) = 22; do { _gf_msg ("event", "./event.c", __FUNCTION__, 93, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "event_pool"); } while (0); goto out; } } while (0);
                 ...
                 int poll_in, int poll_out)
{
        ...
        do { if (!event_pool) { (*__errno_location ()) = 22; do { _gf_msg ("event", "./event.c", __FUNCTION__, 108, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "event_pool"); } while (0); goto out; } } while (0);
...
event_dispatch (struct event_pool *event_pool)
{
        ...
        do { if (!event_pool) { (*__errno_location ()) = 22; do { _gf_msg ("event", "./event.c", __FUNCTION__, 122, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "event_pool"); } while (0); goto out; } } while (0);
...
event_reconfigure_threads (struct event_pool *event_pool, int value)
{
        ...
        do { if (!event_pool) { (*__errno_location ()) = 22; do { _gf_msg ("event", "./event.c", __FUNCTION__, 137, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "event_pool"); } while (0); goto out; } } while (0);
...
event_pool_destroy (struct event_pool *event_pool)
{
        ...
        do { if (!event_pool) { (*__errno_location ()) = 22; do { _gf_msg ("event", "./event.c", __FUNCTION__, 153, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "event_pool"); } while (0); goto out; } } while (0);
...
event_dispatch_destroy (struct event_pool *event_pool)
{
        ...
        do { if (!event_pool) { (*__errno_location ()) = 22; do { _gf_msg ("event", "./event.c", __FUNCTION__, 206, GF_LOG_ERROR, (*__errno_location ()), 1, (100000 + 1000 + 172), "invalid argument: " "event_pool"); } while (0); goto out; } } while (0);
        ...
        pthread_mutex_lock (&event_pool->mutex);
        {
                ...
                while (event_pool->activethreadcount > 0 && retry++ < 10) {
                        if (sys_write (fd[1], "dummy", 6) == -1)
                                break;
                        sleep_till.tv_sec = time (((void *)0)) + 1;
