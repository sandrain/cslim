...
{
        do { do { if (0) printf ("xlator does not " "implement forget_cbk"); } while (0); _gf_log_callingfn (this->name,
 "./defaults-tmpl.c"
# 93 "./defaults-tmpl.c"
        , __FUNCTION__,
 94
# 93 "./defaults-tmpl.c"
        , GF_LOG_DEBUG, "xlator does not " "implement forget_cbk"); } while (0)
                                                 ;
        return 0;
}
...
{
        do { do { if (0) printf ("xlator does not " "implement releasedir_cbk"); } while (0); _gf_log_callingfn (this->name,
 "./defaults-tmpl.c"
# 102 "./defaults-tmpl.c"
        , __FUNCTION__,
 103
# 102 "./defaults-tmpl.c"
        , GF_LOG_DEBUG, "xlator does not " "implement releasedir_cbk"); } while (0)
                                                     ;
        return 0;
}
...
{
        do { do { if (0) printf ("xlator does not " "implement release_cbk"); } while (0); _gf_log_callingfn (this->name,
 "./defaults-tmpl.c"
# 110 "./defaults-tmpl.c"
        , __FUNCTION__,
 111
# 110 "./defaults-tmpl.c"
        , GF_LOG_DEBUG, "xlator does not " "implement release_cbk"); } while (0)
                                                  ;
        return 0;
}
...
default_notify (xlator_t *this, int32_t event, void *data, ...)
{
        ...
        case GF_EVENT_UPCALL:
        {
                ...
                if (!parent && this->ctx && this->ctx->master)
                        xlator_notify (this->ctx->master, event, data, ((void *)0));
