 ...
 if (max == 1) {
  ...
  goto out;
        ...
        if (offset & (1ULL << (63 - 1))) {
                ...
                max_bits = bits_for (max);
                off_mask = ((~0ULL) << max_bits);
                orig_offset = ((offset & ~(1ULL << (63 - 1))) & off_mask) << (((0)>((63 - 63 + 1))?(0):((63 - 63 + 1))));
 } else {
...
gf_itransform (xlator_t *this, uint64_t x, uint64_t *y_p, int client_id)
{
 ...
 if (max == 1) {
  ...
  goto out;
        ...
        hi_mask = ~(((~0ULL) >> (64 - 63)) >> (max_bits + 1));

        if (x & hi_mask) {

                off_mask = (~0ULL) << max_bits;
                y = (1ULL << (63 - 1)) | ((x >> (((0)>((63 - 63 + 1))?(0):((63 - 63 + 1))))) & off_mask) | client_id;
        } else {
...
{
        gf_dirent_t *gf_dirent = ((void *)0);


        gf_dirent = __gf_calloc ((sizeof (gf_dirent_t) + strlen (name) + 1), 1, gf_common_mt_gf_dirent_t, "gf_common_mt_gf_dirent_t")
                                                        ;
        if (!gf_dirent)
                return ((void *)0);
...
gf_dirent_free (gf_dirent_t *entries)
{
        ...
        for (entry = ((typeof(*entry) *)((char *)((&entries->list)->next)-(unsigned long)(&((typeof(*entry) *)0)->list))), tmp = ((typeof(*entry) *)((char *)(entry->list.next)-(unsigned long)(&((typeof(*entry) *)0)->list))); &entry->list != (&entries->list); entry = tmp, tmp = ((typeof(*tmp) *)((char *)(tmp->list.next)-(unsigned long)(&((typeof(*tmp) *)0)->list)))) {
