...
# 28 "./refcount.c"
        do { if (!(cnt != 0)) { do { _gf_msg ("", "./refcount.c", __FUNCTION__, 28, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "cnt != 0"); } while (0); } } while (0);
...
_gf_ref_put (gf_ref_t *ref)
{
        ...
        do { if (!(cnt != 0)) { do { _gf_msg ("", "./refcount.c", __FUNCTION__, 44, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "cnt != 0"); } while (0); } } while (0);
...
_gf_ref_init (gf_ref_t *ref, gf_ref_release_t release, void *data)
{
        do { if (!(ref)) { do { _gf_msg ("", "./refcount.c", __FUNCTION__, 104, GF_LOG_ERROR, 0, 1, (100000 + 1000 + 150), "Assertion failed: " "ref"); } while (0); } } while (0);
